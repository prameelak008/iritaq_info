            ...
            class Entrancesettings extends Admin_Controller 
            {
            ...
            $data['getseatval']             =   $this->Entranceallotment_model->getseatval($courseid, $session_id);
            $data['seatno']                 =   $this->Entranceallotment_model->seatno();
            $data['eligibleseatno']         =   $this->Entranceallotment_model->eligibleseatno($courseid, $session_id);
