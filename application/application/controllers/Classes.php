...
class Classes extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('serialno', $this->lang->line('serialno'), 'trim|required|xss_clean');
    ...
    public function edit($id)
    {
        ...
        $this->form_validation->set_rules('serialno', $this->lang->line('serial'), 'trim|required|xss_clean');
        if ($this->form_validation->run() == false) {
            $vehicle_result       = $this->section_model->get();
            $data['vehiclelist']  = $vehicle_result;
