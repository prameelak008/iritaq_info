...
class Report extends Admin_Controller
{
    ...
    // public function subjectresultreport() {
    //     if (!$this->rbac->hasPrivilege('rank_report', 'can_view')) {
    //         access_denied();
    //     }
    ...
    //     $this->session->set_userdata('top_menu', 'Reports');
    //     $this->session->set_userdata('sub_menu', 'Reports/examinations');
    //     $this->session->set_userdata('subsub_menu', 'Reports/examinations/subjectresultreport');
    ...
    //     $data['sch_setting'] = $this->sch_setting_detail;
    //     $this->load->view('layout/header', $data);
    //     $this->load->view('reports/subjectresultreport', $data);
    //     $this->load->view('layout/footer', $data);
    // }
    ...
    public function subjectresultreport() {
        ...
        public function subjectresultreport_sayexam()
        {
        if (!$this->rbac->hasPrivilege('rank_report', 'can_view')) {
        access_denied();
        }
        $this->session->set_userdata('top_menu', 'Reports');
        $this->session->set_userdata('sub_menu', 'Reports/examinations');
        $this->session->set_userdata('subsub_menu', 'Reports/examinations/subjectresultreport_sayexam');
        $examgroup_result = $this->examgroup_model->get();
        $data['examgrouplist'] = $examgroup_result;
        ...
        $class = $this->class_model->get();
        $data['title'] = 'Report Say Exam';
        $data['title_list'] = 'Report Say Exam';
        $data['examType'] = $this->exam_type;
        $data['classlist'] = $class;
        $session = $this->session_model->get();
        $data['sessionlist'] = $session;
        ...
        else 
        {
            ...
            {
                foreach ($studentList as $student_key => $student_value) {
                    $studentList[$student_key]->subject_results = $this->examresult_model->getStudentResultByExam_bysayexam($exam_id, $student_value->exam_group_class_batch_exam_student_id);
                }
            }
        ...
        $data['sch_setting'] = $this->sch_setting_detail;
        $this->load->view('layout/header', $data);
        $this->load->view('reports/subjectresultreport_sayexam', $data);
        $this->load->view('layout/footer', $data);
        }
        ...
        public function subjectresultreport_sayexamte()
        {
        if (!$this->rbac->hasPrivilege('rank_report', 'can_view')) {
        access_denied();
        }
        $this->session->set_userdata('top_menu', 'Reports');
        $this->session->set_userdata('sub_menu', 'Reports/examinations');
        $this->session->set_userdata('subsub_menu', 'Reports/examinations/subjectresultreport_sayexamte');
        $examgroup_result = $this->examgroup_model->get();
        $data['examgrouplist'] = $examgroup_result;
        ...
        else 
        {
            ...
            if (!empty($studentList)) {
                foreach ($studentList as $student_key => $student_value) {
                    $studentList[$student_key]->subject_results = $this->examresult_model->getStudentResultByExam_bysayexamte($exam_id, $student_value->exam_group_class_batch_exam_student_id);
                }
            }
        ...
        $data['sch_setting'] = $this->sch_setting_detail;
        $this->load->view('layout/header', $data);
        $this->load->view('reports/subjectresultreport_sayexamte', $data);
        $this->load->view('layout/footer', $data);
        }
    ...
    public function daily_studentattendance_report()
    {
        ...
        $data['result']                 = $this->stuattendence_model->get_attendancebydate($date);
         ...
         $absenttype                    = $this->input->post('absenttype');
         $newDate                       = date("Y-m-d", strtotime($date));
         $class                         = $this->input->post('class');
         $data['classes']               = $this->staff_model->classes();

        if(isset($_POST['search']))
        {
            
          
        $data['student_absent_request'] = $this->staff_model->student_absent_request($newDate,$absenttype,$class);
        $data['date_fr']                = $newDate;

        }


        $this->load->view('layout/header', $data);
        $this->load->view('reports/daily_studentattendance_report', $data);
        $this->load->view('layout/footer', $data);
    ...
    public function daily_staffattendance_report()
    {    
    ...
    $data['roles']   = $this->staff_model->roles();
    ...
    if(isset($_POST['search']))
    {
    $data['dte_for'] = $newDate;
    $data['staff_absent_request'] = $this->staff_model->staff_absent_request($newDate,$absenttype,$role);
    }


    $this->load->view('layout/header', $data);
    $this->load->view('reports/daily_staffattendance_report', $data);
    $this->load->view('layout/footer', $data);
    ...
    public function student_category_report()
    {  

    
    $category         = $this->input->post('category');
    $data['category'] = $this->staff_model->category();
    if(isset($_POST['search']))
    {
    $data['staff_category'] = $this->staff_model->staff_category($category);
    }
    $this->load->view('layout/header', $data);
    $this->load->view('reports/student_category_report', $data);
    $this->load->view('layout/footer', $data);
