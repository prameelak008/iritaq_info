                ...
                $this->form_validation->set_rules('to_semdate', $this->lang->line('to_semdate'), 'trim|required|xss_clean');
                ...
                $data['batch_types']         =   $this->Batchtype_model->get_batchtypes();
                ...
                $data                      = array(
               'bch_prog'                => $this->input->post('prog_id'),
                'bchtyp_id'                => $this->input->post('sem_batch_type'),
                'semtyp_id'                => $this->input->post('semester_semtype'),                
