        ...
        'viewstatus' => $this->input->post('status'),
        'class_id'   => $classes,
        ...
        $list               = $this->content_model->getListByCategory("refund");
        $data['list']       = $list;
        $this->load->view('layout/header');
        $this->load->view('admin/content/refund', $data);
        $this->load->view('layout/footer');
        }
        
        
        public function oldquestionpapers()
        {
        $this->session->set_userdata('top_menu', 'Download Center');
        $this->session->set_userdata('sub_menu', 'content/oldquestionppapers');
        $data['title_list'] = 'Old Question Papers';
        $list               = $this->content_model->getListByCategory("old_question_papers");
        $data['list']       = $list;
        $this->load->view('layout/header');
        $this->load->view('admin/content/oldquestionpapers', $data);
        $this->load->view('layout/footer');
        }
