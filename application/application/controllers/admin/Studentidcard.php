<?php
        ...
        $this->form_validation->set_rules('validity', $this->lang->line('validity'), 'trim|required|xss_clean');
        ...
        // $this->form_validation->set_rules('seal', $this->lang->line('seal'), 'callback_handle_upload[seal]');
        ...
        'layout_color'          => $this->input->post('layout_color'),
        'footer_contents'       => $this->input->post('footer_contents'),
        'layout_title'          => $this->input->post('layout_title'),
        ...
        $config['upload_path'] = 'uploads/student_id_card/seal/';
        $config['allowed_types'] = 'jpg|jpeg|png|gif';
        
        $file_name = $_FILES['seal']['name'];
        ...
        $upload_data = array('id' => $insert_id, 'logo' => $logo_img, 'background' => $background, 'sign_image' => $sign_image,'seal'=>$seal);
