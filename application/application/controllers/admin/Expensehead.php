        ...
        if (!empty($expense_head->data)) {
            ...
            foreach ($expense_head->data as $exhead_key => $exhead_value) {
                ...
                if ($permission_delete) {
                  $action .= "<a data-placement='left'   
onclick='return doconfirm();' href='".site_url('admin/expensehead/delete/'.$exhead_value->id)."' class='btn btn-default btn-xs'  data-toggle='tooltip' title='".$this->lang->line('delete')."' ><i class='fa fa-remove'></i></a>";
                }
                $row           = array();
