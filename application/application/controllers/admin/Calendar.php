<?php
    ...
    $this->load->library('pagination');
        ...
        $ischeckholiday    = $this->input->post("ischeckholiday");
        $event_holiday     = $this->input->post("holiday");
        ...
        if ($this->form_validation->run() == false) 
        {
        ...
        else
           {
            ...
            $getdata     = $this->calendar_model->listall($insert_id);
            ...
            if ($ischeckholiday ==1 && $event_type == 'public')
            {
            ...
            $this->calendar_model->saveAttendenceEvent($attendence_data); 
            }
    ...
    $this->form_validation->set_rules('title', $this->lang->line('event') . " " . $this->lang->line('title'), 'trim|required|xss_clean');
    $this->form_validation->set_rules('holiday', $this->lang->line('event') . " " . $this->lang->line('holiday'), 'trim|required|xss_clean');
    $this->form_validation->set_rules('event_from', $this->lang->line('event') . " " . $this->lang->line('form'), 'trim|required|xss_clean');
    $this->form_validation->set_rules('event_to', $this->lang->line('event') . " " . $this->lang->line('to'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            ...
            {
            $student=$student_ses['id'];
            $attendence_data = array('date' => $start_date,
            'attendence_type_id'            => 5,
            'created_at'                    => date('Y-m-d'),
            'student_session_id'            => $student,
            'remark'                        => $event_title,
            ...
            $this->calendar_model->saveStaffAttendenceEvent($attendence_data); 
            }
            }
            */
