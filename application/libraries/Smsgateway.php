                                ...
                                function sendWhatsAppSMS($mobile,$message)
                                {
                                $sms_detail = $this->_CI->smsconfig_model->getActiveWHATSAPP(); 
                                if ($sms_detail->type == 'WhatsApp')
                                { 
                                $params         = array(
                                'authkey'  => $sms_detail->authkey,
                                'senderid' => $sms_detail->senderid,
                                ...
                                $this->_CI->load->library('wasupsms', $params);
                                $this->_CI->wasupsms->sendSms(array($mobile), $message);
                                } 
                                else
                                {
                                ...
                                public function sentAbsentStudentWhatsapp($detail, $template, $template_id)
                                {
                                $sms_detail           = $this->_CI->smsconfig_model->getActiveWHATSAPP();
                                if (!empty($sms_detail))
                                {
                                ...
                                $numberlength = strlen((string) $detail['guardian_phone']);
                                if($numberlength<12)
                                {
                                $mobile='91'.''.$detail['guardian_phone'];
                                }
                                else
                                {
                                $mobile=$detail['guardian_phone'];
                                } 
                                $msg                  = $this->getAbsentStudentContent_msg($detail, $template, $sms_detail->type);
                                ...
                                'number'   => $mobile);
                                $this->_CI->load->library('wasupsms', $params);
                                $this->_CI->wasupsms->sendSms(array($mobile), $msg);
                                }
                                else
                                {
                                }
                                ...
                                public function sendregisterStudentWhatsapp($detail, $template, $template_id)
                                {
                                $sms_detail           = $this->_CI->smsconfig_model->getActiveWHATSAPP();
                                if (!empty($sms_detail))
                                {
                                $mobile               = array();
                                $numberlength = strlen((string) $detail['mobileno']);
                                if($numberlength<12)
                                {
                                $mobile='91'.''.$detail['mobileno'];
                                }
                                else
                                {
                                ...
                                public function sendexamappliedStudentWhatsapp($detail, $template, $template_id)
                                {
                                $sms_detail           = $this->_CI->smsconfig_model->getActiveWHATSAPP();
                                ...
                                public function getAbsentStudentContent_msg($student_detail, $template, $sms_detail_type = null)
                                {
                                $session_name                           = $this->_CI->setting_model->getCurrentSessionName();
                                $student_detail['current_session_name'] = $session_name;
                                ...
                                public function sendentranceregWhatsapp($detail, $template, $template_id)
                                {
                                $sms_detail           = $this->_CI->smsconfig_model->getActiveWHATSAPP();
                                if (!empty($sms_detail))
                                {
                                ...
                                $msg                  = $this->getEntranceReg($detail, $template, $sms_detail->type);
                                if ($sms_detail->type == 'WhatsApp')
                                { 
                                $params    = array(
                                'authkey'  => $sms_detail->authkey,
                                ...
                                public function getEntranceReg($student_detail, $template, $sms_detail_type = null)
                                {
                                $session_name                           = $this->_CI->setting_model->getCurrentSessionName();
                                $student_detail['current_session_name'] = $session_name;
