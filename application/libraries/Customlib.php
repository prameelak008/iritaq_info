        ...
        $status['refund']          = $this->CI->lang->line('refund');
        $status['other_download']      = $this->CI->lang->line('other_download');
        $status['old_question_papers'] = $this->CI->lang->line('old_question_papers');
        return $status;
        }
        ...
        {
        return array('mail' => $note_value->is_mail, 'sms' => $note_value->is_sms,'whatsapp' => $note_value->is_whatsapp, 'notification' => $note_value->is_notification, 'template' => $note_value->template, 'template_id' => $note_value->template_id,'template_two' => $note_value->template_two, 'subject' => $note_value->subject, 'is_template' => $note_value->is_template);
        }
        }
        }
        return false;
        ...
        public function sendMailSMS_online($find)
        {
        $notifications = $this->CI->notificationsetting_model->get_online();
        if (!empty($notifications)) 
        {
        foreach ($notifications as $note_key => $note_value) 
        {
        ...
        public function countstudentleave()
        {
        $result = $this->CI->calendar_model->countstudent_leave();
        return $result;
        }
        
        
        public function countstaffleave()
        {
        $result = $this->CI->calendar_model->countstaff_leave();
        return $result;
        }
        
        
        public function countleave_student($id)
        {
        $result = $this->CI->calendar_model->countstudent_leave_forteacher($id);
        return $result;
        }
        ...
        // {
        // return date('d-m-Y');   // or 'd-m-Y' based on your DB format
        // }
