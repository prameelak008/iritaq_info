        ...
        */
        ...
        public function getStaffLeaveType() {
        
        $query = $this->db->select('*')->where("is_active", 'yes')->get("leave_types");
        ...
        */
        ...
        public function getStaffAbsent($date)
        {
        $sql="select leave_type_id,staff_id from staff_leave_request where '".$date."' BETWEEN leave_from and leave_to and  status='approve'" ;
