            ...
            $this->db->select("semester_assign_subjects.*,batch_semester.*,
            ...
            $this->db->join('batch_semester', 'batch_semester.bchsem_id = semester_assign_subjects.sem_assign_group_id');
            ...
            {               
            $this->db->group_by([
            'batch_semester.bch_prog',
            'batch_semester.semterm_id',
            'batch_semester.bchtyp_id'
            ]);
            $this->db->order_by('programee.p_name, batch_groups.batch_group_name');
            $query = $this->db->get();
            return $query->result_array();
