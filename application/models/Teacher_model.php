...
class Teacher_model extends CI_Model {
    ...
    public function get_subjectby_classid($class_id, $section_id, $staff_id) {
     ...
     public function get_subjectby_classid_substitute($class_id, $section_id, $staff_id) {

        $query = $this->db->query("select GROUP_CONCAT(st.subject_group_subject_id) as subject from subject_timetable_substitute st where st.staff_id='" . $staff_id . "' and class_id='" . $class_id . "' and section_id='" . $section_id . "' and st.session_id='" . $this->current_session . "'  group by staff_id ");
        return $query = $query->row_array();
    }
