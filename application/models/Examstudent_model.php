...
class Examstudent_model extends CI_Model {
    ...
    return $query->row_array();
      ...
      public function say_exam($post_exam_id,$post_exam_group_id)
        {
        ...
        //$this->db->where('online_examination.online_examination_student_id', 5916);
        $query = $this->db->get();
        return $query->result_array();
        ...
        public function  getstudent_applicationfee($students_array)
        {
        // $this->current_session = $this->setting_model->getCurrentSession();
        // $this->db->select('*');
       ...
       $this->current_session = $this->setting_model->getCurrentSession();
        ...
        $this->db->where('application_fees.application_fees_examgroupbatch', $examgroup);
        $this->db->where('application_fees.application_fees_examgroup', $examgroupbatch);
