    ...
    public function leavemanagement($data) 
    {
    $this->db->trans_start(); # Starting Transaction
    $this->db->trans_strict(false); # See Note 01. If you wish can remove as well
    //=======================Code Start===========================
    if (isset($data['id'])) {
    $this->db->where('leave_catmanagement_id', $data['id']);
    $this->db->update('leave_catmanagement', $data);
    $message = UPDATE_RECORD_CONSTANT . " On  leave_catmanagement 	id " . $data['id'];
    $action = "Update";
    $record_id = $id = $data['id'];
    $this->log($message, $record_id, $action);
    } 
    ...
    {
    $this->db->insert('leave_catmanagement', $data);
    $insert_id = $this->db->insert_id();
    $message = INSERT_RECORD_CONSTANT . " On leave_catmanagement 	id " . $insert_id;
    $action = "Insert";
    $record_id = $id = $insert_id;
    $this->log($message, $record_id, $action);
    }
    ...
    public function addleave_management($data)
    {
    $this->db->trans_start(); # Starting Transaction
    $this->db->trans_strict(false); # See Note 01. If you wish can remove as well
    //=======================Code Start===========================
    ...
    $this->db->where('id', $data['id']);
    $this->db->update('student_subject_attendances', $data);
    $message = UPDATE_RECORD_CONSTANT . " On  student_subject_attendances id " . $data['id'];
    $action = "Update";
    $record_id = $id = $data['id'];
    $this->log($message, $record_id, $action);
    } 
    ...
    {
    $this->db->insert('student_subject_attendances', $data);
    $insert_id = $this->db->insert_id();
    $message = INSERT_RECORD_CONSTANT . " On student_subject_attendances id " . $insert_id;
    $action = "Insert";
    $record_id = $id = $insert_id;
    $this->log($message, $record_id, $action);
    }
    ...
    $message = UPDATE_RECORD_CONSTANT . " On  staff_attendance id " . $data['id'];
    $action = "Update";
    $record_id = $id = $data['id'];
    $this->log($message, $record_id, $action);
    } 
    ...
    $insert_id = $this->db->insert_id();
    $message = INSERT_RECORD_CONSTANT . " On staff_attendance id " . $insert_id;
    $action = "Insert";
    $record_id = $id = $insert_id;
    $this->log($message, $record_id, $action);
    }
