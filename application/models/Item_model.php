...
class Item_model extends MY_Model
{
                ...
                public function getpurchasePrice($store_id,$item_id,$supplier_id)
                {
                $this->db->select('*');
                $this->db->from('item');
                $this->db->join('item_stock', 'item_stock.item_id = item.id');
                
                $this->db->where(array('item_stock.store_id'=> $store_id,'item_stock.item_id'=> $item_id,'item_stock.supplier_id'=> $supplier_id));
