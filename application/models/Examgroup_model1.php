...
/*$this->db->select('*,exam_groups.id as groupid,exam_groups.name as groupname,
exam_group_class_batch_exams.id as exambatch_id,exam_group_class_batch_exams.exam as exambatch_exam,
    exam_group_class_batch_exams.id as grpid,exam_group_class_batch_exams.exam as examgrpid,
subjects.id as subjectid,subjects.name as subject');
$this->db->from('exam_groups');
$this->db->join('exam_group_class_batch_exams', 'exam_group_class_batch_exams.exam_group_id  = exam_groups.id');
...
//$this->db->select('*,exam_groups.name as groupname,
exam_group_class_batch_exams.exam as exambatch_exam,
    exam_group_class_batch_exams.exam as examgrpid,
...
public function online_examination_getsubjectlist($examid,$student_id)
{
$this->db->select('*,exam_group_class_batch_exams.id as grpid,exam_group_class_batch_exams.exam as examgrpid,
subjects.id as subjectid,subjects.name as subject,exam_group_class_batch_exam_students.id as studid');
...
public function view_Studentattendence($studentid)
{ 
$this->db->select('*');
$this->db->from('students');
$this->db->join('student_session', 'student_session.student_id  = students.id');
