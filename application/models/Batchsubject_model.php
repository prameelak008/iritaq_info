   ...
   // $this->db->join('class_sections', 'class_sections.id   = subject_group_class_sections.class_section_id');
    ...
    public function getvaluationExamSubjects($id = null)
    {
    ...
    public function getExamSubjects_row($id = null)
    {
    
    $this->db->select('exam_group_class_batch_exam_subjects.*,subjects.name as `subject_name`,exam_group_class_batch_exams.exam as `examname`,subjects.code as `subject_code`,subjects.type as `subject_type`')->from('exam_group_class_batch_exam_subjects');
    
    $this->db->join('subjects', 'subjects.id = exam_group_class_batch_exam_subjects.subject_id');
    
    $this->db->join('exam_group_class_batch_exams', 'exam_group_class_batch_exams.id = exam_group_class_batch_exam_subjects.exam_group_class_batch_exams_id');
    ...
    */
    ...
    public function let_export($id)
    {
    $this->db->select('"",subject_id,date_from,time_from,duration,room_no,max_marks,min_marks,credit_hours,date_to,is_active,created_at,updated_at,max_cmarks,min_cmarks');        
    $this->db->from('exam_group_class_batch_exam_subjects');
    $this->db->where(array('exam_group_class_batch_exam_subjects.exam_group_class_batch_exams_id'=>$id));
    $query = $this->db->get();
