...
//Semester 
                protected $sem_student     = null;
                protected $sem_group_id    = null;
                ...
                // if (!($current_controller === 'semesterauth' && $current_method === 'login')) 
                // {
                // $this->check_session();
                // }   
                ...
                else if ($this->session->has_userdata('sem_student'))
                {

                $sem_student  = $this->session->userdata('sem_student');
                $language     = ($sem_student['language']['language'] ?? 'english'); // default fallback
                ...
                // Force redirect with 302 status code
                redirect('semesterauth/login', 'auto', 302);
                exit;
                }
                }
                }
