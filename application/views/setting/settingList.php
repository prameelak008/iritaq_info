...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-12 uploadsticky">
                ...
                <div class="box box-primary">
                    ...
                    <br>
                <span style="display: inline-block; background-color: #e9ecef; color: #333; padding: 5px 10px; border-radius: 4px; margin-top: 10px; font-size: 13px;">
                290px × 51px
                </span>
                    </div>
                </div>
                <div class="box box-primary">
                    <div class="box-body text-center">
                        ...
                        if ($result->admin_small_logo == "") {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/logo/images.png" class="img-thumbnail img-responsive " alt="Cinque Terre" width="" height="">
                            <?php
                        } else {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/admin_small_logo/<?php echo $result->admin_small_logo; ?>" class="img-responsive"  alt="Cinque Terre" width="" height="">
                            <?php
                        }
                        ?>
                        <br/>
                        <br/>
                        <a href="#admin_small_logo" role="button" class="btn btn-primary btn-sm upload_admin_small_logo" class="img-responsive"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit') . " " . $this->lang->line('admin') . " " . $this->lang->line('small') . " " . $this->lang->line('logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit') . " " . $this->lang->line('admin') . " " . $this->lang->line('small') . " " . $this->lang->line('logo'); ?></a>
                   <br>
                    <span style="display: inline-block; background-color: #e9ecef; color: #333; padding: 5px 10px; border-radius: 4px; margin-top: 10px; font-size: 13px;">
                    32px × 32px
                    </span>
                ...
                <div class="box box-primary">
                 ...
                 <div class="box box-primary">
                    <div class="box-body text-center">
                        <?php
                        if ($result->dashboard_logo == "") {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/logo/images.png" class="img-thumbnail img-responsive " alt="" width="" height="">
                            <?php
                        } else {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/dashboardimage/<?php echo $result->dashboard_logo; ?>" class="img-responsive" alt="" width="" height="">
                            <?php
                        }
                        ?>
                        <br/>
                        <a href="#dashboard_logo" role="button" class="btn btn-primary btn-sm upload_dashboard_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit_app_logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit_dashboard_logo'); ?></a>
                    </div>
                </div>
        ...
        <form name="from1" method="POST" action="<?php echo site_url('Schsettings/dashboard_editlogo');  ?>"            enctype="multipart/form-data"/>
        <?php
        ...
        <button type="submit" class="btn btn-primary btn-sm " name="submit"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('editdashboard_logo'); ?></button>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('website'); ?>
                                        </label>
                                            <div class="col-sm-8">
...
<div class="modal fade" id="modal-upload_dashboard_logo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('edit_dashboard_logo'); ?></h4>
            </div>
            <div class="modal-body upload_logo_body">
                <!-- ==== -->
                <form class="box_upload boxupload has-advanced-upload" method="post" action="<?php echo site_url('schsettings/ajax_editlogo') ?>" enctype="multipart/form-data">
                    <input value="<?php echo $result->id ?>" type="hidden" name="id" id="id_dashboard_logo"/>
                    <input type="file" name="file" id="file_dashboardlogo">
                    <!-- Drag and Drop container-->
                    <div class="box__input upload-dashboard_logo_area"  id="uploaddashboard_logo">
                        <i class="fa fa-download box__icon"></i>
                        <label><strong><?php echo $this->lang->line('choose_a_file'); ?></strong><span class="box__dragndrop"> <?php echo $this->lang->line('or') ?> <span><?php echo $this->lang->line('drag') ?></span><?php echo $this->lang->line('it_here') ?></span>.</label>
...
<script type="text/javascript">
    $('.upload_dashboard_logo').on('click', function (e) {
        e.preventDefault();
        var $this = $(this);
        logo_type = $this.data('logo_type');

        $this.button('loading');
        $('#modal-upload_dashboard_logo').modal({
            show: true,
            backdrop: 'static',
            keyboard: false
        });
...
// set focus when modal is opened
    $('#modal-upload_dashboard_logo').on('shown.bs.modal', function () {
        $('.upload_dashboard_logo').button('reset');
    });
    ...
    $(function () {
        // Drag enter
        $('.upload-dashboard_logo_area').on('dragenter', function (e) {
            e.stopPropagation();
            e.preventDefault();
            $("h1").text("Drop");
        });
        ...
        // Drag over
        $('.upload-dashboard_logo_area').on('dragover', function (e) {
            e.stopPropagation();
            e.preventDefault();
            $("h1").text("Drop");
        });
        ...
        // Drop
        $('.upload-dashboard_logo_area').on('drop', function (e) {
            e.stopPropagation();
            e.preventDefault();
            ...
            fd.append('file', file[0]);
            fd.append("id", $('#id_appdashboard_logo').val());
            // fd.append("logo_type", logo_type);
        ...
        // Open file selector on div click
        $("#uploaddashboard_logo").click(function () {
            $("#file_dashboardlogo").click();
        });

        // file selected
        $("#file_dashboardlogo").change(function () {
            var fd = new FormData();

            var files = $('#file_dashboardlogo')[0].files[0];


            fd.append('file', files);
            fd.append("id", $('#id_dashboard_logo').val());
            // fd.append("logo_type", logo_type);
            uploadDashboardData(fd);
        });
    });

// Sending AJAX request and upload file
    function uploadDashboardData(formdata) {

        $.ajax({
            url: '<?php echo site_url('schsettings/ajax_dashboardlogo') ?>',
            type: 'post',
            data: formdata,
            contentType: false,
            processData: false,
            ...
            beforeSend: function () {
                $('#modal-upload_dashboard_logo').addClass('modal_loading');
            },
            success: function (response) {
            ...
            complete: function () {
                $('#modal-upload_dashboard_logo').removeClass('modal_loading');
