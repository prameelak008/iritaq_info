        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0"> 
                ...
                <div class="row"> 
                        ...
                        <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo $this->lang->line('holiday');  ?></label>
                        <input type="checkbox" name="ischeckholiday" id="ischeckholiday" value="1" />
                        </div>
                        ...
                        <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo $this->lang->line('holiday'); ?></label>
                        <textarea name="holiday" class="form-control" id="desc-holiday"></textarea>
                        </div>
...
<div id="viewEventModal" class="modal fade " role="dialog" >
    ...
    <div class="form-group col-md-12">
    <label for="exampleInputEmail1">Is &nbsp;<?php echo $this->lang->line('holiday');  ?></label>
    <input type="checkbox" name="ischeckholiday" id="evischeckholiday" value="1" />
    </div>
    ...
    <div class="form-group col-md-12">
    <label for="exampleInputEmail1"><?php echo $this->lang->line('holiday');  ?></label>
    <textarea name="holiday" class="form-control" placeholder="Set Holiday"  id="event_holiday" ></textarea>
    </div>
