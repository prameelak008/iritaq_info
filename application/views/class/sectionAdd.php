                                        ...
                                        foreach ($classSectionlist as $classSection) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <a href="<?php echo base_url(); ?>classes/deletesection/<?php echo $classSection['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();"  >
