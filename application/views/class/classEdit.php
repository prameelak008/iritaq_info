                        ...
                        <form id="form1" action="<?php echo site_url('classes/edit/' . $id) ?>"  method="post" accept-charset="utf-8">
                            ...
                            */
                            ?>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('serial').''.$this->lang->line('no'); ?></label><small class="req"> *</small>
                                    <input autofocus="" id="serialno" name="serialno" placeholder="" type="number" class="form-control"  value="<?php echo set_value('serialno', $vehroute[0]->serialno); ?>" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('class', 'can_delete')) {
                                                    ?>  
                                               <a data-placement="left" href="<?php echo base_url(); ?>classes/delete/<?php echo $vehroute->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php
