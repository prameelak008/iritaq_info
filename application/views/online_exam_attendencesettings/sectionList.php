                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('attendance').'&nbsp;'.$this->lang->line('settings'); ?></h3>
                        </div>
                         
                        <form action="<?php echo site_url('admin/attendence_settings/add_inst') ?>"  id="instruction" name="instruction" method="post" accept-charset="utf-8">
                        <div class="box-body">
                         <?php
                        ...
                        <textarea name="message" placeholder="" class="form-control ckeditor"></textarea>
                        ...
                        <input autofocus="" id="attendence_percentage" name="attendence_percentage" placeholder="" type="text" class="form-control"  value="<?php echo set_value('attendence'); ?>" />
