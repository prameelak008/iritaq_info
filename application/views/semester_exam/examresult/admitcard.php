                ...
                <div class="box-body">
                <form role="form" action="<?php echo site_url('semester_exam/examresult/admitcard') ?>" method="post" class="row">
...
<?php /* ?>
                ...
                <input type="hidden" name="sem_group_id" id="sem_group_id" value="<?php echo set_value('sem_group_id'); ?>" class="form-control" >
                ...
                foreach ($admitcardlist as $admitcard)
               {
                ...
                <form method="post" action="<?php echo base_url('semester_exam/examresult/printCard') ?>" id="printCard">
                <input type="hidden" name="admitcard_template" value="<?php echo $admitcard_template; ?>">
                <input type="hidden" name="sem_group_id" id="sem_group_id" value="<?php echo $sem_group_id; ?>">
                <div  class="" >
                ...
                {
                var selectedProgramType = "<?php echo set_value('program_type'); ?>";  
                var selectedProgram     = "<?php echo set_value('programe'); ?>";  

                // When program type changes → fetch programs
                ...
                //  Trigger change on page load if program_type was already chosen

                if(selectedProgramType !== ''){
                $('#program_type').val(selectedProgramType).trigger('change');
                }
                });
