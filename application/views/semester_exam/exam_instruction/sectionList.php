                    ...
                    <div class="row">
                        <div class="">
                            <div class="tabs-container">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group">
                                                    ...
                                                    <select id="exam_group_id" name="exam_group_id" class="form-control">
                                                        ...
                                                        <option value="<?php echo $ex_group_value->id ?>" <?php if (set_value('exam_group_id') == $ex_group_value->id) { echo "selected=selected"; } ?>><?php echo $ex_group_value->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                ...
                                <form id="feeform" method="POST" action="<?php echo site_url('semester_exam/exam_instruction/save_fees') ?>">
                                    <div class="tab-content">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group">
                                                    ...
                                                    <select id="fee_ex_type" name="fee_ex_type">
                                                        ...
                                                        <?php foreach($get_instruction as $instr) { ?>
                                        ...
                                        <div class="btn-container">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="switchTab(2)">Next: Subject Charge →</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="tab-content">
                                    <form id="subjectform_search" method="POST" action="<?php echo site_url('semester_exam/exam_instruction') ?>">
                                        <div class="form-section"> 
                                            <div class="section-title">
                                    ...
                                    <form id="subjectform_save" method="POST" action="<?php echo site_url('semester_exam/exam_instruction/save_subjectform') ?>">
                                        <input type="hidden" name="gt_sem_group" value="<?php echo $sem_group_id; ?>" />
                                        <input type="hidden" name="gt_sem_title" value="<?php echo $inst_title; ?>" />
                                        ...
                                        <div class="table-responsive mailbox-messages">
                                            ...
                                            <table class="table table-striped table-bordered table-hover example">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>            
                                                        ...
                                                        <td>
                                                            <input type="hidden" name="subject_id[]" value="<?php echo $result['subjectid'] ?>" />          
                                                            <input type="text" name="fees_charge[]" class="form-control fees_charge" placeholder="Enter applicable fee" value="<?php echo !empty($result['inst_fees_charge']) ? $result['inst_fees_charge'] : ''; ?>" />
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            ...
                                            <div class="btn-container">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="switchTab(3)">Next: Details →</button>
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-content">
                                    <div class="info-card">
                                        <p><strong> Note:</strong> Review the exam fees and instructions listed below.</p>
                                    </div>
                                    ...
                                    <div class="btn-container">
                                        <button type="button" class="btn btn-secondary" onclick="switchTab(2)">← Previous</button>
                                        <button type="button" class="btn btn-primary" onclick="switchTab(4)">Next: Attempt →</button>
                                    </div>
                                </div>  
                                ...
                                <div class="tab-content">
                                    <div class="info-card">
                                        ...
                                        📋 What This Controls:<br>
                                        Set the maximum number of times a student can apply/register for each exam type. For example:<br>
                                        ...
                                        Revaluation: Limited to 1 attempt per subject
                                        </p>
                                    </div>

                                    <form id="attemptform" method="POST" action="<?php echo site_url('semester_exam/exam_instruction/save_attempt') ?>">
                                        <div class="form-section">
                                            <div class="section-title">
                                                <span>💵</span> Attempts
                                            </div>
                                            ...
                                            <div class="form-row"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="exam_group_id_attempt" name="exam_group_id_attempt" class="form-control">
                                                        ...
                                                        <option value="<?php echo $ex_group_value->id ?>" <?php if (set_value('exam_group_id_attempt') == $ex_group_value->id) { echo "selected=selected"; } ?>><?php echo $ex_group_value->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                        ...
                                        <table class="table table-bordered" id="examOptionTypeTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="attempt[]" class="form-control" placeholder="e.g., 1, 2, or unlimited"></td>
                                                    <td>
                                        ...
                                        <div class="btn-container">
                                            <button type="button" class="btn btn-secondary" onclick="switchTab(3)">← Previous</button>
                                            <button type="submit" class="btn btn-primary">💾 Save & Update</button>
                                        </div>
                                    </form>
                                </div>
            ...
            $(document).ready(function () { 
                ...
                $('#exam_group_id,#exam_id,#exam_option,#exam_type').on('change', function () {         
                    ...
                    if (examGroupId && examId && examOption && examType) {
                        $.ajax({
                            url: '<?php echo base_url("Semester_exam/exam_instruction/get_bygroup"); ?>',
                            type: 'POST',
                            data: {
            ...
            function resetForm() {
                if (confirm('⚠️ Are you sure you want to reset all fields?')) {
                    document.getElementById('subjectform_save').reset();
                    switchTab(2);
                }
            }
            ...
            <script>
            // Add/Remove Row functionality for Attempt table
