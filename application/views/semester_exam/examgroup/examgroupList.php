           ...
           <?php $currency_symbol = $this->customlib->getSchoolCurrencyFormat(); ?>
            ...
            <h3 class="box-title">
            <?php echo $this->lang->line('add') . " " . $this->lang->line('semester')." ". $this->lang->line('exam') . " " . $this->lang->line('group'); ?>
        
            </h3>
            </div><!-- /.box-header -->
            <form id="form1" action="<?php echo site_url('semester_exam/examgroup') ?>"  id="examgroupform" name="examgroupform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <select id="name"  class="form-control" name="exam_type" placeholder="" type="text" >
            ...
            <?php if ($this->rbac->hasPrivilege('exam', 'can_view')) { ?>
                <a href="<?php echo base_url(); ?>semester_exam/examgroup/addexam/<?php echo $examgroup->id ?>"
            ...
            if ($this->rbac->hasPrivilege('exam_group', 'can_edit')) {
                ?>
                <a data-placement="left" href="<?php echo site_url('semester_exam/examgroup/edit/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
            ...
            if ($this->rbac->hasPrivilege('exam_group', 'can_delete')) {
                ?>
                <a data-placement="left" href="<?php echo site_url('semester_exam/examgroup/delete/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
