...
<form method="post" action="<?php echo site_url('semester_exam/examgroup/entrymarks') ?>" id="assign_form1111">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('cmarks') ?></th>
  ...
  $roll_no=($student['use_exam_roll_no'])?$student['exam_roll_no']:$student['roll_no'];
                                ...
                                <td> <input type="number" class="cmarksssss form-control" name="exam_group_student_cmark_<?php echo $student['exam_group_class_batch_exam_students_id']; ?>" value="<?php echo $student['exam_group_exam_result_get_cmarks']; ?>" step="any"></td> 
