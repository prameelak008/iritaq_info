                        ...
                        <form id="formadd" action="<?php echo site_url('semester_exam/examgroup/ajaxaddexam'); ?>">
            ...
            <!------------------------End Add Subjects------------------------------------------------------------------------------->
                        ...
                        <form role="form" id="searchStudentForm" action="<?php echo site_url('semester_exam/examgroup/subjectstudent') ?>" method="post" class="mb10">
                        ...
                        <select name="sub_program_type" id="sub_program_type" class="form-control" >
                        ...
                        <select name="sub_programe" id="sub_programe" class="form-control">
                        <option></option>
                        </select>
                        </div>
                        </div>
                        ...
                        <select name="sub_batch_group" id="sub_batch_group" class="form-control" >
                        ...
                        <select name="sub_semester_semtype" id="sub_semester_semtype" class="form-control" >
                        ...
                        <select name="sub_semester_term" id="sub_semester_term" class="form-control" >
                        ...
                        <div class="modal-body">
                        <form role="form" id="allotStudentForm" action="<?php echo site_url('semester_exam/examgroup/examstudent') ?>" method="post" >
                        <input type="hidden" name="exam_id" value="0" class="exam_group_exam_id">
                        ...
                        <input type="hidden" name="sem_group_id" id="sem_group_id" value="" class="form-control" >                     
                        ...
                        $.ajax({
                        type: "POST",
                        url: base_url + "semester_exam/examgroup/getexamSubjects",
                        ...
                        $.ajax({
                        type: "POST",
                        url: base_url + "semester_exam/examgroup/getexam",
                        ...
                        html += '<td><div class="input-group datepicker_init_time"><input type="text" placeholder="00:00:00" name="duration' + x + '" class="form-control duration"  value="0"/><span class="input-group-addon" id="basic-addon3"><i class="fa fa-calendar"></i></span></div></td>';
                        ...
                        html += '<td class=""><input type="text" name="max_marks_' + x + '" class="form-control marksssss" /></td>';
                        html += '<td class=""><input type="hidden" name="rows[]" value="' + x + '"> <input name="prev_row[' + x + ']" type="hidden" value="0"><input type="text" name="min_marks_' + x + '" class="form-control marksssss" /></td>';


                        html += '<td class=""><input type="text" name="max_cmarks_' + x + '" class="form-control marksssss" /></td>';
                        html += '<td class=""><input type="text" name="min_cmarks_' + x + '" class="form-control marksssss" /></td>'
                        ...
                        $.ajax({
                        type: 'POST',
                        url: baseurl + "semester_exam/examgroup/getSubjectByExam",
                        data: {'recordid': recordid},
                        dataType: 'JSON',
                        beforeSend: function ()
                        {
