        ...
        $this->db->where(array('semester_student_session.student_id' => $stud_id));                       
        $query         = $this->db->get();
        $res           = $query->row_array(); 
        ...
        <td class="tdfirst_space">:</td>
        <td class="tdsecond font6 "><?php echo $id_card_backend[0]->validity; ?></td>
        </tr>
       ...
       <td class="tdfirst font6 "  style="text-align:center; padding-top:2px;">
        ...
        <tr>
            <td>&nbsp;</td>
        <td class="tdsec_centre"  ><img src="<?php echo base_url();?>/<?php echo $student->qrcode; ?>" style="height:100px; width:100px; "/></td>
        </tr>
