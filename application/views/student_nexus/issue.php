...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-book"></i>  <?php echo $this->lang->line('library').'&nbsp;&nbsp;'.$this->lang->line('issue_return');  ?>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                if ($memberList->member_type == "student") {
                    $this->load->view('student_nexus/_student');
                } 
                // else 
                //     {
                //     $this->load->view('student_nexus/_teacher');
                // }
                ?>
            </div>
            <div class="col-md-9">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('student_nexus/library/issue/' . $memberList->lib_member_id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <select autofocus="" id="book_id" name="book_id" class="form-control js-example-basic-single">
                                    ...
                                    foreach ($bookList as $book) {
                                        ...
                                        ?>>
                                            <?php echo $book['book_title'].''.$book['book_no'].''.$book['isbn_no'].''. $book['author']?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('no').''.$this->lang->line('of').''.$this->lang->line('days'); ?></th>
                                        ...
                                        $count = 1;
                                          ...
                                          foreach ($issued_books as $book) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                <?php echo $book['library_cp_no_of_days'] ?>
                                                </td>
...
<div class="modal fade" id="confirm-return" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('student_nexus/library/bookreturn') ?>" method="POST" id="return_book">
                ...
                <div class="modal-footer">
                    ...
                    <form name="form1" id="add_form"  method="POST" action="<?php echo site_url('admin/circulation_privileges/add_multiplefine') ?>">
                    <div class="modal-body">
                    
                    <div class="form-group">
                    <label for="recipient-name" class="col-form-label"><?php echo $this->lang->line('fine_days'); ?></label>
                    <input type="text" class="form-control" id="fine_days"  name="fine_days">
                    ...
                    <textarea class="form-control" id="message-text" id="fineamt" name="fineamt"></textarea>
                    </div>
...
$(document).ready(function () 
    {
    var membertype_id=$('#membertype_id').val();
    var Membertype = capitalizeFirstLetter(membertype_id);
    
      $.ajax({
                type: "POST",
                url: base_url + "admin/book/returndate",
                data: {'Membertype': Membertype},
                dataType: "json",
                success: function (data) 
                {
                var category=data.library_cp_category;    
                var no_of_days=data.library_cp_no_of_days; 
                //$('#no_of_days').val(category);
                
                var currentDate = new Date();
                var futureDate = new Date(currentDate);
                futureDate.setDate(currentDate.getDate() + data.library_cp_no_of_days);
            
                // Format the date using $.datepicker.formatDate
                var formattedDate = $.datepicker.formatDate('yy-mm-dd', futureDate);
                // Display the formatted date
                alert("Current Date + 7 Days: " + formattedDate);
                },
                complete: function () {
                }
