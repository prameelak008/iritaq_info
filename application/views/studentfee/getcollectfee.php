...
<ul class="fees-list fees-list-in-box">
    ...
    if (($fee_value->due_date != "0000-00-00" && $fee_value->due_date != NULL) && (strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) && $amount_to_be_pay > 0) {
        ...
        if ($amount_to_be_pay > 0) {
            ...
            <li class="item">
                <input name="row_counter[]" id="row_counter" type="hidden" value="<?php echo $row_counter; ?>">
               ...
               <!-- <input name="fee_amount_<?php echo $row_counter; ?>" type="hidden" value="<?php echo $amount_to_be_pay; ?>">-->
                <div class="product-info">
                    <a href="#"  onclick="return false;" class="product-title"><?php echo $fee_value->name; ?></a>
                        <span class="pull-right">
						
						<input class="product-title" id="fee_amount" required="required"   style="color:#0084B4;border: 1px solid #ccc; " name="fee_amount_<?php echo $row_counter; ?>" type="number" min="1" value="<?php echo $amount_to_be_pay; ?>">
						<br>
						 <span class="product-description">
<?php echo '( Balance &nbsp;'.  $currency_symbol.number_format((float) $amount_to_be_pay, 2, '.', '') .')'; ?>
</span>	
						...
						<?php echo 'Paid &nbsp; '. $amount_prev_paid ;?><br>
						<?php  echo 'Total &nbsp;'.$fee_value->amount ;?>
