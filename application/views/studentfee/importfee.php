            ...
            <div class="col-md-12">
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        <h3 class="box-title"> Import Student Fee</h3>
                        <div class="pull-right box-tools">                            
                            <a href="<?php echo site_url('student/Newexportfeeformat') ?>">
...
//echo $value;
                    ...
                    <form action="<?php echo site_url('importfees/importFile') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <?php //echo $this->customlib->getCSRF(); ?>

                            <input type="hidden" name="ses_id" value="<?php echo $id; ?>"
                            <div class="row">
                                <!--<div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div><input class="filestyle form-control" type='file' name='uploadFile' id="file" size='20' />
