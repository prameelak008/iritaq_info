            ...
            <div class="row">
                <div id="content" class="col-lg-12 col-sm-12 ">
                        ...
                        <div class="row header ">
                            <div class="col-sm-12">
                                ...
                                <!--<img  src="<?php echo base_url(); ?>/uploads/print_headerfooter/student_receipt/<?php $this->setting_model->get_receiptheader(); ?>" style="height: 100px;width: 100%;">-->
								 ...
								 <div class="col-sm-6" style="width:50% !important;float:left;">
                   ...
                   <p>&nbsp;</p>
					...
					<br>
					<!--<p class="text-heading" style="font-size:30px !important; "><?php echo  $sch_setting->name; ?></p>-->
					</div>
					<br>
					<br>
                ...
                <div class="col-sm-6">
					...
					<?php
                        ...
                        <p class="text-black">Email:<?php echo  $sch_setting->email; ?></p>
                    </div>
                </div>
							...
							<img  src="<?php echo base_url(); ?>/uploads/NewfeesCollectTitle/heading.jpg">
							</div>							
							</div>
