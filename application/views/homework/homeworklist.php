...
<?php } ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                         <span id="downloadfiles" ><i class="fa fa-downloads"></i></span>
            ...
            $.ajax({
                ...
                {                 
                    ...
                    getsubjectBySubjectGroup(res.class_id, res.section_id, res.subject_groups_id, res.subject_group_subject_id, 'modal_subject_id');
                        ...
                        if (res.document && res.document !== '') {
                        $('#downloadfiles').html(
                        '<a href="' + base_url + 'uploads/homework/' + res.document + '" download>' +
                        'Click to download the attached file. &nbsp;&nbsp;<i class="fa fa-download">&nbsp;&nbsp;Download</i>' +
                        '</a>'
                        );
                        } else {
                        $('#downloadfiles').html(
                        '<span class="text-muted"><?php echo $this->lang->line("no_file_attached"); ?></span>'
                        );
                        }  
...
$(document).ready(function(){ 
    ...
    initDatatable('homework-list', 'homework/dthomeworklist_initial', {}, [], 100);
