            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_11" data-toggle="tab"><?php echo $this->lang->line('WhatsApp'); ?></a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_2">
                            ...
                            <form role="form" id="whatsapp_id"  action="<?php echo site_url('smsconfig/whatsapp') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="minheight170">
                                            <div class="col-md-7">
                                                <?php
                                                $whatsApp_result = check_in_array('WhatsApp', $whatsapp_result);

                                                //print_r($whatsApp_result);
                                                ?>


                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('whatsappformat'); ?></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="whatsapp_link" value="<?php echo $whatsApp_result->url; ?>">
                                                        <!--<span class="text text-danger whatsapp_link"></span>-->
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('api_key'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="api" value="<?php echo $whatsApp_result->api_id; ?>">
                                                        <span class="text text-danger api_error"></span>
                                                    </div>

                                                </div>

                                                  <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('intense_id'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="intense_id" value="<?php echo $whatsApp_result->senderid; ?>">
                                                        <span class="text text-danger intense_id_error"></span>
                                                    </div>
                                                </div>   
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="auth_token" value="<?php echo $whatsApp_result->authkey; ?>">
                                                        <span class="text text-danger auth_token_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('registered_phone_number'); ?></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="sender_phone_number" value="<?php echo $whatsApp_result->contact; ?>">
                                                       <!-- <span class="text text-danger sender_phone_number"></span>-->
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('status'); ?><small class="req"> *</small></label>
                                                        ...
                                                        <select class="form-control" name="status">
                                                            ...
                                                            foreach ($statuslist as $s_key => $s_value) {
                                                                ...
                                                                <option
                                                                    value="<?php echo $s_key; ?>"
                                                                    <?php
                                                                    if ($whatsApp_result->is_active == $s_key) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?>
                                                                    ><?php echo $s_value; ?></option>
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://firstdialwhatsapp.xyz/"  target="_blank"><img src="<?php echo base_url() ?>backend/images/whatsApp.jpg"><p>First Dial</p></a>
                                            </div>
                                        </div>
                                    </div>
      ...
      $("#mobireach").submit(function (e) {
       ...
       $("#nexmo").submit(function (e) {
        ...
        $.ajax({
            ...
            dataType: 'JSON',
            url: url,
            data: $("#whatsapp_id").serialize(), // serializes the form's elements.
            success: function (data, textStatus, jqXHR)
            {
                if (data.st === 1) {
                    $.each(data.msg, function (key, value) {
