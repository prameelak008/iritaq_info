...
{ 
    ...
    foreach ($whole_arr as $key => $i) {
        ...
        if ($i < 20) {
            ...
            $rettxt .= $tens[intval(substr($i, 0, 1))];
            $rettxt .= " " . $ones[intval(substr($i, 1))];
        } else {
            $rettxt .= $ones[intval(substr($i, 0, 1))] . " hundred ";
            $rettxt .= $tens[intval(substr($i, 1, 1))];
            $rettxt .= " " . $ones[intval(substr($i, 2, 1))];
        }
    ...
    if($decnum > 0){
        ...
        if($decnum < 20){
            ...
            $rettxt .= $tens[intval(substr($decnum,0,1))];
            $rettxt .= " " . $ones[intval(substr($decnum,1,1))];
        }
    }
