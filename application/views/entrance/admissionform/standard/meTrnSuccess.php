        ...
        */
        ...
        <form action="<?php   echo site_url('entrance/home/pay'); ?>" method="POST" id="submpay" >
        ...
        <input type="hidden" name="getRrn" value="<?php echo $response->getRrn();?>" />
        <input type="hidden" name="getAuthZCode" value="<?php echo $response->getAuthZCode();?>" />
