...
<div class="content-wrapper" style="min-height: 946px;">
	...
	<meta charset="utf-8">
	<title>Entrance Exam Cash Transaction</title>
	<style>
		body{
...
<br>
<center> <H3>  </H3></center>
	<form action="<?php  echo site_url('entrance/home/meTrnPayment');?>" method="post">
		<table width="100%" >
			...
			<tr hidden>	
				...
				<td><input type="text" name="addField1" id="addField1" value="<?php  echo $session_studid;  ?>"  /></td>
				...
				<td><input type="text" name="addField3" id="addField3" value="<?php  echo $regid['admission_range']; ?>" /></td>
			</tr>
			<tr hidden>	
				<td><label for="addField4">Add Field 4</label></td>
				<td><input type="text" name="addField4" id="addField4"  value="<?php  echo $regid['admission_application_no']; ?>" /></td>
				
				<td><label for="addField5">Add Field 5</label></td>
				<td><input type="text" name="addField5" id="addField5" value="" /></td>
				
				<td><label for="addField6">Add Field 6</label></td>
				<td><input type="text" name="addField6" id="addField6" value=""  /></td>	
			</tr>
			<tr hidden>	
				...
				<td><input type="text" name="responseUrl" id="responseUrl" value="<?php echo site_url();?>entrance/home/meTrnSuccess" /></td>
			</tr>
