            ...
            <?php echo $this->lang->line('payments'); ?></h3>
            ...
            array_pop($resHost);
            $resHostNew = $resHost;
            array_push($resHost, 'response_te.php');
            ...
            <td>
            <input type="text" name="tpsl_txn_id" value="" /></td>
            </tr>
            ...
            <td>
            <input type="text" name="returnURL" value='<?php echo site_url();?>user/sayexam_temarks/response' required />
            </td>
            </tr>
