...
if ($_POST) {
    ...
    if (isset($responseData['clnt_rqst_meta'])) {
        ...
        $feepay = array(
        'fees_improvementpayment_responsecode'   => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
        'fees_improvementpayment_statuscode'     => $txnmsg_msg,
        'fees_improvementpayment_student_id'     => isset($responseData['studentid']) ? $responseData['studentid'] : null,
        'fees_improvementpayment_class_id'       => isset($responseData['class_id']) ? $responseData['class_id'] : null,
        'fees_improvementpayment_section_id'     => isset($responseData['section_id']) ? $responseData['section_id'] : null,
        'fees_improvementpayment_session_id'     => isset($responseData['session_id']) ? $responseData['session_id'] : null,
        'fees_improvementpayment_examgroup'      => isset($responseData['examgroup']) ? $responseData['examgroup'] : null,
        'fees_improvementpayment_examgroupbatch' => isset($responseData['examgroupbatch']) ? $responseData['examgroupbatch'] : null,
        'fees_improvementpayment_orderid'        => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
        'fees_improvementpayment_transdate'      => isset($responseData['tpsl_txn_time']) ? $responseData['tpsl_txn_time'] : null,
        'fees_improvementpayment_transaction_no' => isset($responseData['clnt_txn_ref']) ? $responseData['clnt_txn_ref'] : null,
        // 'fees_payment_orderid'        => isset($responseData['tpsl_txn_id']) ? $responseData['tpsl_txn_id'] : null,
        'fees_improvementpayment_amount'         => isset($responseData['txn_amt']) ? $responseData['txn_amt'] : null,
        'fees_improvementpayment_created_date'   => date('d-m-y H:i:s'),
        'fees_improvementpayment_onlinestatus'   =>"Worldline-3rd Stage",
        'fees_improvementpayment_errormsg'       => isset($responseData['txn_err_msg']) ? $responseData['txn_err_msg'] : null,
        'fees_improvementpayment_year'           => date('Y'));
        $this->Pay_storemodel->insert_improve_fees_payment($feepay);
    } 
