                ...
                if ($key !== NULL) {
                $formattedKey = str_replace('studentid', 'student_id', $key); // Ensure key is 'student_id'
                ...
                $feepay = array(
                'fees_revaluationpayment_responsecode'   => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
                'fees_revaluationpayment_statuscode'     => $txnmsg_msg,
                'fees_revaluationpayment_student_id'     => isset($responseData['student_id']) ? $responseData['student_id'] : null,
                'fees_revaluationpayment_class_id'       => isset($responseData['class_id']) ? $responseData['class_id'] : null,
                'fees_revaluationpayment_section_id'     => isset($responseData['section_id']) ? $responseData['section_id'] : null,
                'fees_revaluationpayment_session_id'     => isset($responseData['session_id']) ? $responseData['session_id'] : null,
                'fees_revaluationpayment_examgroup'      => isset($responseData['examgroup']) ? $responseData['examgroup'] : null,
                'fees_revaluationpayment_examgroupbatch' => isset($responseData['examgroupbatch']) ? $responseData['examgroupbatch'] : null,
                'fees_revaluationpayment_orderid'        => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
                'fees_revaluationpayment_transdate'      => isset($responseData['tpsl_txn_time']) ? $responseData['tpsl_txn_time'] : null,
                'fees_revaluationpayment_transaction_no' => isset($responseData['clnt_txn_ref']) ? $responseData['clnt_txn_ref'] : null,
                // 'fees_payment_orderid'        => isset($responseData['tpsl_txn_id']) ? $responseData['tpsl_txn_id'] : null,
                'fees_revaluationpayment_amount'         => isset($responseData['txn_amt']) ? $responseData['txn_amt'] : null,
                'fees_revaluationpayment_created_date'   => date('d-m-y H:i:s'),
                'fees_revaluationpayment_onlinestatus'   =>"Worldline-3rd Stage",
                'fees_revaluationpayment_errormsg'       => isset($responseData['txn_err_msg']) ? $responseData['txn_err_msg'] : null,
                'fees_revaluationpayment_year'           => date('Y'));
                $this->Pay_storemodel->insert_rev_fees_payment($feepay);
