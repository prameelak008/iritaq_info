            ...
            <td><input type="text" readonly name="amount" id="amount"  value="<?php echo $totalamt; ?>" required /></td>
            </tr>
            ...
            <input type="text" name="returnURL" value='<?php echo site_url();?>user/user/rev_response' required />
            </td>
            </tr>
            <tr>
            <td>
