                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/marksheet') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="footer_text_bottom" type="text" class="form-control"><?php echo set_value('footer_text_bottom'); ?></textarea>

                                 <span class="text-danger"><?php echo form_error('footer_text_bottom'); ?></span>
                                </div>
                             ...
                             <div class="form-group">
                                    ...
                                    <input autofocus="" id="footer_bottom_padding" value="<?php echo set_value('footer_bottom_padding'); ?>" name="footer_bottom_padding" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="header_height" placeholder="" type="number" class=" form-control" data-height="40"  name="header_height">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="footer_height" placeholder="" type="number" class=" form-control" data-height="40"  name="footer_height">
                                    <span class="text-danger"><?php echo form_error('header_height'); ?></span>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('rollactive') . " " . $this->lang->line('no'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_rollactive" name="is_rollactive" type="checkbox" class="chk" value="1">
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_preprint" name="is_preprint" type="checkbox" class="chk" value="1">
                                ...
                                <div class="material-switch switchcheck">
                                <input id="is_examination_course" name="is_examination_course" type="checkbox" class="chk" value="1">
