        ...
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('design_marksheet', 'can_edit')) {
                ...
                <div class="col-md-4">
                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('admin/marksheet/edit/' . $marksheet->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8">
                            ...
                            */
                            ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_align'); ?></label>
                                   <select name="footer_align" class="form-control">
                                    <option value="<?php echo set_value('footer_align', $marksheet->footer_align); ?>"><?php echo set_value('content_footer', $marksheet->footer_align); ?></option>
                                 ...
                                 <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_text_bottom'); ?></label>
                                    <textarea name="footer_text_bottom" type="text" class="form-control"><?php echo set_value('footer_text_bottom', $marksheet->footer_text_bottom); ?></textarea>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_align_bottom'); ?></label>
                                   <select name="footer_align_bottom" class="form-control">
                                    <option value="<?php echo set_value('footer_align_bottom', $marksheet->footer_align_bottom); ?>"><?php echo set_value('footer_align_bottom', $marksheet->footer_align_bottom); ?></option>
                                       <option value="left">left</option>
                                       <option value="center">center</option>
                                       <option value="right">right</option>
                                   </select>
                                 ...
                                 <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_bottom_padding') ?></label>
                                    <input autofocus="" id="footer_bottom_padding" value="<?php echo set_value('footer_bottom_padding', $marksheet->footer_bottom_padding); ?>" name="footer_bottom_padding" placeholder="" type="text" class="form-control" />
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->left_logo; ?>" style="width:20%; height:20%">

                     <a href="<?php echo site_url();  ?>admin/marksheet/removeleftlogo/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Image</small></i></a>
                    ...
                    <?php }  
                     ...
                     { 
                    ?>
                    <!--<img src="<?php  echo base_url();?>backend/default_format/no_image.png " style="width:20%; height:20%"> -->
               ...
               <?php
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->right_logo; ?>" style="width:20%; height:20%">

                    <a href="<?php echo site_url();  ?>admin/marksheet/removerightlogo/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Image</small></i></a>
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->left_sign; ?>" style="width:20%; height:20%">

                    <a href="<?php echo site_url();  ?>admin/marksheet/removeleft_sign/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove </small></i></a>
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->middle_sign; ?>" style="width:20%; height:20%">

                    <a href="<?php echo site_url();  ?>admin/marksheet/removemiddle_sign/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove </small></i></a>
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->right_sign; ?>" style="width:20%; height:20%">

                    <a href="<?php echo site_url();  ?>admin/marksheet/removeright_sign/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove </small></i></a>
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/marksheet/<?php echo $marksheet->background_img; ?>" style="width:20%; height:20%">
                    

                     <a href="<?php echo site_url();  ?>admin/marksheet/removebackground_img/<?php echo $marksheet->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove </small></i></a>
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('header_height')  ?></label>
                                    <input autofocus="" id="header_height" name="header_height" placeholder="" type="text" class="form-control " value="<?php echo set_value('header_height', $marksheet->header_height); ?>"/>
                                    <span class="text-danger"><?php echo form_error('header_height'); ?></span>
                                </div>



                                <div class="form-group">
                                    <label><?php echo $this->lang->line('footer_height') ?></label>
                                    <input autofocus="" id="footer_height" name="footer_height" placeholder="" type="text" class="form-control " value="<?php echo set_value('footer_height', $marksheet->footer_height); ?>"/>
                                    <span class="text-danger"><?php echo form_error('footer_height'); ?></span>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('rollactive')  ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_rollactive" name="is_rollactive" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_rollactive', '1', (set_value('is_rollactive', $marksheet->is_rollactive) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_rollactive" class="label-success"></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('preprint'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_preprint" name="is_preprint" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_preprint', '1', (set_value('is_preprint', $marksheet->is_preprint) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_preprint" class="label-success"></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('examination_course'); ?> </label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_examination_course" name="is_examination_course" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_examination_course', '1', (set_value('is_examination_course', $marksheet->is_examination_course) == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_examination_course" class="label-success"></label>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date text-right no-print white-space-nowrap">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('design_marksheet', 'can_delete')) {
                                                        ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/marksheet/delete/<?php echo $certificate->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
