                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <?php if ($admin['username'] != "Admin") {?>
                                                        <a href="<?php echo base_url(); ?>admin/adminuser/delete/<?php echo $admin['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
