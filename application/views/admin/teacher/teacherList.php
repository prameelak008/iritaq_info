                                    ...
                                    foreach ($teacherlist as $teacher) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/teacher/delete/<?php echo $teacher['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
