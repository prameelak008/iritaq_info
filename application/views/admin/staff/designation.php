                                ...
                                <tbody>
                                    ...
                                    foreach ($designation as $value) {
                                        ...
                                        <?php } if ($this->rbac->hasPrivilege('designation', 'can_delete')) { ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/designation/designationdelete/<?php echo $value['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick='return doconfirm()'>
