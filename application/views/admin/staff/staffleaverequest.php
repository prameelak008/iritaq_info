                                    ...
                                    <div class="panel-body">
                                     <table class="table table-striped table-bordered table-hover example">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $i = 0;
                                            foreach ($leave_request_previous as $key => $value) {
                                                ?>
                                                <tr> 
                                                   ...
                                                   <td><?php echo $value["timedifference"]; ?></td>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><small <?php echo $label ?>><?php echo $status[$value["status"]]; ?></small></span>
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    <td><?php echo $value["leave_days"]; ?></td>
                                                     ...
                                                     <!--<td><?php echo $value["leave_hours"]; ?></td>-->
                                                   <td><?php echo $value["timedifference"]; ?></td>
                                                    <td><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($value["date"])); ?></td>
                                                    <?php
                                                    if ($value["status"] == "approve") {
                    ...
                    <form role="form" id="leavedetails_form" action="">
                        <div class="col-md-12 table-responsive">  
                            <table class="table mb0 table-striped table-bordered examples">
                                ...
                                <tr>
                                    <th><?php echo $this->lang->line('leave'); ?><?php echo $this->lang->line('time'); ?></th>
                                    <td><span id='leave_fromtime'></span> - <label> </label><span id='leave_totime'> </span> 
                                        </td>
            ...
            <div class="modal-body">
                <div class="row">
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('fromtime'); ?> </label><small class="req"> *</small>
                         ...
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('totime'); ?> </label><small class="req"> *</small>
    ...
    function getRecord(id) 
    {
        ...
        $.ajax({
            ...
            success: function (result) 
            {
                ...
                $('#leave_fromtime').html(result.leave_fromtime);
                $('#leave_totime').html(result.leave_totime);
            ...
            success: function (result) {
               ...
               $('#leave_from_date').val(result.leavefrom);
                $('#leave_to_date').val(result.leaveto);
                  ...
                  $('#leave_from_time').val(result.leave_fromtime);
                $('#leave_to_time').val(result.leave_totime);
