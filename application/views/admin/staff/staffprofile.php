            ...
            <div class="col-md-3">                
                ...
                ?>>
                    <div class="box-body box-profile">
                        ...
                        <br>
                        <h5  class="profile-username text-center">(<?php echo $staff['shortname'];?>)</h5>
                    ...
                    <?php } ?>
                        ...
                        if ($staff["is_active"] == 1) {
                            if ($this->rbac->hasPrivilege('disable_staff', 'can_view')) {
                                ...
                                if ($a) {
                                    ?> 
                                    <li class="pull-right" style="margin-right:50px;"><a  class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('disable'); ?>" onclick="disable_staff('<?php echo $id; ?>');"></i> <i class="fa fa-thumbs-o-down"></i></a></li>
                            ...
                            if ($a) {
                                ...
                                <li class="pull-right" style="margin-right:50px;"><a href="<?php echo base_url('admin/staff/delete/' . $id); ?>" class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_delete_record'); ?>');"></i><i class="fa fa-trash"></i></a></li>  


                                <li class="pull-right" style="margin-right:50px;"><a href="<?php echo base_url('admin/staff/enablestaff/' . $id); ?>" class="text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('enable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure').' '.$this->lang->line('you_want_to_enable_this_record'); ?>');"><i class="fa fa-thumbs-o-up"></i></a></li>  
                        ...
                        <div class="tab-pane" id="payroll">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse" aria-expanded="false"><label for="collapsible" class="lbl-toggle">Previous Year Report</label> </a>
                                    </h4>
                                    </div>
                                    ...
                                    <?php
                                    foreach ($staff_payroll_previous as $new_arr ) 
                                    {
                                    foreach ($new_arr as $key => $payroll_value )
                                    {
                             ...
                             <div class="download_label"><?php echo $this->lang->line('details_for'); ?> <?php echo $staff["name"] . " " . $staff["surname"]; ?></div> 
                                <table class="table table-hover table-striped example">
                                    ...
                                    <tbody>
                                            ...
                                            <?php
                                            foreach ($staff_payroll_val as $new_arr ) 
                                            {
                                            foreach ($new_arr as $key => $payroll_value )
                                            {
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="staffprofile">
                                                    ...
                                                    if (
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/doc_delete/<?php echo $staff['id'] . "/1/" . $staff['resume']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="staffprofile">
                                                    ...
                                                    if (
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/doc_delete/<?php echo $staff['id'] . "/2/" . $staff['joining_letter']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="staffprofile">
                                                    ...
                                                    if (
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/doc_delete/<?php echo $staff['id'] . "/3/" . $staff['resignation_letter']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                                            <i class="fa fa-remove"></i></a> 
                                                    <?php } ?>
                                                    <div class="icon">
                                                        <i class="fa fa-file-archive-o"></i>
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="staffprofile">
                                                    ...
                                                    if (
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/staff/doc_delete/<?php echo $staff['id'] . "/4/" . $staff['other_document_file']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                                            <i class="fa fa-remove"></i></a> 
                                                    <?php } ?>
                                                    <div class="icon">
                                                        <i class="fa fa-file-archive-o"></i>
...
<div class="download_label"><?php echo $this->lang->line('details_fors'); ?> <?php echo $staff["name"] . " " . $staff["surname"]; ?></div>
                    ...
                    <?php } ?>
                              ...
                              <div class="tab-pane" id="leaves">
                                    <div class="panel panel-default" >
                                    <div class="panel-heading" role="tab" id="headingval">
                                    <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseval" aria-expanded="false"><label for="collapsible" class="lbl-toggle">Previous Year Report</label> </a>
                                    </h4>
                                    </div>
                                    <div id="collapseval" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingval">
                                    <div class="panel-body">
                                     <table class="table table-striped table-bordered table-hover example    content-inner">
                                        <thead>
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($staff_leaves_previous as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php //echo $value["leave_hours"];
                                                    
                                                    $leav = explode(':', $value["leave_hours"]);
                                                    echo $leav[0].':'.$leav[1];
                            ...
                            <div class="row">
                                <?php /*
                                foreach ($leavedetails as $ldkey => $ldvalue) {
                                    ?>
                                ...
                                */
                                 ...
                                 foreach ($leavedetails as $ldkey => $ldvalue) {
                                    ?>
                                    <?php if (!empty($ldvalue["alloted_leavehours"]))
                                    { 
                                    ?>
                                        <div class="col-md-3 col-sm-6">
                                            <div class="staffprofile">
                                                <h5><?php echo $ldvalue["type"] . " (" . $ldvalue["alloted_leavehours"] . ")"; ?></h5>
                                                <p><?php echo $this->lang->line('used'); ?>: <?php
                                                    if (!empty($ldvalue["approve_leave"])) {
                                                        //echo $ldvalue["approve_leave"];
                                                        
                                                        $leav = explode(':', $ldvalue["approve_leave"]);
                                                        echo $leav[0].':'.$leav[1];
                                                    } else {
                                                        echo "0";
                                                    }
                                                ...
                                                <?php //echo $ldvalue["alloted_leavehours"] - $ldvalue["approve_leave"];
                                                
                                                
                                                 
                                                    $time2     = $ldvalue["alloted_leavehours"];
                                                    $time1     = $ldvalue["approve_leave"];
