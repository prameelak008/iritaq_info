                                        ...
                                        { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="shortname" name="shortname" placeholder="" type="text" class="form-control"  value="<?php echo set_value('shortname') ?>" />
                                                    ...
                                                    foreach ($leavetypeList as $key => $leave) {
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input  name="leave_typehrs[]" type="hidden" readonly class="form-control" value="<?php echo $leave['id'] ?>" />
                                                                <input  name="alloted_leavehrs_<?php echo $leave['id'] ?>" placeholder="<?php echo ('Number of Leave Hours'); ?>" type="text" class="form-control" />
