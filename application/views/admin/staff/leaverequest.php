                    ...
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/leaverequest/add_staff_leave'); ?>">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <label><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('from'); ?> <?php echo $this->lang->line('date'); ?></label><small class="req"> *</small>
                                ...
                                <input type="text" readonly id="leave_from_date"  onchange="validatedate()"      name="leave_from_date" class="form-control date date_betweenfrom" >
                        ...
                        <span class="text-danger"><?php echo form_error('leave_from_time'); ?></span>
                         ...
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-3">
                            <label><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?> <?php echo $this->lang->line('date'); ?></label><small class="req"> *</small>
                                ...
                                <input type="text" readonly id="leave_to_date" onchange="validatedate()"    name="leave_to_date" class="form-control date date_betweento" >
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-3">
                         ...
                         <span class="text-danger"><?php echo form_error('leave_to_time'); ?></span>
