                                    ...
                                    foreach ($leavetype as $value) {
                                     ...
                                     <!--        <td><?php echo $this->lang->line($value['is_active']) ?></td>
                                        ...
                                        <?php } if ($this->rbac->hasPrivilege('leave_types', 'can_delete')) { ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/leavetypes/leavedelete/<?php echo $value['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
