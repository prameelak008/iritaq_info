                            ...
                            ?> 
                                    ...
                                    <div class="row">
                                        ...
                                        <?php } 
                                         ...
                                         if ($sch_setting->staff_short_name)
                                        { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('shortname'); ?></label>
                                                    <input id="shortname" name="shortname" placeholder="" type="text" class="form-control"  value="<?php echo set_value('surname', $staff["shortname"]); ?>" />
                                        ...
                                        <?php if ($sch_setting->staff_leaves) { ?>
                                            <div class="tshadow mb25 bozero">    
                                                ...
                                                <!-- Leave in Hours -->
                                                 ...
                                                 <h4 class="pagetitleh2"><?php echo  $this->lang->line('hours'); ?>
                                                </h4>
                                                <div class="row around10" >
                                                    <?php
                                                    $k = 0;
                                                    foreach ($leavetypeList as $key => $leavehrs) {
                                                        # code...
                                                        ?>

                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo $leavehrs["type"]; ?></label>


                                                                <input id="ifsc_code" name="alloted_leavehours[]" placeholder="Number of leavehours" type="text" class="form-control"  value="<?php
                                                                if (array_key_exists($k, $staffLeaveDetails)) {
                                                                    echo $staffLeaveDetails[$k]["alloted_leavehours"];
                                                                }
                                                                ?>" />

                                                                <input  name="leave_typehrs[]" placeholder="" type="hidden" readonly class="form-control"  value="<?php echo $leavehrs["type"] ?>" />

                                                                <input  name="altidhrs[]" placeholder="" type="hidden" readonly class="form-control"  value="<?php
                                                                if (array_key_exists($k, $staffLeaveDetails)) {
                                                                    echo $staffLeaveDetails[$k]["altid"];
                                                                }
                                                                ?>" />

                                                                <input  name="leave_type_idhrs[]" placeholder="" type="hidden" class="form-control"  value="<?php echo $leavehrs["id"]; ?>" />
                                                                <span class="text-danger"><?php echo form_error('ifsc_code'); ?></span>
                                                            </div>
                                                        </div>
                                                        <?php
