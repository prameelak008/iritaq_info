  ...
  <?php
    ...
    <div class="form-group">
    <label for="exampleInputEmail1">
    <?php echo $this->lang->line('from').'&nbsp;'. $this->lang->line('date'); ?></label>
    ...
    <div class="form-group">
    <label for="exampleInputEmail1">
   <?php echo $this->lang->line('to').'&nbsp;'. $this->lang->line('date'); ?></label>
   <input type="date" name="fromdate" class="form-control">
    ...
    <div class="box-header ptbnull"></div>  
    <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('report'); ?></h3>
    ...
    <div class="box-body">
     ...
     <div class="mailbox-messages table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('studentpanel'); ?></div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('name'); ?>
                                              ...
                                              <th><?php echo $this->lang->line('total').''.$this->lang->line('periods'); ?>
                                            </th>
