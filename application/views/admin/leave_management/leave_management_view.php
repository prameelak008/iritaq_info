                                ...
                                <form action="<?php echo site_url('admin/leave_management/remove_group_attendence') ?>" method="post" id="group_form">
                                <div class="box-body">
                                <div class="row">
                                <div class="col-md-8">
                                ...
                                */
                                ...
                                <button type="submit" class="btn btn-danger submit_group" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Sending" ><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete'); ?></button>
                                </div>
                                </div>
                                </form>
                                </div>
                                ...
                                <form action="<?php echo site_url('admin/leave_management/remove_class') ?>" method="post" id="class_form">
                                <div class="box-body">
                                <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="box-footer">
                                <div class="pull-right">
                                <button type="submit" class="btn btn-danger submit_class" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Sending" ><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete'); ?></button>
                                </div>
                                </div>
                                </form>
                                </div>
