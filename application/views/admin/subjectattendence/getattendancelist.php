        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/subjectattendence/subjectattendence_list') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                       ...
                                       <!-- <input  name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date'); ?>" readonly="readonly"/>-->
                                        <input  name="date" placeholder="" id="date" type="text" class="form-control date"  value="<?php echo set_value(date,date('d-m-Y')); ?>" readonly="readonly"/>
                        ...
                        <div class="">
                            ...
                            <div class="box-body">
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    if (!isset($msg)) {
                                        if ($resultlist[0]['attendence_type_id'] != "") 
                                        {
                                            if ($resultlist[0]['attendence_type_id'] != 5) {
                                                ...
                                                ?>
                                                <div class="alert alert-warning"><?php echo $this->lang->line('attendance_already_submitted_as_holiday'); ?>. <?php //echo $this->lang->line('you_can_edit_record');
                                                
                                                echo $this->lang->line('you_cannot_edit_record');
                                                ?></div>
                                                <?php
                                            }
                                        }
                                    ...
                                    <form action="<?php echo site_url('admin/subjectattendence/subjectattendence_list') ?>" method="post" class="form_attendence">
                                        <?php echo $this->customlib->getCSRF(); ?>
...
echo $this->customlib->getFullName($value['firstname'],$value['middlename'],$value['lastname'],$sch_setting->middlename,$sch_setting->lastname);
           ?>
                ...
                var div_data = '<option value="" style="font-size:20px;"><?php echo $this->lang->line('select'); ?></option>';
                $.ajax({
                type: "POST",
                ...
                div_data += "<option style='font-size:20px; '  value=" + obj.id + " " + select + ">" + obj.periodic_table_name + "     "+'-'+"  "+''+"   " + obj.subject_name + " (" + obj.time_from + "- " + obj.time_to + ") By " + staff_name + " (" + obj.employee_id + ")" + "</option>";
                });
                ...
                /* 
                $(document).on('change', '#subject_timetable_id', function (e) 
                {
                var class_id = $('#class_id').val();
                var section_id = $('#section_id').val(); 
                var date = $('#date').val(); 
                var subject_timeid=$('#subject_timetable_id').val();
                var subject_substitute_timeid= $('#subject_substitute_timetable_id').val();
                $.ajax({
                type: "GET",
                url: baseurl + "admin/subjectattendence/substitute_val",
                data: {'class_id': class_id},
                dataType: "json",
                success: function (data)
                {
