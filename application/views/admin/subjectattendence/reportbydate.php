...
<!--<input  name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date'); ?>" readonly="readonly"/>-->
                                        ...
                                        <!--<input  name="date" placeholder="" type="text" class="form-control date"  value="<?php echo date('d-m-Y'); ?>" readonly="readonly"/>-->
                                        <input name="date" placeholder="" type="text" class="form-control date" value="<?php echo empty(set_value('date')) ? date('d-m-Y') : set_value('date'); ?>" readonly="readonly"/>
