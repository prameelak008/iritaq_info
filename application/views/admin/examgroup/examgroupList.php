            ...
            <div class="form-group">
            <label for="exampleInputEmail1"> <?php echo $this->lang->line('exam') . " " . $this->lang->line('status') ?></label> <small class="req">*</small>
            <select id="name" name="exam_status" placeholder="" type="text" class="form-control">
            <option value=""><?php echo $this->lang->line('select'); ?></option>
            <option>Main Exam</option>
            <option>Say Exam</option>
            ...
            */
            ...
            if ($this->rbac->hasPrivilege('exam_group', 'can_delete')) {
                ?>
                <a data-placement="left" href="<?php echo site_url('admin/examgroup/delete/' . $examgroup->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
