                  ...
                  <tr>
                    ...
                    */
                    ...
                    body{padding: 0; margin:10mm 8mm 10mm 8mm; font-family: arial; color: #000; font-size: 12px; line-height: normal;}
                    .tableone{}
                    .tableone td{border:1px solid #000; padding: 5px 0}
                    .denifittable th{border: 1px solid #999;border-right: 0px solid #999;}
                    .denifittable th,
                    .denifittable td {border: 1px solid #999;
                    border-collapse: collapse;border-left: 1px solid #999;}
                    ...
                    height: auto; /* Allows content to grow if needed */
                    ...
                    /* Optional: Hide elements that aren't needed in print */
                    .no-print {
                    display: none;
                    }
                    }
                    ...
                    <tr>
                    <!--<th class="headerclass"><b><?php echo $this->lang->line('paper') ?></b></th>-->
                    <th class="headerclass"><b><?php echo $this->lang->line('subjects') ?></b></th>
                    <th class="headerclass"><b><?php echo $this->lang->line('code') ?></b></th>
                    ...
                    <th class="headerclass"  valign="middle" rowspan="2"><b><?php echo $this->lang->line('mark') . " " . $this->lang->line('awarded') ?></b></th>
                    <th class="headerclass"valign="middle" rowspan="2" style="text-align:center;"><b><?php echo $this->lang->line('pass') . " " . $this->lang->line('mark') ?></b></th>
                    <th class="headerclass" valign="middle" rowspan="2" style="text-align: center;border-right:1px solid #999">
                        
                    <b><?php echo $this->lang->line('ma_x');?> &nbsp;<?php echo $this->lang->line('mark') ?></b></th>
                        ...
                        ?>
                        <th class="headerclass" valign="middle" rowspan="2"><b><?php echo $this->lang->line('grade') . " " . $this->lang->line('point'); ?></b></th>
                        <th class="headerclass" valign="middle" rowspan="2"><b><?php echo $this->lang->line('credit') . " " . $this->lang->line('hours') ?></b></th>
                        <th class="headerclass"  valign="middle" rowspan="2"><b><?php echo $this->lang->line('quality') . " " . $this->lang->line('point') ?></b></th>
                        <?php
                    }
                    ...
                    <tr>
                        <!--<td><?php echo $exam_result_value->subjectpaper_papername.''.$exam_result_value->subjectpaper_papercode; ?></td>-->
                        <td>
                        ...
                        if ($exam->exam_group_type != "gpa") {
                            ...
                            <td>
                                <?php
                                echo $exam_result_value->get_marks+$exam_result_value->get_cmarks;
                    ...
                    <td class="footerclass"><b><?php echo $this->lang->line('Total_mark') ?></b></td>
                    <td class="footerclass">
                    <b><?php echo number_format($total_obtain_marks, 2, '.', ''); ?></b>
                    </td>
                    
                    
                    <td class="footerclass">
                    <b> <?php echo number_format($total_min_marks, 2, '.', ''); ?></b>
                    </td>
                    
                    <td>
                    <b><?php echo number_format($total_max_marks, 2, '.', ''); ?></b>
                    </td>
