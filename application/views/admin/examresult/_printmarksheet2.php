                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" class="">
                                    ...
                                    <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span>
                                    </td>
                                    ...
                                    <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('exam_mother_name'); ?>
                                    </td>
                                    <td style="width:2%;text-transform: uppercase;">:</td>
                                    <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['mother_name']; ?></span>
                                     ...
                                     <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('date_of_birth'); ?>
                                    </td>
                                    <td style="width:2%;text-transform: uppercase;">:</td>
                                    <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['dob']; ?></span>
                                    </td>
                                        </tr>
                                        <?php
                                    }
                                    ...
                                    <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('class'); ?>
                                    </td>
                                    <td style="width:2%;text-transform: uppercase;">:</td>
                            ...
                            <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['section']; ?> </span>
                                    ...
                                    if ($template->school_name != "") {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('school_name'); ?>
                            </td>
                            <td style="width:2%;text-transform: uppercase;">:</td>
                            <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $template->school_name; ?> </span>
                                    ...
                                    if ($template->exam_center != "") {
                                        ...
                                        <tr>
                                           ...
                                           <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"> 
