    ...
    <section class="content">
        ...
        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('exam') . " " . $this->lang->line('result'); ?></h3>
                              ...
                              <table class="table table-striped table-bordered table-hover example" border="2" cellspacing="0" width="100%">
                                                        ...
                                                        if ($exam_details->exam_group_type == "school_grade_system" || $exam_details->exam_group_type == "basic_system" || $exam_details->exam_group_type == "coll_grade_system") {
                                                         ...
                                                         <?php
                                                            ...
                                                            if ($exam_details->exam_group_type != "gpa") {
                                                                ?>
                                                                <th>
                                                                    <?php //echo $this->lang->line('result') ?></th>
                                                                <?php
                                                            }
                                                            ?>
                                                            <?php
                                                    ...
                                                    foreach ($studentList as $student_key => $student_value)
                                                     {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!--<?php echo ($student_value->exam_roll_no != 0) ? $student_value->exam_roll_no : "-"; ?> -->
                                                            ...
                                                            if (!empty($subjectList)) {
                                                                    ...
                                                                    <td style="min-height:500px; height:auto;">
                                                                        ...
                                                                        if ($result) {
                                                                            ...
                                                                            if ($exam_details->exam_group_type == "gpa") {
                                                                                ...
                                                                                if ($result->get_cmarks < $subject_value->min_cmarks) {
                                                                                    $result_status_cmark = 0;
                                                                                    $subject_status_cmark = 0;
                                                                                }

                                                                                ?>


                                                                                <?php echo $result->get_marks; ?>


                                                                                <p style="min-height:40px; height:auto;">
                                                                                <?php
                                                                               ...
                                                                               <p style="min-height:20px; height:auto;">

                                                                               <b>                                                                                
                                                                               <?php echo $this->lang->line("cmarks");?></b>&nbsp;<?php
                                                                            ...
                                                                            $tot_mark_cmark= $result->get_marks + $result->get_cmarks;
                                                                            ?>
                                                                             </p>
                                                                            ...
                                                                            <b>
                                                                                ...
                                                                                <?php echo $this->lang->line("total");?></b>&nbsp;<?php

                                                                                

                                                                                  echo number_format($tot_mark_cmark, 2, '.', '');
                                                                                  echo "<br>";
                                                                               ...
                                                                               ?>
                                                                                <p class="text">
                                                                                   ...
                                                                                   <b><?php echo $this->lang->line("note");?></b>&nbsp;


                                                                                    <?php echo $result->note; ?></p>
                                                                ...
                                                                if ($exam_details->exam_group_type == "school_grade_system" || $exam_details->exam_group_type == "basic_system" || $exam_details->exam_group_type == "coll_grade_system") {
                                                                    ?>
                                                                    <td><p style="min-height:40px; height:auto;">

                                                                        <?php echo number_format($get_marks, 2, '.', '') . "/" . number_format($total_marks, 2, '.', ''); 
                                                                    ...
                                                                    ?><b></p>
                                                                        <p style="min-height:20px; height:auto;">
                                                                        <?php echo $this->lang->line("cmarks"); ?></b>&nbsp;

                                                                    <?php
                                                                     echo number_format($get_cmarks, 2, '.', '') . "/" . number_format($total_cmarks, 2, '.', ''); 
                                                                    ?>
                                                                </p>
                                                                    </td>
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $finaltotalmax=$total_marks+$total_cmarks;


                                                                        $finaltol=$get_marks+$get_cmarks;
                                                                        $finalmaxtol=$total_marks+$total_cmarks;
                                                                        echo number_format($finaltol, 2, '.', '').'/'.number_format($finaltotalmax, 2, '.', '');
                                                                        ?>
                                    ...
                                    $total_percentage = ($finaltol * 100) / $finalmaxtol;
                                    echo number_format($total_percentage, 2, '.', '');
                                                                       ...
                                                                       /*echo "<br>";
                                                                       echo "<br>";
                                                                        echo $this->lang->line("cmarks");   ?>&nbsp;
                                                                        <?php

                                                                       $total_cmarkpercentage = ($get_cmarks * 100) / $total_cmarks;
                                                                        echo number_format($total_cmarkpercentage, 2, '.', '');
                                                                         echo "<br>"; 
                                                                         */                                                                       
                                                                        ?>
                                                                    </td>                                                                   
                                                            ...
                                                            if ($exam_details->exam_group_type == "gpa") {
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($total_credit_hour > 0) {
                                                                        ...
                                                                        $percentage_cgrade = ($get_cmarks * 100) / $total_cmarks;
                ...
                if ($no_subject_result_cmark) {
                if ($result_status_cmark) 
                {
                $c_res= "pass";
                //echo "Pass";
