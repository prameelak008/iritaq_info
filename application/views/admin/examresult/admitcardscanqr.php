        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/examresult/admitcardscanqr') ?>" method="post" class="">
                    ...
                    if (isset($resultlist)) {
                        ...
                        <form method="post" action="<?php echo base_url('admin/examresult/generatemultiple') ?>">
                            <div  class="" id="duefee">
                                                        ...
                                                        <tr>
                                                            <td class="text-center"><input type="checkbox" class="checkbox center-block" data-student_id="<?php echo $student['id'] ?>"  name="check" id="check" value="<?php echo $student['id'] ?>">
                                                                ...
                                                                <input type="hidden" name="id_card_id" id="id_card_id" value="<?php echo $idcardResult[0]->id ?>">
                                                                 ...
                                                                 <input type="hidden" name="exam_group_id" id="exam_group_id" value="<?php echo $exam_group_id; ?>">
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/examresult/generatemultiple") ?>',
                    type: 'post',
                    dataType: 'JSON',
                    data: {'data': JSON.stringify(array_to_print), 'class_id': classId, 'id_card': idCard,'exam_id':exam_id,'exam_group_id':exam_group_id,'session_id':session_id },
