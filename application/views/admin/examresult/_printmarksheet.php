                ...
                .denifittable th{border: 1px solid #999;}
                .denifittable th,
                .denifittable td {border: 1px solid #999;
                border-collapse: collapse;border-left: 1px solid #999;}
                .denifittable tr th {padding: 10px 10px; font-weight: normal;}
                .denifittable tr td {padding: 10px 10px; font-weight: normal;} */
                ...
                .tablemain{position: relative;z-index: 1;border:1px solid #000; padding: 5px;height: 100;}
                </style>
                ...
                ?>
                <tr>
                <td valign="top" style="font-size: 42px; font-weight: 800; text-align: center;"><?php echo $template->heading; ?></td>
                </tr>
                <?php 
                }
                if ($template->title != "") {
                ?>
                <tr>
                <td valign="top" style="font-size: 20px; font-weight: 600; text-align: center; text-transform: uppercase;"><?php echo $template->title; ?></td>
                </tr>
                <?php
                }
                ?>
                ...
                <?php
                if ($template->is_examination_course) 
                {
                ?>
                <tr>
                <td style="width:40%;text-transform: uppercase;"><?php echo $this->lang->line('Name_of_the_examination'); ?>
                </td>
                <td style="width:10%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;"><?php echo $marksheet_Newexamgroup; ?>
                </td>
                </tr>


                <tr>
                <td style="width:40%;text-transform: uppercase;"><?php echo $this->lang->line('course'); ?>
                </td>
                <td style="width:10%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;"><?php echo $marksheet_Newexambatch; ?>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"><?php echo $this->lang->line('name_prefix'); ?>
                </td>
                <td style="width:2%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span>
                </td>
                </tr>
                ...
                if ($template->is_rollactive) 
                {
                ?>
                <tr>
                <td style="width:45%;text-transform: uppercase;"> <?php echo $this->lang->line('rollactive'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['student_roll_no']; ?></span>
                </td>
                </tr>
                ...
                <td style="width:20%;text-transform: uppercase; padding-bottom: 15px;"><?php echo $this->lang->line('marksheet_father_name') ?>
                </td>
                <td style="width:2%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['father_name']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('exam_mother_name'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['mother_name']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('date_of_birth'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;">
                <span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['dob']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('class'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['class'] . " (" . $student_value['section'] . ")"; ?></span>
                </td>
                </tr>
                <?php
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['class_id']; ?> </span>
                </td>
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $student_value['section']; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; padding-bottom: 15px;"> <?php echo $this->lang->line('school_name'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $template->school_name; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; padding-bottom: 15px;"> 
                <?php echo $this->lang->line('exam') . " " . $this->lang->line('center') ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;padding-left: 5px;"><span style="padding-left: 30px; font-weight: bold;"><?php echo $template->exam_center; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                ?>
                <table cellpadding="0" cellspacing="0" width="100%" class="denifittable" style="text-align: center;margin-top:40px;">
                <thead>
                <tr>

                <th><?php echo $this->lang->line('Papers') ?></th>
                ...
                <th valign="middle"><?php echo $this->lang->line('mark') . " " . $this->lang->line('awarded') ?></th>
                <th valign="middle" ><?php echo $this->lang->line('pass') . " " . $this->lang->line('mark') ?></th>
                <th valign="middle"><?php echo $this->lang->line('max') . " " . $this->lang->line('awarded') ?></th>
                ...
                */
                ...
                ?>
                <tr >
                <td><?php echo $this->lang->line('Total_mark') ?></td>                                                   
                ...
                ?>
                <tr>
                <td valign="top" style="text-transform: uppercase; padding-bottom: 15px; line-height: normal;text-align:<?php echo $template->footer_align; ?>"><?php echo $template->content_footer ?></td>
                </tr>
                <?php
                }
                ?>-->
                ...
                ?>
                <tr>
                <td valign="top" style=" padding-bottom: 15px; line-height: normal;text-align:<?php echo $template->footer_align; ?>"> <?php echo $template->content_footer; ?></td>
                </tr>
                <?php
                }
                ?> 
                ...
                <tr><td valign="top" height="30"></td></tr>
                <?php
                if ($template->footer_text_bottom != "") {
                ?>
                <tr>
                <td valign="top" style=" padding-right: 50px;padding-top:<?php echo $template->footer_bottom_padding; ?>px; line-height: normal;text-align:<?php echo $template->footer_align_bottom; ?>"><b> <?php echo $template->footer_text_bottom; ?></b></td>
                </tr>
                <?php
                }
                ?>  
                ...
                <tr >
                <td style="width:45%;text-transform: uppercase;"><?php echo $this->lang->line('Name_of_the_examination'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><?php echo $marksheet_Newexamgroup; ?>
                </td>
                </tr>


                <tr >
                <td style="width:45%;text-transform: uppercase;"><?php echo $this->lang->line('course'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><?php echo $marksheet_Newexambatch; ?>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; "><?php echo $this->lang->line('name_prefix'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;">
                <span style=" font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; "><?php echo $this->lang->line('marksheet_father_name') ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['father_name']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase;"> <?php echo $this->lang->line('exam_mother_name'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['mother_name']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase;"> <?php echo $this->lang->line('date_of_birth'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['dob']; ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; "> <?php echo $this->lang->line('class'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['class'] . " (" . $student_value['section'] . ")"; ?></span>
                </td>
                </tr>
                <?php
                } elseif ($template->is_class) {
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $student_value['class_id']; ?> </span>
                </td>
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style="font-weight: bold;"><?php echo $student_value['section']; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:45%;text-transform: uppercase; "> <?php echo $this->lang->line('school_name'); ?>
                </td>
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $template->school_name; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $template->exam_center; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                ?>
                <tr>
                <td valign="top" style="text-transform: uppercase;  line-height: normal;"><?php echo $template->content ?></td>
                </tr>
                <?php
                }
                ?>
                ...
                <!--<th valign="top" style="text-align: left;border-right:1px solid #999"><?php echo $this->lang->line('arabic') ?></th>-->
                ...
                */
                ...
                ?>
                <tr>
                <td valign="top" style="padding-right: 40px;padding-top:<?php echo $template->footer_bottom_padding; ?>px; line-height: normal;text-align:<?php echo $template->footer_align_bottom; ?>"><b> <?php echo $template->footer_text_bottom; ?></b></td>
                </tr>
                <?php
                }
                ?>  
                ...
                /* body{padding   : 0; margin:5mm 5mm 5mm 5mm; font-family: arial; color: #000; font-size: 10px; }
                .tableone{}
                .tableone td{ font-size:10px}
                .denifittable th{font-size: 12px}
                .denifittable th,
                .denifittable td {border: 1px solid #000000;
                ...
                /* .denifittable tr td {padding: 10px 0px; font-weight: normal; font-size: 10px} */
...
.preprint-table td {
  ...
  padding: 5px;
                ...
                @page {
                size: A4; /* A4 size */
                 margin: 10mm; /* Optional: customize as needed */               
                }                
                .no-print {
                display: none;
                }
                ...
                <tr style="height:<?php echo $template->header_height; ?>px">
                <td>
                ...
                ?>
                <tr>
                <td valign="top" style="font-size: 18px; font-weight: 600; color: red;text-align: center; text-transform: uppercase;"><?php echo $template->title; ?></td>
                </tr>
                <?php
                }
                ?>
                ...
                <tr>
                <td valign="top" style="height: 1.27cm !important;"></td>
                </tr>
                </table>
                </td>
                </tr>
                ...
                ?>                    
                <tr class="trstyle">
                <td class="tdstylelabel" ><?php echo $this->lang->line('Name_of_the_examination'); ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><?php echo $marksheet_Newexamgroup; ?>
                </td>
                </tr>


                <tr class="trstyle">
                <td class="tdstylelabel"><?php echo $this->lang->line('course'); ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><?php echo $marksheet_Newexambatch; ?>
                </td>
                </tr>
                <?php
                }
                ...
                <td class="tdstylelabel"><?php echo $this->lang->line('name_prefix'); ?>
                </td>
                <td  class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span>
                </td>
                ...
                ?> 
                <tr class="trstyle">                              
                <td class="tdstylelabel" > <?php echo $this->lang->line('rollactive'); ?>
                </td>
                <td class="tdstyledot">:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $student_value['student_roll_no']; ?></span>
                </td>
                </tr>                      
                <?php
                }                   
                ...
                <td class="tdstylelabel" ><?php echo $this->lang->line('marksheet_father_name') ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle"><span style=" font-weight: bold;"><?php echo $student_value['father_name']; ?></span>
                ...
                ?>
                <tr class="trstyle">
                <td class="tdstylelabel" > <?php echo $this->lang->line('exam_mother_name'); ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $student_value['mother_name']; ?></span>
                ...
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $student_value['dob']; ?></span>
                ...
                <td class="tdstylelabel" > <?php echo $this->lang->line('class'); ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $student_value['class'] . " (" . $student_value['section'] . ")"; ?></span>
                </td>
                </tr>
                <?php
                } elseif ($template->is_class) {
                ...
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $student_value['class_id']; ?> </span>
                </td>
                ...
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style="font-weight: bold;"><?php echo $student_value['section']; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td class="tdstylelabel" > <?php echo $this->lang->line('school_name'); ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $template->school_name; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <td class="tdstylelabel" > 
                <?php echo $this->lang->line('exam') . " " . $this->lang->line('center') ?>
                </td>
                <td class="tdstyledot" >:</td>
                <td class="tdstyle" ><span style=" font-weight: bold;"><?php echo $template->exam_center; ?> </span>
                </td>
                ...
                {
                ?>
                <!-- <div style="min-height:450px;padding-top:2px;padding:3mm 3mm 3mm 3mm;"> -->

                <div style="min-height:18.99cm;">
                <table cellpadding="0" cellspacing="0" width="100%" class="preprint-table" style="text-align: center;">
                <thead>
                <tr>
                <th class="headerclass" rowspan="2"><b><?php echo $this->lang->line('course_code'); ?></b></th>
                <th class="headerclass" rowspan="2"><b><?php echo $this->lang->line('subjects'); ?></b></th>
                <!-- <th class="headerclass" rowspan="2"><b><?php echo $this->lang->line('code'); ?></b></th> -->
                <th class="headerclass" colspan="2"><b><?php echo $this->lang->line('mark') . " " . $this->lang->line('awarded'); ?></b></th>
                <th class="headerclass rotate-text" rowspan="2"><b><?php echo $this->lang->line('total'); ?></b></th>
                <th class="headerclass rotate-text" rowspan="2"><b><?php echo $this->lang->line('r_s_i'); ?></b></th>
                <th class="headerclass rotate-text" rowspan="2"><b><?php echo $this->lang->line('status'); ?></b></th>
                <th class="headerclass rotate-text" rowspan="2"><b><?php echo $this->lang->line('maximum'); ?></b></th>
                <th class="headerclass" rowspan="2"><b><?php echo $this->lang->line('arabic'); ?></b></th>
                </tr>
                <tr>
                <th class="">TE</th>
                <th class="">CE</th>
                ...
                foreach ($student_value['exam_result'] as $exam_result_key => $exam_result_value) {                     
                $total_min_marks += $exam_result_value->min_marks;
                $total_max_marks += $exam_result_value->max_marks;
                $total_obtain_marks += $exam_result_value->get_marks + $exam_result_value->get_cmarks;
                ?>
                <tr>
                ...
                <td>
                <?php  $totalvalue=$exam_result_value->get_marks + $exam_result_value->get_cmarks; 
                echo $totalvalue;
                ?>
                </td>

                <td><?php echo $exam_result_value->rsi_mode; ?></td> 
                <td>
                <?php  
    if ($exam_result_value->attendence == "absent") {
        echo "A";
    } else {
        $max_marks = $exam_result_value->max_marks ?? 100;
        $totalvalue = $exam_result_value->get_marks + $exam_result_value->get_cmarks;
        $percentage = ($max_marks > 0) ? ($totalvalue / $max_marks) * 100 : 0;
        

        $result = ($percentage >= 40) ? "P" : "F";
        echo $result;
    }
                    ?>
                ...
                <td>
            <?php                 
               $maxtot= $exam_result_value->max_cmarks+$exam_result_value->max_marks;
               echo $maxtot; 
               ?></td>

               <td><?php echo $exam_result_value->arabic_name; ?></td>

                </tr>
                <?php
                $total_getmarks    =   $total_getmarks+ $exam_result_value->get_marks;            
                $total_get_cmarks  =   $total_get_cmarks+ $exam_result_value->get_cmarks; 
                $grandtot          =   $grandtot+$totalvalue;
                $grandmaxtot       =   $grandmaxtot+$maxtot;                
                 } 
                 ?>                
                <tr>             

                <td colspan="2" class=""><b><?php echo $this->lang->line('Total_mark'); ?></b></td>
                <td colspan="" class=""><b><?php echo $total_getmarks; ?></b></td>
                <td colspan="" class=""><b><?php echo $total_get_cmarks; ?></b></td>
                <td colspan="2" class=""><b><?php echo $grandtot; ?></b></td>
                <td colspan="2" class=""><b><?php echo  $grandmaxtot ; ?></b></td>
                <td></td>                 

                <!-- <td colspan="2" class="footerclass"><b><?php echo number_format($total_obtain_marks, 2); ?></b></td>
                <td class="footerclass"><b><?php echo number_format($total_min_marks, 2); ?></b></td>
                <td colspan="4" class="footerclass">&nbsp;</td> -->
                ...
                <table cellpadding="0" cellspacing="0" width="100%"  class="preprint-table" style="text-align: center;">
                <tr><td><?php echo $this->lang->line('semester') .'&nbsp;'.$this->lang->line('status'); ?></td>
                
                <!-- <td colspan="3"><?php
      if ($grandmaxtot > 0) {
          $percentage = ($grandtot / $grandmaxtot) * 100;
          if ($percentage >= 40) {
              echo 'Passed, Successfully Completed';
          } else {
              echo 'Failed';
          }
      } else {
...
if (!empty($exam_result)) {
    foreach ($exam_result as $exam_result_value) {
        if ($exam_result_value->attendence === "absent") {
            $hasAbsent = true;
            break;
        }
...
?>
                ...
                <tr><td><?php echo $this->lang->line('percentage'); ?></td><td>
    ...
    ?>
                ...
                <td>Division</td><td>Excellent</td></tr>
                </table>
                ...
                ?>
                <tr>
                <td valign="top" style="padding-bottom: 10px; line-height: normal;text-align:<?php echo $template->footer_align; ?>"> <?php echo $template->content_footer; ?></td>
                </tr>
                <?php
                }
                */
                ...
                */
                ...
                ?>
                <table cellpadding="0" cellspacing="0" width="100%"  class="tablemain1">
                <tr>
                <td valign="top">
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                ...
                <tr>
                <td valign="top" style="font-size: 20px; height:1.27cm; font-weight: 600; text-align: center; text-transform: uppercase;"><?php echo $template->title; ?></td>
                </tr>
                <!-- <tr>
                <td valign="top" height="5"></td>
                </tr> -->
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname);  ?></span>
                </td>
                </tr>
                <?php
                }
                ...
                <td style="width:5%;text-transform: uppercase;">:</td>
                <td style="width:50%;padding-left: 30px; font-weight: bold;"><span style=" font-weight: bold;"><?php echo $template->exam_center; ?> </span>
                </td>
                </tr>
                <?php
                }
                ...
                <th valign="middle" rowspan="2"><?php echo $this->lang->line('mark') . " " . $this->lang->line('awarded') ?></th>
                <th valign="middle" rowspan="2"><?php echo $this->lang->line('pass') . " " . $this->lang->line('mark') ?></th>
                <th valign="middle" rowspan="2"><?php echo $this->lang->line('max') . " " . $this->lang->line('marks') ?></th>
                <?php
                } else if ($exam->exam_group_type == "gpa") {
                ?>
                ...
                */
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="" style="text-align: center; text-transform: uppercase;">
                <thead>
                <tr>
                <th> <?php echo $this->lang->line('exam'); ?></th>
                <?php
                ...
                <td valign="top">
                <table cellpadding="0" cellspacing="0" width="100%" class="">
                <tr style="height:<?php echo $template->footer_height; ?>px">
                <td>
                </td>
                </tr>
                </table>
