...
.pagebreak
 {
    ...
    clear: both;
                   ...
                   <style type="text/css">
                    ...
                    @page{padding: 0; margin:0;size: A4;}

                    body{padding: 0; margin:5mm 3mm 3mm 3mm; font-family: arial; color: #000; font-size: 8px; line-height: normal;}
                    .tableone{}
...
?>
                ...
                <div class="tablemain1">
                   ...
                   <div style="width:100%">
                    <span>
<h1 style="text-align:center">APPLICATION FOR REVALUATION</h1>
...
foreach($revluation_marks as $reval_mark)
{
foreach($reval_mark as $reval)
{

if($student_value->student_id==$reval['exam_group_exam_revaluation_student_studentid'])
{ 
?>
...
<td><?php echo $reval['gtcmark'];  ?></td>
<td><?php echo $reval['gtmark'];  ?></td>
<td><?php  $obtainedtotal= $reval['gtcmark']+$reval['gtmark'];  ?>
<?php




$maxtotal= $reval['max_cmarks']+$reval['max_marks'];
...
<div class="wrapper">
  ...
  text-align: left; width: 100%;">
    ...
    <tbody>
      <tr>
        <td>Description</td>
        <td style="text-align:right; padding-right:10px;">Amount <i class="fa fa-rupee"></i>  </td>
      </tr>


      <tr>
        <td>Application Fee</td>
        <td style="text-align:right; padding-right:10px;"><?php $feetotal= $gcount*$revaluation_feecharge['examfees_charge_fees_charge'];
      ...
      <tr>
        <td>Total Amount</td>
        <td style="text-align:right; padding-right:10px;"><?php   $feegrandtotal=$feetotal+$revaluation_feecharge['examfees_charge_processing_charge'];
    ...
    <thead>
      <tr style="background-color:#c5cac5;border: 1px solid #000;">
       <th colspan="2" >Payment Details</th>
        ...
        $this->db->where('fees_revaluationpayment_examgroup', $post_exam_id);
        $this->db->where('fees_revaluationpayment_examgroupbatch', $post_exam_group_id);
        $this->db->where('fees_revaluationpayment_session_id', $session_id);
        $this->db->where('fees_revaluationpayment_student_id', $student_value->student_id);
        $this->db->where('fees_revaluationpayment_statuscode', 'S');
        $query = $this->db->get();
        $paymentdetails= $query->row_array();
        ?>
      </tr>
        </thead>
        <tbody>
        ...
        <td><?php  echo $paymentdetails['fees_revaluationpayment_transaction_no']; ?></td>
        </tr>
        ...
        <td><?php  echo $paymentdetails['fees_revaluationpayment_amount']; ?></td>
        </tr>
        
        <tr>
        <td>Order Number</td>
        <td><?php  echo $paymentdetails['fees_revaluationpayment_orderid']; ?></td>
        </tr>
        ...
        echo $paymentdetails['fees_revaluationpayment_transdate']; 
        ?></td>
        </tr>
