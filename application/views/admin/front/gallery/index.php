                                                ...
                                                <tr id="<?php echo $page["id"]; ?>">
                                                    ...
                                                    <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('gallery', 'can_delete')) {
                                                            ?>
                                                            <a data-placement="left" href="<?php echo site_url('admin/front/gallery/delete/' . $page['slug']); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
