                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('menus', 'can_delete')) {
                                                        ...
                                                        if ($menu['content_type'] != "default") {
                                                            ?>
                                                            <a href="<?php echo site_url('admin/front/menus/delete/' . $menu['slug']); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
