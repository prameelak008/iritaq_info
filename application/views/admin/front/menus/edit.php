                                ...
                                <tbody>
                                    <?php if (empty($listMenus)) {
                                        ...
                                        <td class="mailbox-date pull-right no-print">
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/front/menus/delete/<?php echo $menu['slug'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
