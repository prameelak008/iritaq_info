...
<div style="margin: 0 auto; padding: 5px 5px 5px;position: relative; z-index: 0;">
                ...
                <div class="tablemain1">
                   ...
                   <div style="width:100%">
                    <span>
                        <h1 style="text-align:center"><?php echo $this->lang->line('application_for_improvement'); ?>  </h1>
...
foreach($improvement_marks as $improvement_mark)
{
foreach($improvement_mark as $impexam)
{  

if($student_value->student_id==$impexam['exam_group_exam_sayexam_student_studentid'])
{ 
?>

<tr>
<td><?php echo $count; ?></td>
<td><?php echo $impexam['code'];  ?></td>
<td><?php echo $impexam['name'];  ?></td>


<td><?php echo $impexam['get_cmarks'];  ?></td>
<!--<td><?php echo $impexam['gtmark'];  ?></td>-->
<td>

<?php  
/*
$obtainedtotal= $impexam['gtcmark']+$impexam['gtmark'];  





$maxtotal= $impexam['max_cmarks']+$impexam['max_marks'];
...
//$obtainedtotal= $impexam['gtcmark'];  

$obtainedtotal= $impexam['get_cmarks'];



$maxtotal= $impexam['max_cmarks'];
  ...
  text-align: left; width: 100%;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="padding-right:15px;text-align: right;"><?php $feetotal= $gcount*  $sayexamfee_feecharge_ce['examfees_charge_fees_charge']; 
...
<?php echo $sayexamfee_feecharge_ce['examfees_charge_processing_charge']; ?>
        </td>
      </tr>

      <tr>
        <td>Total Amount</td>
        <td style="padding-right:15px;text-align: right;"><?php   $feegrandtotal=$feetotal+$sayexamfee_feecharge_ce['examfees_charge_processing_charge'];
