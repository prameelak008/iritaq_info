        ...
        <span style="text-align:center; font-weight:bold; font-size:18px;">Applied Subjects For Improvement</span>
        ...
        <form id="updateMarksForm" name="frm" method="POST" action="<?php echo site_url('admin/improvement/update_marksentry');?>">
        <p style="text-align:right;">
        <input type="submit" class="btn btn-info "  value="Update Marks" >
        
        <?php
        
        if($improvement_approved_status['exam_group_exam_improvement_approvedstatus']==2)
        {
        ?>
        ...
        <div class="download_label"> <?php echo $this->lang->line('improvement') ; ?></div>
        ...
        <input type="hidden" id="exam_group_exam_improvement_id" name="exam_group_exam_improvement_id[]" value="<?php echo $sy['exam_group_exam_improvement_id']; ?>" >
        <input type="hidden" id="resultid" name="resultid[]" value="<?php echo $sy['resultid']; ?>" >
        <!--<input type="number" class="form-control" id="get_cmarks" name="get_cmarks[]" value="<?php echo $sy['get_cmarks']; ?>" >-->
        
        <input type="number" class="form-control" id="get_marks" name="get_marks[]" value="<?php echo $sy['get_marks']; ?>" >
