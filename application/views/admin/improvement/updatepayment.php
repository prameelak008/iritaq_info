            ...
            <form role="form" action="<?php echo site_url('admin/improvement/checkpayment') ?>" method="post" class="row">
            ...
            <input type="hidden" name="studid" id="studid<?php echo $sl; ?>" value="<?php echo $online['exam_group_exam_sayexam_student_studentid'];?>">
            <input type="hidden" name="group" id="group<?php echo $sl; ?>" value="<?php echo  $online['exam_group_exam_sayexam_examid']; ?>">
            <input type="hidden" name="exambatchid" id="exambatchid<?php echo $sl; ?>" value="<?php echo $online['exam_group_exam_sayexam_examgroupid']; ?>">
            </td>
            <td>
            ...
            <td>
                ...
                {
                if($fee['fees_improvementpayment_student_id']==$online['exam_group_exam_improvement_student_studentid']
                && $fee['fees_improvementpayment_examgroup']==$online['exam_group_exam_improvement_examid'] 
                && $fee['fees_improvementpayment_examgroupbatch']==$online['exam_group_exam_improvement_examgroupid'] 
                && $fee['fees_improvementpayment_session_id']==$online['exam_group_exam_improvement_session_id'] )
                {
                echo  'Order Id'.'&nbsp;&nbsp;:'. 	$fee['fees_improvementpayment_orderid'];
                echo "<br>";
                echo  'Transaction No'.'&nbsp;&nbsp; :'. 	$fee['fees_improvementpayment_transaction_no'];
                
                echo "<br>";
                echo  'Transaction Date'.'&nbsp;&nbsp; :'. 	$fee['fees_improvementpayment_transdate'];
                
                echo "<br>";
                echo  'Amount'.'&nbsp;&nbsp; :'. 	$fee['fees_improvementpayment_amount'];
                
                echo "<br>";
                echo  'Year'.'&nbsp;&nbsp;:'. 	$fee['fees_improvementpayment_year'];
              
                
                echo "<br>";
                echo  'Notes'.'&nbsp;&nbsp;:'. 	$fee['fees_improvementpayment_notes'];
                echo "<br>";
                
                if($fee['fees_improvementpayment_statuscode'] == 'S') 
                {
                $status = '<span style="font-size:18px;">Success <i class="fa fa-check-circle" style="color:green;"></i></span>';
                } 
                else if($fee['fees_improvementpayment_statuscode'] == 'F') 
                {
                ...
                <button type="button" title="delete"  onClick="return ConfirmDelete(this)" class="fa fa-trash" style="color:red" data-id="<?php echo $fee['fees_improvementpayment_id']; ?>"></button>
                ...
                ?>
                                        ...
                                        <td>
                                        <form id="form" action="<?php echo site_url('admin/improvement/updatefees'); ?>" method="post"  enctype="multipart/form-data">
                                        Order Id :<input type="text" class="form-control" name="orderid" id="orderid" placeholder="Enter Order No" />
                                        <br>
                                        ...
                                        <input type="hidden" class="form-control" name="student_id" id="student_id" value="<?php echo $online['exam_group_exam_improvement_student_studentid']; ?>" />
                                        <input type="hidden" class="form-control" name="examgroup" id="examgroup" value="<?php echo $online['exam_group_exam_improvement_examgroupid']; ?>" /> 
                                        <input type="hidden" class="form-control" name="exam"  id="exam" value="<?php echo $online['exam_group_exam_improvement_examid']; ?>" />
                                        <input type="hidden" class="form-control" name="session_id" id="session_id" value="<?php echo $online['exam_group_exam_improvement_session_id']; ?>" /> 
            ...
            $('#exam_id').removeClass('dropdownloading');
                ...
                $.ajax({
                url: '<?php echo site_url('admin/improvement/updatefees'); ?>',
                type: 'POST',
                data: formData,
                async: false,
                success: function(data) 
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/improvement/deletefees'); ?>",
                cache: false,
                data: {'id': id},
                success: function (data) 
                {
