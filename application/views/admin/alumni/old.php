                                    ...
                                    <tbody>
                                       ...
                                       foreach ($eventlist as $key => $value) {
                                          ...
                                          <tr>
                                            ...
                                            <a onclick="return doconfirm();"  href="<?php echo base_url();?>admin/alumni/delete_event/<?php echo $value['id']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-remove"></i></a></td>
                                          </tr>
                                          <?php
                                       }
                                       ?>
