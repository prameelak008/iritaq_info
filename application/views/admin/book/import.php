...
<hr/></div>
               ...
               <tbody>
                ...
                <hr/>
                   <form action="<?php echo site_url('admin/book/import') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data" acceptcharset="UTF-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?php echo ('Select Subject'); ?></label><small class="req"> *</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?php echo ('Select Library'); ?></label><small class="req"> *</small>
