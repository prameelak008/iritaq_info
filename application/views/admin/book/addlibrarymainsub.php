                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary" style="padding-bottom: 100px">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo ('Add Main Subject'); ?></h3>
                        </div><!-- /.box-header -->

                        <form id="form1" action="<?php echo site_url('Librarymainsub/addmainsub'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
 								<!-- name -->
