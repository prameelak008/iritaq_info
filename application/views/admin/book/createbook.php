...
<div class="content-wrapper">
                        ...
                        <div class="box-body row">
                            ...
                            */
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <option value="<?php echo $subtp['lib_sub_type']; ?>"><?php echo $subtp['lib_sub_type']; ?></option>
                            <?php } ?>
                            </select> 
 ...
 -->
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="place_of_publicaton" name="place_of_publicaton"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('place_of_publicaton'); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="year_of_publishing" name="year_of_publishing"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('year_of_publishing'); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="total_pages" name="total_pages"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('total_pages'); ?>" />
                                <span class="text-danger"><?php echo form_error('total_pages'); ?></span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1"><?php echo ('Second_author'); ?></label>
                                <input id="second_author" name="second_author"  placeholder="" type="text" class="form-control"  value="<?php echo set_value('second_author'); ?>" />
