...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('income', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary" style="padding-bottom: 100px">
                        ...
                        <form id="form1" action="<?php echo site_url('Library/updatelibrary'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                <!-- name -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo ('Library Name'); ?><small class="req"> *</small></label>
                                    <input type="text" name="name" placeholder="Name" class="form-control" value="<?php echo $libedit->library_name; ?>" required>
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
                                <!-- code -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo ('Library Code'); ?><small class="req"> *</small></label>
                                    <input type="text" name="code" placeholder="Code" class="form-control" value="<?php echo $libedit->library_code; ?>" required>
                                </div>
                                <!-- location -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo ('Location'); ?><small class="req"> *</small></label>
                                    <input type="text" name="location" placeholder="Location" class="form-control" value="<?php echo $libedit->library_location; ?>" required>
                                </div>
                                <!-- details -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo ('Details'); ?><small class="req"> *</small></label>
                                    <input type="text" name="details" placeholder="Details" class="form-control" value="<?php echo $libedit->library_details; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo ('Status'); ?><small class="req"> *</small></label>
                                <select class="form-control" name="status" required>
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <option value="1" <?php if($libedit->library_status==1)
                                {
                                echo "selected=selected";
                                }?>><?php echo "Yes"; ?></option>
                                <option value="0" <?php if($libedit->library_status==0)
                                {
                                echo "selected=selected";
                                }?>><?php echo "No"; ?></option>
                                </select>
            ...
            <input type="hidden" name="libid" placeholder="ID" class="form-control" value="<?php echo $libedit->library_id; ?>" required>
