                    ...
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('book_list'); ?></h3><div class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('books', 'can_add')) {
                                ...
                                <a href="<?php echo base_url() ?>admin/book/delete_bulkbook" onclick ="return confirm('Do You want To Delete all Books?');">
                                <button class="btn btn-danger btn-sm" autocomplete="off"><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete')." ".$this->lang->line('all') . " " . $this->lang->line('books'); ?></button>
                                </a>
                            ...
                            <table class="table table-striped table-bordered table-hover book-list" data-export-title="<?php echo $this->lang->line('book_list'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('library'); ?></th>
