                    ...
                    <h3 class="box-title"><i class="fa fa-search"></i> Application For SayExam-CE  </h3> 
                    <div class="box-body">
                        
                        
                    <form role="form" action="<?php echo site_url('user/sayexam/sayexam') ?>" method="post" class="row">
                    ...
                    <!--<button type="submit"   name="view"  class="btn btn-primary pull-right btn-sm checkbox-toggle" style="margin-right:10px;">-->
                    ...
                    <!--<a href="<?php  echo site_url('user/sayexam/sayexam_previous'); ?>">View</a>-->
                    <!--<a href="#" id="viewLink" class="btn btn-secondary">View</a>-->
                    ...
                    <form name="" method="POST" action="<?php   echo site_url('user/sayexam/send_request');?>">
                    ...
                    */
                    ...
                    $obtainedtotal= $exam_result_value->get_cmarks;
                    
                    $maxtotal= $exam_result_value->max_cmarks;
                    ...
                    <?php
                    if($sayexamfee_feecharge_ce['examfees_charge_fees_charge']!="")
                    {
                    echo $sayexamfee_feecharge_ce['examfees_charge_fees_charge'].''.'/Paper';
                    }
                    else
                    {
                    echo "0";
                    ...
                    <?php
                    if($sayexamfee_feecharge_ce['examfees_charge_processing_charge']!="")
                    {
                    echo $sayexamfee_feecharge_ce['examfees_charge_processing_charge'];
                    }
                    else
                    {
                    echo "0";
                    ...
                    <?php
                    if($sayexamfee_feecharge_ce['examfees_charge_fine']!="")
                    {
                    echo $sayexamfee_feecharge_ce['examfees_charge_fine'];
                    }
                    else
                    {
                    echo "0";
                    ...
                    <?php
                    if($sayexamfee_feecharge_ce['examfees_charge_effectivedate']!="")
                    {
                    echo $sayexamfee_feecharge_ce['examfees_charge_effectivedate'];
                    }
                    else
                    {
                    echo "00:00:0000";
                ...
                //   echo "Not Declared";     
                    ...
                    ?>
                            ...
                            <div style="width:100%">
                            <span>
                            <h5 style="text-align:center">SAY EXAM STATUS </h5>
                            </div>
                            
             <form method="post" action="<?php echo base_url('user/sayexam/printsayexam') ?>" id="printMarksheet">
            ...
            <td><?php echo $sayexamfee_feecharge_ce['examfees_charge_processing_charge']; ?></td>
            </tr>
            <?php
            ...
            $totalfee= $sayexamfee_feecharge_ce['examfees_charge_fees_charge'];
            ...
            <td colspan="2"><b><?php   $tot=$totalamt+$sayexamfee_feecharge_ce['examfees_charge_processing_charge']; 
            echo number_format($tot,2);?></b></td>
                    ...
                    <input type="submit" name="submit" value="Printsayexam" class="btn btn-success pull-right btn-sm checkbox-toggle"/>
                    </form>
                    </div>
                    </div>
                     <?php
                    ...
                    function doconfirm()
                    {
                    job=confirm("Are you sure you want to continue your  CE exam application?");
                    if(job!=true)
                    {
                    return false;
                    }
   ...
   document.getElementById('viewLink').addEventListener('click', function (event) 
   {
    ...
    const examGroupId = document.getElementById('exam_group_id').value;
    const examId = document.getElementById('exam_id').value;

    // Validate if both values are selected
    if (!examGroupId || !examId) {
        alert('Please select both Exam Group and Exam.');
        return;
    }

    // Prepare data to send
    const formData = new FormData();
    formData.append('exam_group_id', examGroupId);
    formData.append('exam_id', examId);
    
    alert(formData);

    // Send the AJAX request
    const url = "<?php echo site_url('user/sayexam/sayexam_previous'); ?>";
    ...
    fetch(url, {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Optionally render data dynamically on the page
                document.getElementById('examDetailsContainer').innerHTML = data.html;
            } else {
