                ...
                <form id="updateMarksForm" name="frm" method="POST" action="<?php echo site_url('admin/sayexam/update_marksentry');?>">
                ...
                <input type="text" class="form-control" id="get_cmarks" name="get_cmarks[]" value="<?php echo $sy['get_cmarks']; ?>" ></td>
                
                <!--<td class="headerclass">-->
                <!--    <input type="number" id="get_marks" name="get_marks[]"  value="<?php echo $sy['get_marks']; ?>"></td>-->
                ...
                <?php 
                /*$obtainedtotal =$sy['get_cmarks']+ $sy['get_marks'];  echo number_format((float)$obtainedtotal, 2, '.', '');  
                
                $maxtotal= $sy['max_cmarks']+$sy['max_marks'];
                */
                
                $obtainedtotal =$sy['get_cmarks']; 
                echo number_format((float)$obtainedtotal, 2, '.', '');  
                
                $maxtotal= $sy['max_cmarks'];
                ...
                // var exam_group_exam_sayexam_id  =  $('#exam_group_exam_sayexam_id').val();            
                ...
                // $.ajax({
                // type: "POST",   
                // data: {exam_group_exam_sayexam_id:exam_group_exam_sayexam_id,get_cmarks:get_cmarks,get_marks:get_marks},  
                // url: "<?php echo site_url('admin/sayexam/update_marksentry');?>",
