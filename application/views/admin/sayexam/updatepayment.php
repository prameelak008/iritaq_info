            ...
            <form role="form" action="<?php echo site_url('admin/sayexam/checkpayment') ?>" method="post" class="row">
            ...
            <td>
                ...
                ?>
                                        ...
                                        <form id="form" action="<?php echo site_url('admin/sayexam/updatefees'); ?>" method="post"  enctype="multipart/form-data">
            ...
            $('#exam_id').removeClass('dropdownloading');
                ...
                $.ajax({
                url: '<?php echo site_url('admin/sayexam/updatefees'); ?>',
                type: 'POST',
                data: formData,
                async: false,
                success: function(data) 
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/sayexam/deletefees'); ?>",
                cache: false,
                data: {'id': id},
                success: function (data) 
                {
