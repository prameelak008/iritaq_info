...
<td><?php echo $syexam['get_cmarks'];  ?></td>
<!--<td><?php echo $syexam['gtmark'];  ?></td>-->
<td>

<?php  
/*
$obtainedtotal= $syexam['gtcmark']+$syexam['gtmark'];  





$maxtotal= $syexam['max_cmarks']+$syexam['max_marks'];
...
//$obtainedtotal= $syexam['gtcmark'];  

$obtainedtotal= $syexam['get_cmarks'];



$maxtotal= $syexam['max_cmarks'];
