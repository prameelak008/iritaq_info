...
<div class="content-wrapper">
    ...
    <div class="form-group">
    <label for="exampleInputEmail1"><b><?php echo $this->lang->line('last') . " " .$this->lang->line('purchase') . " " . $this->lang->line('price') .':'?></b>&nbsp;&nbsp;<span  id="lastpurchase_price" style="font-weight:bold;"></span></label>
    &nbsp;&nbsp;<label for="exampleInputEmail1"><b><?php echo $this->lang->line('qty').'&nbsp;&nbsp;:'; ?></b>&nbsp;&nbsp;<span  id="lastqty" style="font-weight:bold;"></span></label>
    &nbsp;&nbsp;<label for="exampleInputEmail1"><b><?php echo $this->lang->line('unit').'&nbsp;'. $this->lang->line('price'); ?></b>&nbsp;&nbsp;<span  id="lasttotal_unit" style="font-weight:bold;"></span></label>
    
    </div>                
                                
                                
    <div class="form-group">
    <label for="exampleInputEmail1"><?php echo $this->lang->line('purchase') . " " . $this->lang->line('price') ?></label><small class="req"> *</small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $this->lang->line('unit').'&nbsp;'. $this->lang->line('price'); ?>&nbsp;&nbsp;&nbsp;&nbsp;:<span id="currenttotal_unit"></span></b>
                                    ...
                                    if (empty($itemlist)) {
                                        ...
                                        foreach ($itemlist as $items) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                     <?php echo $items['unit']; ?>
                                                <!--<?php echo number_format($items['purchase_price']/$items['quantity'],3); ?>-->
                                                </td>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('item_stock', 'can_delete')) { ?> 
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/itemstock/delete/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var supplier_id       = $('#supplier_id').val();
            ...
            $.ajax({
                type: "GET",
                url: base_url + "admin/itemstock/getpurchaseprice",
                data: {'store_id':store_id,'itemid':itemid,'supplier_id':supplier_id,},
                dataType: "json",
                success: function (data) 
                {
                $('#lastpurchase_price').html(data.purchase_price);
                $('#lastqty').html(data.quantity);
                var lastunit= (data.purchase_price/data.quantity).toFixed(3);
                $('#lasttotal_unit').html(lastunit);
                }
                ...
                var currnettotal    = $('#currenttotal_unit');
                var unit            = purchase_price/ quantity;
                currnettotal.html(unit);
                }
