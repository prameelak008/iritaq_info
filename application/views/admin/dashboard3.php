...
?>
        ...
        <img src="<?php echo base_url(); ?>uploads/school_content/dashboardimage/<?php  echo $sch_setting->dashboard_logo; ?>" height="300px" width="100%">
...
<i class="fa fa-eye" title="View" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"></i>



<span class="pull-right"><?php echo $Staffattendence_data + 0; ?>/<?php echo $getTotalStaff_data; ?></span>
</p>
...
<i class="fa fa-eye" title="View" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterStudent"></i>
                            </p>
                            ...
                            <div class="progress-group">
                             ...
                             <!--<p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('student') . ' ' . $this->lang->line('absent') . ' ' . $this->lang->line('today'); ?>



<i class="fa fa-eye" title="View" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterAbsentStudent"></i>
                            </p>-->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Staff Present Today-<?php echo date('d-m-Y'); ?></h5>
       ...
       <table class="tablecls" style="border-collapse: collapse; width:100%;" >
        <thead>
            ...
            $i = 0;
                    ...
                    <tr class="trcls" style="border: 1px solid #857d7d;"><td class="tdcls" style="border: 1px solid #857d7d;"><span style="color:#da3400; "><h4><?php  echo $rol['name'];  ?></h4></span>
                    </td></tr>
                    <?php
                    ...
                    <td class="tdcls" style="border: 1px solid #857d7d;">                   
...
<div class="modal fade" id="exampleModalCenterStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Student Present Today-<?php echo date('d-m-Y'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <table class="" style="width:100%;" >
        <thead>        
            ...
            $i = 0;
                   ...
                   <td style="border: 1px solid #857d7d;"><span style="color:#da3400"><h4><?php  echo $cls['class'];  ?></h4></span>
                    </td></tr>
                    <?php
