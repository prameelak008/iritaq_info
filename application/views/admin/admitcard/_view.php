...
if ($admitcard->is_roll_no) {
    ?>
                                                <td valign="top" width="30%" style="padding-bottom: 10px; "> <?php echo $this->lang->line('roll_no') ?></td>
                                                <td valign="top" width="40%" style="font-weight: bold;padding-bottom: 10px;">161066</td>
                                                <?php
}
?>
                                            <?php
if ($admitcard->is_admission_no) {
    ?>
                                                ...
                                                <td valign="top" width="20%" style="font-weight: bold;padding-bottom: 10px;">18S168375</td>
                                                <?php
}
?>
...
if ($admitcard->is_address) {
    ?>
                                                ...
                                                <td colspan="3" valign="top" style="text-transform: uppercase; font-weight: bold;padding-bottom: 10px;">56 Main Street, Suite 3,<br> Brooklyn, NY 11210-0000</td>
                                                <?php
}
?>
