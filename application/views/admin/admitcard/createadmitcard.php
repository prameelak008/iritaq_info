    ...
    ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea name="content_instruction" type="text" class="form-control ckeditor"><?php echo set_value('content_instruction'); ?></textarea>
                                </div>


                                <div class="form-group">
                                    <label><?php echo $this->lang->line('warning'); ?></label>
                                    <textarea name="content_warning" type="text" class="form-control ckeditor"><?php echo set_value('content_warning'); ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="sign" placeholder="" type="file" class="filestyle form-control" data-height="28"  >
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="documents" name="sign_two" placeholder="" type="file" class="filestyle form-control" data-height="28"  >
                                    <!--<span class="text-danger"><?php echo form_error('sign'); ?></span>-->
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                   <label><?php echo $this->lang->line('qrcode'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_qrcode" name="is_section" type="checkbox" class="chk" value="1">
