        ...
        ?>
                    ...
                    <div id="" style="width:100%;">
                         ...
                         <div id="" style="width:75%; float:left;">
                            ...
                            <table cellpadding="0" cellspacing="0" class="denifittable" width="50%" style="text-transform: uppercase;float:left;">
                       ...
                       if ($admitcard->is_name) {
                            ?>
                                            <tr >
                                                <td ><?php echo $this->lang->line('candidates') . " " . $this->lang->line('name') ?></td>
                        ...
                        <table cellpadding="0" cellspacing="0" width="50%"  class="denifittable" style="text-transform: uppercase;float:left;">
...
?>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%"   style="text-transform: uppercase;float:left;"> 
        ...
        <tr class="first_td"><td>&nbsp;</td></tr>     
                         ...
                         <div id="" style="width:24%;float:left;margin-left:2px;">
                            <table cellpadding="0" cellspacing="0" width="100%"   style="text-transform: uppercase;">
                                ...
                                if ($student_value->image != '') {
                                ?>
                                <img src="<?php echo base_url() . $student_value->image; ?>" width="200" height="200" style="border: 2px solid #fff;
                                outline: 1px solid #000000;">
                                <?php }?>
                       ...
                       <!--<table cellpadding="0" cellspacing="0" width="30%"   style="text-transform: uppercase;float:left;">
                         <?php
if ($admitcard->is_photo) {
            ?>
                                    <tr> 
...
if ($student_value->image != '') {
                ?>
                                            <img src="<?php echo base_url() . $student_value->image; ?>" width="100" height="150" style="border: 2px solid #fff;
                                                 outline: 1px solid #000000;">
                                             <?php }?>
