...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <textarea name="content_instruction" type="text" class="form-control ckeditor">
                                    <?php echo set_value('content_instruction', ($admitcard->content_instruction)); ?></textarea>                                   
                               </div>
            
            
            
                               <div class="form-group">
                                <label><?php echo $this->lang->line('Warning'); ?></label>
                                <textarea name="content_warning" type="text" class="form-control ckeditor">
                                    <?php echo set_value('content_warning', ($admitcard->content_warning)); ?></textarea>                                   
                               </div>
                ...
                <input id="documents" name="left_logo" placeholder="" type="file" class="filestyle form-control" data-height="28">
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->left_logo; ?>" style="width:20%; height:20%">
                ...
                <a href="<?php echo site_url();  ?>admin/admitcard/removeleftlogo/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Image</small></i></a>
                ...
                <input id="documents" name="right_logo" placeholder="" type="file" class="filestyle form-control" data-height="28">
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->right_logo; ?>" style="width:20%; height:20%">
                ...
                <a href="<?php echo site_url();  ?>admin/admitcard/removerightlogo/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Image</small></i></a>
                ...
                <span class="text-danger"><?php echo form_error('right_logo'); ?></span>
                 ...
                 <div class="form-group">
                <label><?php echo $this->lang->line('middle') . " " . $this->lang->line('logo') ?></label>

                


                <input id="documents" name="middle_logo" placeholder="" type="file" class="filestyle form-control" data-height="28">
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->middle_logo; ?>" style="width:20%; height:20%">
                ...
                <a href="<?php echo site_url();  ?>admin/admitcard/removemiddlelogo/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Image</small></i></a>

                <span class="text-danger"><?php echo form_error('middle_logo'); ?></span>
                ...
                <input id="documents" name="sign" placeholder="" type="file" class="filestyle form-control" data-height="28"  name="sign">
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->sign; ?>" style="width:20%; height:20%">
<a href="<?php echo site_url();  ?>admin/admitcard/removesign/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Sign</small></i></a>
                ...
                <span class="text-danger"><?php echo form_error('sign'); ?></span>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input id="documents" name="sign_two" placeholder="" type="file" class="filestyle form-control" data-height="28"  name="sign_two">
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->sign_two; ?>" style="width:20%; height:20%">
                    ...
                    <?php }?>
                                    ...
                                    <a href="<?php echo site_url();  ?>admin/admitcard/removerightsign/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Sign</small></i></a>
                    ...
                    {
                    ?>
                    <img src="<?php  echo base_url();?>uploads/admit_card/<?php echo $admitcard->background_img; ?>" style="width:20%; height:20%">
...
<a href="<?php echo site_url();  ?>admin/admitcard/removebackground/<?php echo $admitcard->id; ?>" onclick="return doconfirm();"><i style="color:#ab1616;"class="fa fa-remove"><small>Remove Background</small></i></a>
<span class="text-danger"><?php echo form_error('background_img'); ?></span>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('qrcode'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_qrcode" name="is_qrcode" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_qrcode', '1', (set_value('is_qrcode', $admitcard->is_qrcode) == 1) ? true : false); ?>>
                                        <label for="is_qrcode" class="label-success"></label>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_status" name="is_status" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_status', '1', (set_value('is_status', $admitcard->is_status) == 1) ? true : false); ?>>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    ...
                                                    <?php if ($certificate->is_status =='1')
                                                     {
                                                    ?>
                                                        
                                                     
                                               <button type="button" class="btn btn-success btn-sm"> <?php echo "Active"; ?></button>
                                                    <?php } 
                                                    else 
                                                    {                                                      
                                               ...
                                               <button type="button" class="btn btn-warning btn-sm"><?php echo "InActive"; ?></button>
...
if ($this->rbac->hasPrivilege('design_admit_card', 'can_edit')) {
        ...
        if ($this->rbac->hasPrivilege('design_admit_card', 'can_delete')) {
            ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/admitcard/delete/<?php echo $certificate->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
