                ...
                <h1>
                <i class="fa fa-map-o"></i> <?php echo $this->lang->line('moderation').'&nbsp;'.$this->lang->line('report'); ?> <small></small>  
                </h1>
                </section>
                <!-- Main content -->
                ...
                <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('moderation').'&nbsp;'.$this->lang->line('report'); ?></h3> 
                </div>
                
                
                <div class="box-body">
                <form role="form"  action="<?php echo site_url('admin/moderation/moderationreport') ?>" method="post" >
                ...
                <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('moderation').'&nbsp;'.$this->lang->line('report'); ?></h3>
                </div>
                ...
                <th class="text-left"><?php echo $this->lang->line('moderation') .''.$this->lang->line('TE')?></th>
                <th class="text-left"><?php echo $this->lang->line('moderation') .''.$this->lang->line('CE')?></th>
                ...
                <td class="text-left">
                <?php echo $reskey->get_marks; ?>
                </td>
                
                <td class="text-left"> 
                <?php echo $reskey->get_cmarks; ?>
                </td>
                
                 <td class="text-left" > 
                <?php echo $student_value->moderation_te;
                ?>
                </td>
                
                <td class="text-left" > 
                <?php echo $student_value->moderation_ce;
                ?>
                </td>
                
               
                <td class="text-left">
                <?php echo $reskey->note; ?>
                ...
                url: "<?php echo site_url('admin/moderation/getsubject');?>",
