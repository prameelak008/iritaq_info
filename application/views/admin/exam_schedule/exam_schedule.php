...
<style>
  @media print {
    .examhead {
        display: block;
        /* Add any additional styling for printing */
    }
}
</style>
                                    ...
                                    if (!empty($exam_subjects)) {
                                        foreach ($exam_subjects as $exam_subject_key => $exam_subject_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <?php echo $exam_subject_value->subject_name; ?></td>
                                                
                                                <td>
                                                <?php  echo $exam_subject_value->subject_code; ?></td>
                                                ...
                                                $timefrom= $exam_subject_value->time_from;
                                                ...
                                                <td>
                                                   <?php 
                                                          ...
                                                          $timefrom= $exam_subject_value->time_from;
                                                          $duration= $exam_subject_value->duration;
