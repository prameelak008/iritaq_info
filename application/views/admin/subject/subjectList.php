                ...
                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('subject_name').'&nbsp;'. $this->lang->line('arabic'); ?></label><small class="req"> *</small>
                <input autofocus="" id="arabic_name" name="arabic_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('arabic_name'); ?>" />
                <span class="text-danger"><?php echo form_error('arabic_name'); ?></span>
                </div>
                ...
                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('subject_type'); ?></label><small class="req"> *</small>
                <br>
                <?php 
                foreach ($subject_types as $subject_type_key => $subject_type_value) {
                ?>
                ...
                <label class="radio-inline">
                <input type="radio" checked="checked" value="<?php echo $subject_type_key?>" name="type" <?php echo set_radio('type', $subject_type_key, set_value('type')); ?> ><?php echo $subject_type_value; ?> 
                                </label>
                <?php 
                }
                ?>
                ...
                <tr>
                <td class="mailbox-name"> <?php echo $subject['name'] ;
                echo "<br>";
                echo "<br>";

                echo $subject['arabic_name'] ;
                ?>
                </td>
                ...
                ?>
                <a data-placement="left" href="<?php echo base_url(); ?>admin/subject/delete/<?php echo $subject['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
