        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="">
                    ...
                    <table width="100%" style="border:1px solid;height: 99px;text-align: center;font-size: 11px;" class="paytable2">
                        <tr>
                            <th class="thcls"><?php echo $this->lang->line('staff_id'); ?></th>
                            <td ><?php echo $result["employee_id"] ?></td>
                        </tr>
                        <tr>
                            <th class="thcls"><?php echo $this->lang->line('department'); ?></th>
                            <td><?php echo $result["department"] ?></td>
                        </tr>
                        <tr>
                            <th class="thcls"><?php echo ('Name'); ?></th>
                            <td><?php echo $result["name"]." ".$result["surname"] ?></td>
                        </tr>
                        <tr>
                            <th class="thcls"><?php echo $this->lang->line('designation'); ?></th>
                ...
                <div class="col-sm-8">
                    <table width="100%" class="paytable2" style="padding-left: 3px;font-size: 10px; border:1px solid;height: 99px;" border="1">
                        <tr>
                            ...
                            for($i=0;$i<=$lv;$i++)
                            {
                              if($i==1)
                                { ?>
                                   <th width="20px" style="white-space: nowrap;"  class="thcls"><?php echo('Paid Days'); ?></th>
                                <?php
                                }
                              if($i==2)
                                { ?>
                                   <td width="15px" style="text-align: center;padding:1px;" >26</td>
                                <?php
                                }
                              if($i==3)
                                {  ?>
                                   <th width="15px" style="text-align: center;"><?php echo ('L.Days'); ?></th>
                                <?php
                                }
                              if($i==4)
                                {  ?>
                                   <td width="15px" style="text-align: center;padding:1px; border:0px;"><?php echo "4"; ?></td>
                                <?php
                                }
                              if($i>4)
                                {  ?>
                                   <td width="15px" style="text-align: center;padding:1px;border:0px;"></td>
                                <?php
                                }
                            }   
                            ?> 
                        ...
                        <tr class="trow">
                            <th width="20px" style="white-space: nowrap;"  class="thcls"><?php echo ('Leave Type'); ?></th>
                         <?php
                          $i=1;
                          foreach($leave as $ltypes)
                          { 
                             if(empty($ltypes->allotedleavehrs))
                            {
                                $ltypes->allotedleavehrs="0";
                            }
                            ?> 
                            <td width="15px" style="padding:1px;text-align: left;

  white-space: nowrap;text-align: center;"><?php echo $ltypes->lvtypes;
  echo "(";
  echo $ltypes->allotedleavehrs;
  echo ")";
                        ...
                        <tr>
                            <th width="20px"  class="thcls"><?php echo ('Total Used'); ?></th>
                            <?php
                          $i=1;
                          foreach($leave as $ltypes)
                          { 
                            if(empty($ltypes->totalused))
                            {
                                $ltypes->totalused="0";
                            }
                            ?>
                        
                            <td width="15px" style="text-align: center;padding:1px;"><?php echo $ltypes->totalused; ?></td>
                        ...
                        <tr>
                            <th width="20px"  class="thcls"><?php echo ('This Month'); ?></th>
                            <?php
                          $i=1;
                          foreach($leave as $ltypes)
                          { 
                            if(empty($ltypes->thism))
                            {
                                $ltypes->thism="0";
                            }
                            
                            ?>
                            <td width="15px" style="text-align: center;padding:1px;"><?php echo $ltypes->thism; ?></td> 
                             <?php
                          $i++;
                          }
                           ?>
                        ...
                        <tr>
                            <th width="20px" style="white-space: nowrap;"  class="thcls"><?php echo ('Total Balance'); ?></th>
                             <?php
                          $i=1;
                          foreach($leave as $ltypes)
                          { 
                            if(empty($ltypes->lbal))
                            {
                                $ltypes->lbal="0";
                            }
                            ?>
                            <td width="15px" style="text-align: center;padding:1px;"><?php echo $ltypes->lbal; ?></td>
                           <?php
                          $i++;
                          }
                           ?>
