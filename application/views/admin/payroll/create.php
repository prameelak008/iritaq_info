        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php 
                  $hours = substr($deduction_hr,0,strpos($deduction_hr, ":"));
                  $minutes = substr($deduction_hr,strpos($deduction_hr, ":") + 1);
                 //$totabsentdays = str_replace(":", ".", ($deduction_hr)); 
                 //echo $totabsentdays;
                 //echo $d;?>
                     <?php
                        //   $i=1;
                        //   foreach($absent as $countabsent)
                        //   { 
                            
                        //     $countabsent->absentcount;
                        //     $absentdays=$countabsent->absentcount;
                        //     $totabsentdays+=$absentdays;
                        //   $i++;

                        //   }
                          ?>
                           <!-- <input type="text" id="tabsentdays" name="tabsentdays" value="200"> -->
                     <?php
                     /*
                          $i=1;
                        ...
                        <!--<input type="hidden" id="totleavedays" name="totleavedays" value="<?php echo $totlvdays;?>"> -->
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="sameheight">
                                        <div class="payrollbox feebox">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label"><?php echo ('Leave Deduction'); ?></label>
                                                <div class="col-sm-8 deductiondred">
                                                    <input class="form-control" name="leave_deduction" id="leave_deduction" type="text" style="color:#f50000" value="0"/>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function add_allowance() 
    {
       ...
       var totalleavehrs = 0;
    var salperday = 0;
    var leave_deduction = 0;
    
    var noofdays = <?php echo $d;?>;
    var salperhour = basic_pay/noofdays/24;
    var salpermin = basic_pay/noofdays/24/60;

    var hrded = <?php echo $hours; ?>;
    var minded = <?php echo $minutes; ?>;

    var hourded = hrded * salperhour;
    var minuteded = minded * salpermin;

    var totalleaveded = hourded + minuteded;
    var leave_deduction = totalleaveded;
        ...
        //var leave_deduction = document.getElementsByName('leave_deduction');
...
//total_deduction += parseInt(leave_deduction) ;
        ...
        var gross_salary = parseFloat(basic_pay) + parseFloat(total_allowance) - parseFloat(total_deduction) - parseFloat(leave_deduction);

        var net_salary = parseFloat(basic_pay) + parseFloat(total_allowance) - parseFloat(total_deduction) - parseFloat(leave_deduction) - parseFloat(tax);
