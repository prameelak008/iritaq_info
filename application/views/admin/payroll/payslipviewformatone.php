                ...
                <div class="">
                    ...
                    <table class="earntable table table-striped table-responsive" >
                        ...
                        if(!empty($result["leave_deduction"])) {
                            ?>
                            <tr><td></td><td></td>
                                <td class="pttleft"><?php echo ("Leave Deduction"); ?></td>

                                <td class="text-right"><?php echo number_format($result["leave_deduction"],2);?>
                                </td>
                            </tr>
                            <?php  
                            }
                        ...
                        <tr>
                            ...
                            <th class="text-right"><?php echo number_format($result["tot_deduction"],2);  ?></th>
                        </tr>  
                    </table>   
                    ...
                    <table class="totaltable table table-striped table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php $gross_salary  = $result["basic"] + $result["total_allowance"] - $result["total_deduction"] - $result["leave_deduction"]; echo  number_format($gross_salary,2); ?></td>
                        </tr>
