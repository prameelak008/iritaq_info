      ...
      ?>
      <tr>
      <td width="50%"><b><?php echo $subject['groupname']; ?></b></td>

      <td width="50%"><b><?php echo $subject['examname']; ?></b>
      ...
      <tr>
      <td  >&nbsp;</td>
      <td width="50%"><?php echo $getsub['name'];  ?></td>
      </tr>
      ...
      echo "<i class='btn btn-$class'><b>$status</b></i>";
      ...
      <td>
      <a  href="<?php echo site_url(); ?>/admin/onlineexam/accept_exam/<?php echo $studid; ?>/<?php echo $groupid; ?>/<?php echo $exambatchid; ?>" class="btn btn-success">Accept</a></td>
      <td>

      <a  href="<?php echo site_url(); ?>/admin/onlineexam/reject_exam/<?php echo $studid; ?>/<?php echo $groupid; ?>/<?php echo $exambatchid; ?>" class="btn btn-danger">Reject</a>
      </td>
      ...
      url: base_url + "admin/onlineexam/accept_ajaxexam",
