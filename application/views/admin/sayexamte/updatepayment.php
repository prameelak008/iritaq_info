            ...
            <form role="form" action="<?php echo site_url('admin/Sayexamte/checkpayment') ?>" method="post" class="row">
            ...
            <td>
                ...
                {
                if($fee['fees_sayexampayment_student_id']==$online['exam_group_exam_sayexam_student_studentid']
                && $fee['fees_sayexampayment_examgroup']==$online['exam_group_exam_sayexam_examid'] 
                && $fee['fees_sayexampayment_examgroupbatch']==$online['exam_group_exam_sayexam_examgroupid'] 
                && $fee['fees_sayexampayment_session_id']==$online['exam_group_exam_sayexam_session_id'] )
                {
                echo  'Order Id'.'&nbsp;&nbsp;:'. 	$fee['fees_sayexampayment_orderid'];
                echo "<br>";
                echo  'Transaction No'.'&nbsp;&nbsp; :'. 	$fee['fees_sayexampayment_transaction_no'];
                
                echo "<br>";
                echo  'Transaction Date'.'&nbsp;&nbsp; :'. 	$fee['fees_sayexampayment_transdate'];
                
                echo "<br>";
                echo  'Amount'.'&nbsp;&nbsp; :'. 	$fee['fees_sayexampayment_amount'];
                
                echo "<br>";
                echo  'Year'.'&nbsp;&nbsp;:'. 	$fee['fees_sayexampayment_year'];
                echo "<br>";
                
                echo  'Notes'.'&nbsp;&nbsp;:'. 	$fee['fees_sayexampayment_notes'];
                echo "<br>";
                
                if($fee['fees_sayexampayment_statuscode'] == 'S') 
                {
                $status = '<span style="font-size:18px;">Success <i class="fa fa-check-circle" style="color:green;"></i></span>';
                } 
                else if($fee['fees_sayexampayment_statuscode'] == 'F') 
                {
                $status = '<span style="font-size:18px;">Failed <i class="fa fa-times-circle" style="color:red;"></i></span>';
                }
                echo 'Status&nbsp;&nbsp;: ' . $status;
                ?>
                <button type="button" title="delete"  onClick="return ConfirmDelete(this)" class="fa fa-trash" style="color:red" data-id="<?php echo $fee['fees_sayexampayment_id']; ?>"></button>
                ...
                ?>
                                        ...
                                        <form id="form" action="<?php echo site_url('admin/Sayexamte/updatefees'); ?>" method="post"  enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" class="form-control" name="student_id" id="student_id" value="<?php echo $online['exam_group_exam_sayexam_student_studentid']; ?>" />
                                        <input type="hidden" class="form-control" name="examgroup" id="examgroup" value="<?php echo $online['exam_group_exam_sayexam_examgroupid']; ?>" /> 
                                        
                                        <input type="hidden" class="form-control" name="exam"  id="exam" value="<?php echo $online['exam_group_exam_sayexam_examid']; ?>" />
                                        <input type="hidden" class="form-control" name="session_id" id="session_id" value="<?php echo $online['exam_group_exam_sayexam_session_id']; ?>" /> 
            ...
            $('#exam_id').removeClass('dropdownloading');
                ...
                $.ajax({
                url: '<?php echo site_url('admin/sayexamte/updatefees'); ?>',
                type: 'POST',
                data: formData,
                async: false,
                success: function(data) 
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/sayexamte/deletefees'); ?>",
                cache: false,
                data: {'id': id},
                success: function (data) 
                {
