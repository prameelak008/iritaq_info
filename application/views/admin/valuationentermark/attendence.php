            ...
            <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('attendance'); ?></h3>
            </div>
            
            
            <div class="box-body">
            <form role="form" action="<?php echo site_url('admin/valuationmarkentry/attendance') ?>" method="post" >
            ...
            <form method="post" action="<?php echo base_url('admin/Valuationmarkentry/add_attendence') ?>" >
            <div class="" >
            <div class="box-header ptbnull"></div>
            <div class="box-header ptbnull">
            <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo  $this->lang->line('attendence'); ?></h3>
            </div>
            <div class="box-body">
            ...
            <input type="hidden"  id="exam_group_class_batch_exam_subject_id" name="exam_group_class_batch_exam_subject_id" value="<?php echo $student_value->subject_id; ?>">
            </td>
            ...
            <?php
            $this->db->select('*');
            $this->db->where(array('exam_group_class_batch_exam_student_id'=>$student_value->exam_group_class_batch_exam_student_id,'exam_group_class_batch_exam_subject_id'=>$student_value->subject_id));
            $sql = $this->db->get('exam_group_exam_results');
            $query=  $sql->row_array();
            ...
            {
            ?>
            <option value="<?php echo $query['attendence']; ?>"><?php echo $query['attendence']; ?></option>
            <?php
            }
            else
            {
