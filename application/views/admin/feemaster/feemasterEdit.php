                                                ...
                                                <tr>
                                                            ...
                                                            foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                                ...
                                                                <li> <i class="fa fa-money"></i>  
                                                                    ...
                                                                    if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) {
                                                                        ?>
                                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/feemaster/delete/<?php echo $feetype_value->id ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                                    ...
                                                    <td class="mailbox-date ">
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) { ?>
                                                            <a href="<?php echo base_url(); ?>admin/feemaster/deletegrp/<?php echo $feegroup->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } ?>
...
<script type="text/javascript">
    ...
    function calculatefine() {
        ...
        // Ensure UI reflects the pre-selected radio on page load
