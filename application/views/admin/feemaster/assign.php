            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                     ...
                     <div class="box-header with-border">
                         <a href="<?php echo site_url();?>studentfee/importfees/<?php echo $id;?>" class="btn btn-primary pull-right btn-sm checkbox-toggle fa fa-upload" >Import</a>                         
                    </div>                  
                        
                        
                        
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/feemaster/assign/' . $id) ?>" method="post" class="row common-reset-form">
                            ...
                            <div class="col-sm-12">
                                ...
                                <button type="button" id="resetBtn" class="btn btn-warning pull-right btn-sm    custombtn"><?php echo $this->lang->line('reset'); ?></button>


                             <button type="button"  class="btn btn-primary pull-right btn-sm custombtn" onclick="window.history.back();">
