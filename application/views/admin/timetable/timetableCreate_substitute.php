        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/timetable/create_substitute') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
...
if (isset($getDaysnameList)) {
    ?>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <input type="hidden" name="subst_date" id="subst_date" value="<?php echo $subst_date; ?>"/>
...
?>
            ...
            <script type="text/javascript">
                ...
                function getGroupdata(target, target_id, ajax_data)
                {
                    ...
                    var subst_date=$('#subst_date').val();

                    $.ajax({
                        type: 'POST',
                        url: base_url + "admin/timetable/getBydategroupclasssection_substitute",
                        data: {'day': ajax_data.day, 'class_id': ajax_data.c, 'section_id': ajax_data.s, 'subject_group_id': ajax_data.group,'subst_date':subst_date},
                        dataType: 'json',
                        beforeSend: function () {
