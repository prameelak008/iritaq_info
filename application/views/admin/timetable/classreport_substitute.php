                            ...
                            <a href="<?php echo site_url('admin/timetable/create_substitute') ?>" type="button"  class="btn btn-sm btn-primary" autocomplete="off"><i class="fa fa-edit"></i> <?php echo $this->lang->line('edit'); ?></a>
                            </div>
                            </div>
                            
                            
                            <form action="<?php echo site_url('admin/timetable/classreport_substitute') ?>" method="post" accept-charset="utf-8">
                            <div class="box-body">
                            ...
                            {
                            ?>
                            <th class="text text-center" style="padding:10px 10px 10px 10px;"><?php echo $this->lang->line(strtolower($tm_key)); ?></th>
                            <?php
                            }
                            ?>
                            </tr>
                            ...
                            {
                            ?>
                            <td class="text text-center" width="14%" style="color:green !important ;">
                            ...
                            <div class="attachment-block clearfix" >
                            <b class="text-green">
                            <?php echo  $this->lang->line('teacher').'&nbsp : &nbsp;'.$tm_kue->shortname;
                            echo "<br>";
                            echo "<br>";
                            echo $this->lang->line('subject') ?>: <?php
                    ...
                    <h1 style="text-decoration: underline;">Class Time Table</h1></div>
                    <div class="col-md-12" style="text-align:center;">
                    <h2><?php echo $classSection->class .'&nbsp;&nbsp;-&nbsp;&nbsp;'.$classSection->section; ?></h2>
                    </div>
                    
                    
                    
                            
                    <table style="border:1px solid #415041;">
                    <?php
                    foreach ($timetable as $tm_key => $tm_value) 
                    {
                    ?>
                    <tr>
                    <td style="border:1px solid black !important; text-align:center; background-color:#415041; color:white;font-weight:bold;font-size:13px;padding:10px 10px 10px 10px;"><?php  echo $this->lang->line(strtolower($tm_key));
                    ?>
                    </td>
                    ...
                    ?>
                    <?php
                    if($tm_kue->day==$tm_key && $period->periodic_table_id==$tm_kue->period_id)
                    {
                    ?>
                    <td style="border:1px solid black !important; padding-bottom:2px;" class="fontstyle" >
                    <span style="white-space: nowrap; text-align:center;" class="fontstyle" ><b><?php echo  $this->lang->line('teacher').'&nbsp : &nbsp;'.$tm_kue->shortname; ?></b></span>
                    <?php
                    echo "<br>";
                    echo "<br>";
                    echo $tm_kue->subject_name;
                    ...
                    ?>
                    <br>
                    <strong class="text-green" style="white-space: nowrap;"><?php echo $tm_kue->time_from.'-'.$tm_kue->time_to; ?></strong>
                   
                    <br>
                    <strong class="text-green" style="white-space: nowrap;text-align:center;" class="fontstyle"><?php echo $this->lang->line('room_no'); ?>: <?php echo $tm_kue->room_no; ?></strong><br>
                    </td>
                    <?php 
                    }
                    } 
