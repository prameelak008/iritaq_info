        ...
        var newRow = $("<tr>");
        var cols = "";
        cols += '<td class="relative"><input type="hidden" name="total_row[]" value="' + tot_count + '"><input type="hidden" name="prev_id_' + tot_count +  '" value="0"><select class="form-control subjectpaper" onchange="get_subject_id(' + tot_count + ' )" id="subjectpaper_' + tot_count + '" name="subjectpaper_' + tot_count + '">' + $("#subjectpapers_dropdown").text() + '</select></td>';
        cols += '<td class="relative"><input type="text" name="getsubname' + tot_count + '" class="form-control getsubname" id="getsubname' + tot_count + '"  aria-invalid="false"></td>';
        
        // cols += '<td class="relative"><select class="form-control subject" id="subject_id_' + tot_count + '" name="subject_' + tot_count + '">' + $("#subject_dropdown").text() + '</select></td>';
        
        cols += '<td class="relative"><select class="form-control " id="staff_id_' + tot_count + '" name="staff_' + tot_count + '">' + $("#staff_dropdown").text() + '</select></td>';
        
        cols += '<td class="relative"><select class="form-control period" onchange="getperiod_id('+ tot_count + ' )" id="period_id_' + tot_count + '" name="period_id_' + tot_count + '">' + $("#period_dropdown").text() + '</select></td>';
        ...
        // });
             ...
             $(document).on("click", ".ibtnDel", function (event) {
                var inputVal = $(this).closest('tr').prev('input').val(); // your original check

                if (confirm('<?php echo $this->lang->line("are_you_sure_you_want_to_delete"); ?>')) {
                $(this).closest("tr").remove();
                counter -= 1;
                alert("<?php echo $this->lang->line('deleted_successfully'); ?>");
                }
                return false;
                });
        ...
        success: function (data) 
        {
        $('#getsubname'+row).val(data.name); 
        $('#subject_id_'+row).val(data.id); 
        }
        });
        }
