            ...
            if ($this->rbac->hasPrivilege('income', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/income"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="common-reset-form">
                            <div class="box-body">
                                 <?php
                            ...
                            */
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control date"  value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>" readonly="readonly" />
                            ...
                            <button type="button" id="resetBtn" class="btn btn-default  resetstyle pull-right" style="margin-right:10px">Reset</button>
