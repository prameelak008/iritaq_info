                ...
                <h1>
                <i class="fa fa-money"></i> <?php echo ('Subject Paper'); ?></h1>
                </section>
                ...
                <h3 class="box-title"><?php echo ('Add Subject Paper'); ?></h3>
                </div><!-- /.box-header -->
                <form id="form1" action="<?php echo base_url() ?>admin/subjectpaper/create"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="box-body">
                <?php
                ...
                */
                ...
                <input type="text" name="papercode" id="papercode" class="form-control" value="<?php echo set_value('papercode'); ?>">
                ...
                <?php
                foreach($subpaperlist as $sub)
                {
                ?>

                <option value="<?php  echo $sub['subjectpaper_papercode']; ?>"><?php  echo $sub['subjectpaper_papercode']; ?></option>
                <?php } ?>
                ...
                <input type="text" name="arabic_papername" id="arabic_papername" class="form-control" value="<?php echo set_value('arabic_papername'); ?>" >
                ...
                <input type="radio" value="Compulsory" name="papertype"  <?php if (set_value('papertype') == "Compulsory") echo "checked"; ?> checked><?php echo $this->lang->line('compulsory'); ?>
                </label>
                <label class="radio-inline">
                <input type="radio" name="papertype" <?php if (set_value('papertype') == "Elective") echo "checked"; ?> value="Elective"><?php echo $this->lang->line('elective'); ?>
                </label>
                </div>                            

                <div class="form-group" id="parentsubject">
                <label for="exampleInputEmail1"><?php echo ('Parent Subject'); ?></label><br>
                <input type="text" name="parentsubject" id="parentsubject" class="form-control" value="<?php echo set_value('parentsubject'); ?>" >
                <span class="text-danger"><?php echo form_error('parentsubject'); ?></span>
                </div>

                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo ('Credit'); ?></label> <br>
                <input type="text" name="credit" id="credit" class="form-control" value="<?php echo set_value('credit'); ?>">
                <span class="text-danger"><?php echo form_error('credit'); ?></span>
                </div>

                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo ('Credit Hours'); ?></label> <br>
                <input type="text" name="credithours" id="credithours" class="form-control" value="<?php echo set_value('credithours'); ?>" >
                ...
                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('CE'); ?> <small class="req">*</small></label>
                <input type="text" name="ce_max_marks" id="ce_max_marks" class="form-control" value="<?php echo set_value('ce_max_marks'); ?>"/>
                <span class="text-danger"><?php echo form_error('ce_max_marks'); ?></span>
                </div>

                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('TE'); ?> <small class="req">*</small></label>
                <input type="text" name="te_max_marks" id="te_max_marks" class="form-control" value="<?php echo set_value('te_max_marks'); ?>"/>
                ...
                <th><?php echo ('Credit Hours'); ?> </th>
                <th><?php echo $this->lang->line('CE'); ?> </th>
                ...
                <!-- <?php echo $subjectpaper['subjectpaper_status']; ?> -->
                </td>
