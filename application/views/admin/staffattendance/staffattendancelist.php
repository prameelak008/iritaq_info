                                                ...
                                                foreach ($resultlist as $key => $value) {
                                                    ...
                                                    <tr>
                                                                ...
                                                                if ($type['key_value'] != "H") {
                                                                    ...
                                                                    if ($value["date"] != "xxx") {
                                                                        ...
                                                                        <div class="radio radio-info radio-inline">
                                                                            <input <?php if ($value['staff_attendance_type_id'] == $type['id']) echo "checked"; ?> 
                                                                            <?php foreach($staffabsent as $markabsent)
                                                                            {
                                                                                $sid=$markabsent->staff_id;
                                                                                if($value['staff_id'] == $sid)
                                                                                {
                                                                                    if($type['id']==3)
                                                                                    {
                                                                                        echo "checked";
                                                                            ...
                                                                            <label for="attendencetype<?php echo $value['staff_id'] . "-" . $count; ?>">
                                                                                <?php echo $type['type']; ?><?php echo $sid;?>
                                                                            </label>
                                                                        </div>
                                                                        <?php
                                                                    }else {
                                                                        ?>
                                                                        <div class="radio radio-info radio-inline">
                                                                            <input <?php if (($c == 1) && ($resultlist[0]['staff_attendance_type_id'] != 5)) echo "checked"; ?> 
                                                                            <?php foreach($staffabsent as $markabsent)
                                                                            {
                                                                                $sid=$markabsent->staff_id;
                                                                                if($value['staff_id'] == $sid)
                                                        ...
                                                        <?php if ($value["date"] == 'xxx') { ?> 
                                                            <td><input type="text" class="form-control" name="remark<?php echo $value["staff_id"] ?>" ></td>
                                                        <?php } else { ?>
                                                            <td><input type="text" class="form-control" name="remark<?php echo $value["staff_id"] ?>" value="<?php echo $value["remark"]; ?>" ></td>
                                                        <?php } ?>
                                                    </tr>
                                                    <?php
                                                    $row_count++;
