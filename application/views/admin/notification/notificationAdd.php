...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <!-- left column -->
                <form id="form1" action="<?php echo base_url() ?>admin/notification/add"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" class="common-reset-form">
                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <div class="form-horizontal">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('message_to'); ?></label><small class="req" style="color:red;"> *</small>
                                            <div class="checkbox">
    ...
    <button type="button"  class="btn btn-primary custombtn" onclick="window.history.back();">
                            <?php echo $this->lang->line('back'); ?>
                            </button>
                         


                                <button type="button" id="resetBtn" class="btn btn-warning  custombtn"><?php echo $this->lang->line('reset'); ?></button>
