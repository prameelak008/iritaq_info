                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right white-space-nowrap">
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_discount', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/feediscount/delete/<?php echo $feediscount['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
