    ...
    <h1>
    <i class="fa fa-map-o"></i> <?php echo $this->lang->line('revaluation'); ?> <small><?php echo $this->lang->line('Payment'); ?></small>  
    </h1>
    </section>
    <!-- Main content -->
    ...
    <div class="box-body">
    <form role="form" action="<?php echo site_url('admin/Onlineexampayment_revaluation') ?>" method="post" >
    ...
    <td>
    <form method="POST" action="<?php  echo site_url('admin/Onlineexampayment_revaluation/getpaymentdetails');  ?>">
    <input type="hidden" name="student_id" value="<?php  echo $pay['fees_revaluationpayment_student_id'];  ?>" />
    <input type="hidden" name="exam" value="<?php  echo $pay['fees_revaluationpayment_examgroup'];   ?>" />
    <input type="hidden" name="examgroup" value="<?php  echo $pay['fees_revaluationpayment_examgroupbatch'];  ?>" />
    <input type="hidden" name="class_id" value="<?php  echo $pay['fees_revaluationpayment_class_id'];  ?>" />
    <input type="hidden" name="session_id" value="<?php  echo $pay['fees_revaluationpayment_session_id']; ?>" />
    <input type="hidden" name="section_id" value="<?php  echo $pay['fees_revaluationpayment_section_id']; ?>" />
