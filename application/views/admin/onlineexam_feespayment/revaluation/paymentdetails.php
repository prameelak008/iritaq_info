        ...
        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('revaluation').'&nbsp;'.$this->lang->line('payment').'&nbsp;'.$this->lang->line('details'); ?></h3>
        </div>
        ...
        <tr>
        <td><?php  echo $sl; ?></td>
        <td><?php  echo $payment['fees_revaluationpayment_orderid']; ?></td>
        <td><?php  echo $payment['fees_revaluationpayment_transaction_no']; ?></td>
        <td><?php  echo $payment['fees_revaluationpayment_transdate']; ?></td>
        <td><?php  echo number_format($payment['fees_revaluationpayment_amount'],2); ?></td>
        <td><?php  echo $payment['fees_revaluationpayment_errormsg']; ?></td>
        <td>
        <?php  
        if($payment['fees_revaluationpayment_statuscode']=="S")
        {
        $st="Success";
        }
        elseif($payment['fees_revaluationpayment_statuscode']=="F")
        {
        $st="Failed";
        }
        else
