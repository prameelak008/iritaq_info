    ...
    <div class="box-body">
    <form role="form" action="<?php echo site_url('admin/Onlineexampayment') ?>" method="post" >
    ...
    <!--<form method="post" action="<?php echo base_url('admin/Onlineexampayment/getexamfeedetails') ?>" >
    ...
    <td style="text-align:center;"><?php echo $sl; ?><input type="hidden" name="post_exam_id[]" value="<?php echo $exam_id; ?>">
    ...
    <input type="text" name="section_id[]" value="<?php echo $section_id; ?>">
    
    <input type="text" name="session_id[]" value="<?php echo $session_id; ?>">
    
    <input type="text" name="exam_group_class_batch_exam_student_id[]" value="<?php echo $student_value->student_id; ?>"></td>
    ...
    <td><a href="<?php echo base_url(); ?>student/view/<?php echo $student_value->student_id; ?>"><?php echo $this->customlib->getFullName($student_value->firstname,$student_value->middlename,$student_value->lastname,$sch_setting->middlename,$sch_setting->lastname); ?>
    </a>
    </td>
    <td>
    ...
    if($exam_id==$fee['fees_payment_exam'] &&   $exam_group_id==$fee['fees_payment_examgroup'] &&  $class_id==$fee['fees_payment_class_id'] &&  $section_id==$fee['fees_payment_section_id'] &&  $session_id==$fee['fees_payment_session'] && $student_value->student_id==$fee['fees_payment_student_id'])
    {
    
    $orderid=$fee['fees_payment_orderid'];
    $transactiondate=$fee['fees_payment_transdate'];
    $amt=$fee['fees_payment_amount']; 
    
    $transaction=$fee['fees_payment_transaction_no']; 
    ?>
    
    <input type="text" name="orderid[]" class="form-control" value="<?php echo $orderid; ?>"/>
    </td>
    
    <td><input type="text" name="transaction[]" class="form-control" value="<?php echo $transaction; ?>"/></td>
    
    <td><input type="text" name="transactiondate[]" class="form-control" value="<?php echo $transactiondate; ?>"/></td>
    
    
    
    <td><input type="text" name="amount[]" class="form-control" value="<?php echo $amt; ?>"/></td>
    </tr>
    ...
    <button  class="btn btn-success btn-sm printSelected pull-right" type="submit" name="SAVE" title="generate multiple certificate">SAVE </button></b>
    ...
    <td><?php  echo $pay['mobileno'];   ?></td>
        ...
        <td>
        <form method="POST" action="<?php  echo site_url('admin/Onlineexampayment/getpaymentdetails');  ?>">
        <input type="hidden" name="fees_payment_student_id" value="<?php  echo $pay['fees_payment_student_id'];  ?>" />
        <input type="hidden" name="fees_payment_exam" value="<?php  echo $pay['fees_payment_exam'];   ?>" />
        <input type="hidden" name="fees_payment_examgroup" value="<?php  echo $pay['fees_payment_examgroup'];  ?>" />
        <input type="hidden" name="fees_payment_class_id" value="<?php  echo $pay['fees_payment_class_id'];  ?>" />
        <input type="hidden" name="fees_payment_session" value="<?php  echo $pay['fees_payment_session']; ?>" />
        <input type="hidden" name="fees_payment_section_id" value="<?php  echo $pay['fees_payment_section_id']; ?>" />
