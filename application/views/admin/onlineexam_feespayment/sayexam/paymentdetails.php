    ...
    <tr>
    <td><?php  echo $sl; ?></td>
    <td><?php  echo $payment['fees_sayexampayment_orderid']; ?></td>
    <td><?php  echo $payment['fees_sayexampayment_transaction_no']; ?></td>
    <td><?php  echo $payment['fees_sayexampayment_transdate']; ?></td>
    <td><?php  echo number_format($payment['fees_sayexampayment_amount'],2); ?></td>
    
    
    
    <td>
        <?php  
        if($payment['fees_sayexampayment_statuscode']=="S")
        {
            $st="Success";
        }
        elseif($payment['fees_sayexampayment_statuscode']=="F")
        {
            $st="Failed";
        }
        else
