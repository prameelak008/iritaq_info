    ...
    <th>Application Cancellation</th>
    ...
    <tr>
    <td><?php  echo $sl; ?></td>
    <td><?php  echo $payment['fees_payment_orderid']; ?></td>
    <td><?php  echo $payment['fees_payment_transaction_no']; ?></td>
    <td><?php  echo $payment['fees_payment_transdate']; ?></td>
    <td><?php  echo number_format($payment['fees_payment_amount'],2); ?></td>
    
    
    
    <td>
        <?php  
        if($payment['fees_payment_statuscode']=="S")
        {
            $st="Success";
        }
        elseif($payment['fees_payment_statuscode']=="F")
        {
            $st="Failed";
        }
        else
        ...
        <td><?php  echo $payment['fees_payment_cancelled_details']; ?></td>
    </tr>
    <?php
