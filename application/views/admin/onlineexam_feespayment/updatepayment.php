                    ...
                    <div class="box-body">
                    <form role="form" action="<?php echo site_url('admin/Onlineexampayment/checkpayment') ?>" method="post" class="row">
                    ...
                    {
                    if($fee['fees_payment_student_id']==$online['online_examination_student_id'] && $fee['fees_payment_examgroup']==$online['online_examination_examgroup'] && $fee['fees_payment_exam']==$online['online_examination_exam']  && $fee['fees_payment_session']==$online['online_examination_session_id'] && $fee['fees_payment_class_id']==$online['online_examination_class_id'] && $fee['fees_payment_section_id']==$online['online_examination_section_id'])
                    {
                    echo  'Order Id'.'&nbsp;&nbsp;:'. 	$fee['fees_payment_orderid'];
                    echo "<br>";
                    echo  'Transaction No'.'&nbsp;&nbsp; :'. 	$fee['fees_payment_transaction_no'];
                    
                    echo "<br>";
                    echo  'Transaction Date'.'&nbsp;&nbsp; :'. 	$fee['fees_payment_transdate'];
                    
                    echo "<br>";
                    echo  'Amount'.'&nbsp;&nbsp; :'. 	$fee['fees_payment_amount'];
                    
                    echo "<br>";
                    echo  'Year'.'&nbsp;&nbsp;:'. 	$fee['fees_payment_year'];
                    
                    
                    echo "<br>";
                    echo  'Notes'.'&nbsp;&nbsp;:'. 	$fee['fees_payment_notes'];
                    echo "<br>";
                    
                    
                    
                    
                    if($fee['fees_payment_statuscode'] == 'S') 
                    {
                    $status = '<span style="font-size:18px;">Success <i class="fa fa-check-circle" style="color:green;"></i></span>';
                    } 
                    else if($fee['fees_payment_statuscode'] == 'F') 
                    {
                    ...
                    <button type="button" title="delete"  onClick="return ConfirmDelete(this)" class="fa fa-trash" style="color:red" data-id="<?php echo $fee['fees_payment_id']; ?>"></button>
                    ...
                    <form id="form" action="<?php echo site_url('admin/Onlineexampayment/updatefees'); ?>"  method="post"  enctype="multipart/form-data">
                    
                    Order Id :<input type="text" class="form-control" name="orderid" id="orderid" />
                    <br>
                    
                    Transaction No :<input type="text" class="form-control" name="transaction" id="transaction" /> 
                    <br>
                    ...
                    <input type="hidden" class="form-control" name="student_id" id="student_id" value="<?php echo $online['online_examination_student_id']; ?>" />
                    <input type="hidden" class="form-control" name="examgroup" id="examgroup" value="<?php echo $online['online_examination_examgroup']; ?>" /> 
                    
                    <input type="hidden" class="form-control" name="exam"  id="exam" value="<?php echo $online['online_examination_exam']; ?>" />
                    <input type="hidden" class="form-control" name="session_id" id="session_id" value="<?php echo $online['online_examination_session_id']; ?>" /> 
                    
                    <input type="hidden" class="form-control" name="class_id"  id="class_id"   value="<?php echo $online['online_examination_class_id']; ?>" /> 
                    <input type="hidden" class="form-control" name="section_id" id="section_id" value="<?php echo $online['online_examination_section_id']; ?>" /> 
                    <br>
                    ...
                    $.ajax({
                    url: '<?php echo site_url('admin/Onlineexampayment/updatefees'); ?>',
                    type: 'POST',
                    data: formData,
                    async: false,
                    success: function(data) 
                    ...
                    $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('admin/Onlineexampayment/deletefees'); ?>",
                    cache: false,
                    data: {'id': id},
                    success: function (data) 
                    {
