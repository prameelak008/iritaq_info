                                        ...
                                        foreach ($certificateList as $certificate) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/certificate/delete/<?php echo $certificate->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
