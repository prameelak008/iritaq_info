                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date text-right no-print white-space-nowrap">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('student_certificate', 'can_delete')) {
                                                        ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/certificate/delete/<?php echo $certificate->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
