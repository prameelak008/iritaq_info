                            ...
                            */
                            ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label><?php echo $this->lang->line('logo'); ?><?php echo $this->lang->line('align'); ?></label>
                                   Left<input type="radio" name="logoalign" value="left">
                                   Center<input type="radio" name="logoalign" value="center">
                                   Right<input type="radio" name="logoalign" value="right">
                                   
                                </div>
                                
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('logo'); ?><?php echo $this->lang->line('width'); ?></label>
                                   <input type="text" class=" form-control" name="logo_width" ><label><?php echo $this->lang->line('logo').''.$this->lang->line('height'); ?></label><input type="text"  class="form-control" name="logo_width" >
