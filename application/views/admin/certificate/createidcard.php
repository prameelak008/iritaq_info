...
<form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/studentidcard/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            ...
                            */
                            ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('seal'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" id="address" name="address" placeholder="" rows="3" placeholder=""><?php echo set_value('address'); ?></textarea>
                                ...
                                <div class="form-group">
                                <label><?php echo $this->lang->line('icard'); ?> <?php echo $this->lang->line('validity'); ?></label><small class="req"> *</small>
                                <input id="validity" name="validity" placeholder="Enter Date" type="text" class="form-control" value="<?php echo set_value('validity'); ?>" />
                                ...
                                <div class="form-group">
                                <label><?php echo $this->lang->line('footer'); ?> <?php echo $this->lang->line('title'); ?></label><small class="req"> *</small>
                                    
                                <textarea class="form-control" name="footer_contents"></textarea>
                                    
                                </div>


                                 <div class="form-group">
                                    <label><?php echo $this->lang->line('layout'); ?> <?php echo $this->lang->line('title'); ?></label><small class="req"> *</small>
                                    
                                    <textarea class="form-control" name="layout_title"></textarea>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('background'); ?> <?php echo $this->lang->line('color'); ?></label>
                                    <input  name="background_color" placeholder="" type="color" class="form-control my-colorpicker1" value="<?php echo set_value('background_color'); ?>" />
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input  name="layout_color" placeholder="" type="color" class="form-control my-colorpicker1" value="<?php echo set_value('layout_color'); ?>" />
                                </div>
                                ...
                                <div class="form-group switch-inline">
                                 ...
                                 <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="enable_email" name="is_active_email" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_email', '1', (set_value('is_active_email') == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_active_pickuparea" name="is_active_pickuparea" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_pickuparea', '1', (set_value('enable_pickuparea') == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_active_dropofarea" name="is_active_dropofarea" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_dropofarea', '1', (set_value('is_active_dropofarea') == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_active_parentcontactno1" name="is_active_parentcontactno1" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_parentcontactno1', '1', (set_value('is_active_parentcontactno1') == 1) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_active_parentcontactno2" name="is_active_parentcontactno2" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_parentcontactno2', '1', (set_value('is_active_parentcontactno2') == 1) ? TRUE : FALSE); ?>>
                                  ...
                                  <div class="form-group switch-inline">
                                    <label><?php echo $this->lang->line('school').''.$this->lang->line('address'); ?></label>
                                    <div class="material-switch switchcheck">
                                        <input id="is_active_parentcontactno2" name="is_active_parentcontactno2" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_parentcontactno2', '1', (set_value('is_active_parentcontactno2') == 1) ? TRUE : FALSE); ?>>
                                        <label for="is_active_parentcontactno2" class="label-success"></label>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('student_id_card', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/studentidcard/delete/<?php echo $idcard->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
