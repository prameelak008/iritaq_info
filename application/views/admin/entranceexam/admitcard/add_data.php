            ...
            <h1>
            <i class="fa fa-usd"></i> <?php echo $this->lang->line('admitcard'); ?></h1>
            </section>
            ...
            <form id="form1" action="<?php echo site_url('EntranceExam/addadmitcard'); ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <input type="text" name="entrance_admitcarddate_time" placeholder="Date & Time" class="form-control"  required>
            ...
            <textarea  class="form-control" rows="10" cols="5" name="entrance_admitcarddescription"></textarea>
            </div>
            ...
            <!--<td><?php echo $admit['entrance_admitcardsession']; ?></td>-->
            <td align="right">
            ...
            <a data-placement="left"  href="<?php echo site_url('EntranceExam/deleteadmitcard/' . $admit['entrance_admitcardid']); ?>" class="btn btn-default btn-xs" style="color:#fd5050;"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i  class="fa fa-trash"></i></a>
            </td>
            </tr>                                                   
            <?php
            $count++;
