           ...
           //  if ($this->rbac->hasPrivilege('income', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary" style="padding-bottom: 100px">
                        ...
                        <form id="form1" action="<?php echo site_url('EntranceExam/updategroupinstitute'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                
                                <input type="hidden" name="inst_id" placeholder="ID" class="form-control" value="<?php echo $inedit->entranceexam_insituteid ; ?>" required>
                                <?php
 ...
 -->
                               <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="inst_name" placeholder="Name" class="form-control" value="<?php echo $inedit->entranceexam_insitutename; ?>" required>
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>
                                
                                <!--<div class="form-group">-->
                                <!--    <label for="exampleInputEmail1"><?php echo ('Seat'); ?><small class="req"> *</small></label>-->
                                <!--    <input type="text" name="inst_seat" placeholder="Seat" class="form-control" value="<?php echo $inedit->entranceexam_insituteseats; ?>" required>-->
                                ...
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('name'); ?>
                                         ...
                                         <!--<th><?php echo $this->lang->line('seat'); ?>
                                        </th>
