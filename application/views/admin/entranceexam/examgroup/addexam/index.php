                                    ...
                                    <form role="form" action="<?php echo site_url('entrance_allotment/add_marks') ?>" method="post" >
                                    ...
                                    <select autofocus="" id="phaseid" name="phaseid" class="form-control select2" >
                                    ...
                                    <option value="<?php if(!empty($subject_marks)) { echo  $subject_marks['entrance_subtype_id'];} else { echo ""; } ?>"><?php if(!empty($subject_marks)) { echo $subject_marks['entrance_subtype_name']; } else { echo $this->lang->line('select'); } ?></option>
                                    </select>
                                    ...
                                    <form method="post" action="<?php echo site_url('entrance_allotment/add_marks/entermarks') ?>" >
                                    ...
                                    <th class="text-left">Admission no &nbsp;- &nbsp; Register No</th>
                                    <th class="text-left"><?php echo $this->lang->line('mobile_no'); ?></th>
                                    <th class="text-left"><?php echo $this->lang->line('student_name'); ?></th>
                                    <th class="text-left"><?php echo $this->lang->line('marks')." (".$this->lang->line('max').".)";?></th>
                                    <th class="text-left"><?php echo $this->lang->line('marks')." (".$this->lang->line('min').".)";?></th>
                                    ...
                                    <tr>
                                    <td><?php   echo $sl; ?></td> 
                                    <td><?php   echo $appl['admission_application_no'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$appl['admission_application_registerid'];  ?></td>
                                    <td><?php   echo $appl['admission_mobile'];  ?></td>
                                    <td><?php   echo $appl['admission_name'];  ?></td>
                                    <td><?php   echo $subject_marks['entranceexam_marks_maximum_marks']; ?></td>
                                    <td><?php   echo $subject_marks['entranceexam_marks_minimum_marks']; ?>
                                    
                                    
                                  
                                    
                                    <input type="hidden" name="max_marks[]" value="<?php echo $subject_marks['entranceexam_marks_maximum_marks']; ?>" class="form-control"/>
                                    <input type="hidden" name="min_marks[]" value="<?php echo $subject_marks['entranceexam_marks_minimum_marks']; ?>" class="form-control"/>
                                    </td>
                                    <td>
                                    ...
                                    <input type="hidden" name="marksid[]" value="<?php  echo $subject_marks['entranceexam_marks_id']; ?>" class="form-control"/>
                                    <input type="hidden" name="subjectid[]" value="<?php  echo $subject_marks['entranceexam_marks_subject_id']; ?>" class="form-control"/>
                                    
                                    <input type="textbox" name="marks[]" class="form-control" value="<?php 
                                    foreach($getby_marks as $marks)
                                    {
                                    if($marks['entranceexam_result_marksid']==$subject_marks['entranceexam_marks_id'] && $marks['entranceexam_result_applicant']==$appl['admission_application_registerid'])
                                    {
                                    echo  $marks['entranceexam_result_getmarks'];
                                    }
                                    }
                                    ?>"/>
                                    </td>
                                    
                                    <td><textarea class="form-control" name="notes[]" ><?php 
                                    foreach($getby_marks as $marks)
                                    {
                                    ...
                                    echo  $marks['entranceexam_result_notes'];
                                    }
                                    }
