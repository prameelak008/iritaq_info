            ...
            <h3 class="box-title"><i class="fa fa-search"></i>Seat Quota </h3>
            </div>
            ...
            <input type="hidden" name="entrance_phase" class="form-control" id="entrance_phase" value="<?php  echo $entrance_phase; ?>"/>
