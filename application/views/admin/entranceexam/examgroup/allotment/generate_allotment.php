                                    ...
                                    <form role="form" action="<?php echo site_url('entrance_allotment/allotment/generate_allotment') ?>" method="post" >
                                    ...
                                    <button type="button"  data-toggle="modal" border="none" data-target="#sel_institute">
                                    <i class=" btn btn-success" >GENERATE</i>
                                    </button> 
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="publish_id" value="<?php  echo $app['exam_publish_id']; ?>"/>
