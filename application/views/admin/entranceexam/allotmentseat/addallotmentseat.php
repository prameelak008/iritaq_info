                ...
                <form id="form1" action="<?php echo site_url('entrance_allotment/Entrance_allotmentseat/addseat'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="box-body">
                ...
                <option value="<?php echo $sslist['id']; ?>" <?php if(set_value('seat_session')==$sslist['id'])
                {
                ...
                <option value="<?php echo $typelist['entrance_allot_type_id']; ?>" <?php if(set_value('seat_type')==$typelist['entrance_allot_type_id'])
                {
                echo "selected=selected";
                ...
                <input type="text" name="seat_seatno" placeholder="Seat no" class="form-control" required>
                ...
                e.preventDefault();
                $.ajax({
                url: "<?php echo site_url("entrance_allotment/Entrance_allotmentseat/addseat") ?>",
                type: "POST",
                ...
                {
                div_data += "<option value='" + obj.entranceexam_centreid + "'>" + obj.entranceexam_centrename + "</option>";
                });
