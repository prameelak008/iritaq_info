            ...
            <form id="form1" action="<?php echo site_url('entrance_allotment/Entranceexam_subject/addsubject'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <option value="<?php echo $stype['entrance_subtype_id']; ?>" <?php if(set_value('sub_subid')==$stype['entrance_subtype_id'])
            {
            echo "selected=selected";
            ...
            e.preventDefault();
            $.ajax({
            url: "<?php echo site_url("entrance_allotment/Entranceexam_subject/addsubject") ?>",
            type: "POST",
