...
<div class="content-wrapper">
            ...
            //if ($this->rbac->hasPrivilege('income', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary" style="padding-bottom: 100px">
                        ...
                        <form id="form1" action="<?php echo site_url('EntranceExam/addcenter'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                              <?php
 ...
 <!--
                                    ...
                                    <select class="form-control" name="centre_course" >
                                	 ...
                                	 <?php
										...
										foreach ($centerlist as $ctrlist) { ?>
										    <tr> 
										     ...
										     <!--<td><?php echo $ctrlist['entranceexam_centresession']; ?></td>-->
										    ...
										    <td align="right">
                                                ...
                                                <a data-placement="left" href="<?php echo site_url('EntranceExam/deletecenter/' . $ctrlist['entranceexam_centreid']); ?>" onclick="return doconfirm();"   class="btn btn-default btn-xs"   data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-remove" style="color:#cb1515;"></i></a>
                                            </td>
										    </tr>                                                   
										    <?php
										$count++;
