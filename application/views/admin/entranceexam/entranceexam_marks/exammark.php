                ...
                <h3 class="box-title"><?php echo ('Add Marks'); ?></h3>
                </div><!-- /.box-header -->
                
                <form id="form1" action="<?php echo site_url('entrance_allotment/Entranceexam_marks/addmarks'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                ?>
                <option value="<?php echo $phase['entrance_examgroup_id'] ?>" <?php if (set_value('phase') == $phase['entrance_examgroup_id']) {
                ...
                <option value="<?php echo $sublist['entranceexam_subject_id']; ?>" <?php if(set_value('subject_id')==$sublist['entranceexam_subject_id'])
                {
                echo "selected=selected";
                ...
                <input type="text" name="max_mark" placeholder="Maximum" class="form-control" required>
                </div>
                
                <div class="form-group">
                <label for="exampleInputEmail1"><?php echo ('Minimum Marks'); ?><small class="req"> *</small></label>
                <input type="text" name="min_mark" placeholder="Minimum" class="form-control" required>
                </div>
                ...
                <!-- <td><?php echo $marks['entranceexam_marks_active']; ?></td> -->
                ...
                {
                div_data += "<option value=" + obj.	entrance_subtype_id  + ">" + obj.entrance_subtype_name + "</option>";
                });
