...
<div class="content-wrapper">
            ...
            if ($this->rbac->hasPrivilege('income', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary" style="padding-bottom: 100px">
                        ...
                        <form id="form1" action="<?php echo site_url('EntranceExam/update_selcenter'); ?>"  id="centerform" name="centerform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
 ...
 -->
                ...
                <select class="form-control" name="inst_course">
                 <option value="<?php echo $cedit['entranceexam_course_id']; ?>"><?php echo $cedit['entranceexam_course_name']; ?></option>      
                ...
                <?php 
                if($cedit['sel_entranceexam_phase']==$phse['entrance_examgroup_id'])
                {
                echo "selected=selected";
                }
                ?> > <?php
        ...
        <select name="phase" id="phase" class="form-control">
        <?php
        if($cedit['sel_entranceexam_phase'] == 0) {
                ...
                <span class="text-danger"><?php echo form_error('session'); ?></span>
                                ...
                                <!--</div>-->
                                 ...
                                 <div class="form-group">
                                    ...
                                    <option value="<?php echo $cedit['entranceexam_centreid']; ?>"><?php echo $cedit['entranceexam_centrename']; ?></option>
                                    <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="c_seat" placeholder="Seat" class="form-control" value="<?php echo $cedit['sel_entranceexam_centreseat']; ?>" required>
                                      <input type="hidden" name="c_id" placeholder="ID" class="form-control" value="<?php echo $cedit['sel_entranceexam_centreid']; ?>" required>
                                </div>
                                <?php
										$count++;
