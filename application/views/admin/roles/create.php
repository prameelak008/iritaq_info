                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if (!$data['is_superadmin']) {
                                                        ...
                                                        if (!$data['is_system']) {
                                                            ?>
                                                            <a data-placement="left" href="<?php echo site_url('admin/roles/delete/' . $data['id']); ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
