...
<a data-placement="right" onclick="return doconfirm();"  href="<?php echo base_url();?>admin/language/delete/<?php echo $language['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title=""  data-original-title="<?php  echo $this->lang->line('delete')?>">
