...
trcls:hover {background-color: coral;}
...
?>
        ...
        <div class="">
        <!--<img src="<?php echo base_url(); ?>uploads/log/logo.jpg" height="300px" width="100%"> -->
        <img src="<?php echo base_url(); ?>uploads/school_content/dashboardimage/<?php  echo $sch_setting->dashboard_logo; ?>"  width="100%">
        </div>
        </div>
        </div>
		</br>
...
<p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('staff') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?> 

<i class="fa fa-eye" style="font-size: 20px;" title="View Present Staff" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"></i>



<i class="fa fa-eye-slash" style="font-size: 20px;" title="View Absent Staff" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterstaff_absent"></i>



<span class="pull-right" title="Total Staff Present"><?php echo $Staffattendence_data + 0; ?>/<?php echo $getTotalStaff_data; ?></span>
</p>
                        ...
                        <!--<p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('staff') . ' ' . $this->lang->line('absent') . ' ' . $this->lang->line('today'); ?>



<i class="fa fa-eye" title="View" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterAbsentStaff"></i>
                            </p>-->
                    ...
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i>
                                ...
                                <?php echo $this->lang->line('student') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?><span class="pull-right"> 



                                    <?php echo 0 + $attendence_data['total_half_day'] + $attendence_data['total_late'] + $attendence_data['total_present']; ?>/<?php echo $total_students; ?>
...
<i class="fa fa-eye" style="font-size: 20px;" title="View Present Students" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterStudent"></i>


<i class="fa fa-eye-slash" style="font-size: 20px;" title="View Absent Students" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterStudent_absent"></i>
                            </p>
...
if ($this->module_lib->hasActive('student_attendance') && $sch_setting->attendence_type == 1)
{
    if ($this->rbac->hasPrivilege('student_present_today_widegts', 'can_view')) 
    {
        ?>
                    ...
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i>
                                ...
                                <?php echo $this->lang->line('student') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today').'('. $this->lang->line('period') .')'; ?><span class="pull-right"> 
...
<i class="fa fa-eye" style="font-size: 20px;" title="View Present Students" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterStudent_period"></i>


<i class="fa fa-eye-slash" style="font-size: 20px;" title="View Absent Students" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenterStudent_absent_period"></i>
                            </p>
    ...
    ?>
        ...
        <!--total online examination starts------->
...
if ($this->module_lib->hasActive('fees_collection')) {
    if ($this->rbac->hasPrivilege('fees_awaiting_payment_widegts', 'can_view')) {
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="text-uppercase mt5 clearfix"><i class="fa fa-money ftlayer"></i><?php echo $this->lang->line('total') . " " . $this->lang->line('onlineExamination'); ?><span class="pull-right">
                                <?php echo $total_online_examination_currentsession; ?></span>
...
<p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('total') . ' ' . $this->lang->line('accept') ;?> 
<span class="pull-right"><?php echo $accepted_online_examination_currentsession; ?></span>
</p>
...
<p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('total') . ' ' . $this->lang->line('reject') ;?> 





<span class="pull-right"><?php echo $rejected_online_examination_currentsession; ?></span>
</p>
...
?>
        ...
        <!--total online examination closed------->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="text-align:center; font-size:15px;">


            <b>Staff Present Today-<?php echo date('d-m-Y'); ?></b></h5>
      ...
      <div class="modal-body">
       <table class="tablecls" style="border-collapse: collapse; width:100%;" >
        <thead>
            </thead>
            <tbody>
            ...
            $i = 0;
                    ...
                    <tr class="trcls" style="border: 1px solid #857d7d;"><td class="tdcls" style="border: 1px solid #857d7d;font-family: initial;"><span style="color:#da3400;font-family: initial;text-align:center;  "><h4><?php  echo $rol['name'];  ?></h4></span>
                    </td></tr>



                    <tr><td style="border: 1px solid #857d7d; font-size: 20px;color: green;font-family: initial;text-align:center;">
                    <?php
                    foreach($leave_request_holiday as $holiday)
                    {
                    if($rol['id']==$holiday['role_id'])
                    {
                        echo "holiday";
                    ...
                    foreach($leave_request as $staf)
                    {
                    if($rol['id']==$staf['role_id'])
                    {
                    ?>
                    <tr class="trcls" style="border: 1px solid #857d7d;">
                    <td class="tdcls" style="border: 1px solid #857d7d;text-align:center;font-family: initial;">                   

                    <span style="text-align:center;font-family: initial;">
                    <?php echo $staf['name']; ?></span></td></tr>
...
<div class="modal fade" id="exampleModalCenterstaff_absent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
<h5 class="modal-title" id="exampleModalLongTitle" style="text-align:center; font-size:15px;"><b>Staff Absent Today-<?php echo date('d-m-Y'); ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <table class="tablecls" style="border-collapse: collapse; width:100%;" >
        <thead>
            ...
            $i = 0;
                    ...
                    <tr class="trcls" style="border: 1px solid #857d7d;">
                        <td class="tdcls" style="border: 1px solid #857d7d;font-family: initial;"><span style="color:#da3400;font-family: initial;text-align:center; "><h4><?php  echo $rol['name'];  ?></h4></span>
                    </td></tr>
                    ...
                    foreach($leave_request_absent as $staf)
                    {
                    if($rol['id']==$staf['role_id'])
                    {
                    ?>
                    ...
                    <span style="text-align:center;font-family: initial;text-align:center;">
                    <?php echo $staf['name']; ?></span></td></tr>
...
<!--
<div class="modal fade" id="exampleModalCenterAbsentStaff" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Staff Absent Today-<?php echo date('d-m-Y'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <table class="">
        <thead>
            ...
            $i = 0;
                    ...
                    <tr><td><span style="color:#da3400"><h4><?php  echo $rol['name'];  ?></h4></span>
                    </td></tr>
                    <?php

                    foreach($staff_absent_request as $staf)
                    {
                    if($rol['id']==$staf['role_id'])
                    {
                    ?>
...
<div class="modal fade" id="exampleModalCenterStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="text-align:center; font-size:15px;"><b>Student Present Today-<?php echo date('d-m-Y'); ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <table class="" style="width:100%;" >
        <thead>           
            ...
            $i = 0;
                    ...
                    {
                    ?>
                    <tr style="border: 1px solid #857d7d;">
                    <td style="border: 1px solid #857d7d;">
                    <span style="color:#da3400;font-family: initial;text-align:center;"><h4><?php  echo $cls['class'];  ?></h4></span>
                    </td>
                    </tr>
                    ...
                    foreach($student_leave_request_holiday as $holiday)
                    {
                    if($cls['id']==$holiday['class_id'])
                    {
                        echo "holiday";
                    ...
                    <?php
                    foreach($student_leave_request as $student)
                    {
                    if($cls['id']==$student['class_id'])
                    {
                    ?>
                    <tr style="border: 1px solid #857d7d;">
                    <td style="border: 1px solid #857d7d;font-family: initial;text-align:center;">
                    <?php 
                    echo  $student['admission_no'].'-&nbsp;&nbsp;&nbsp;&nbsp;'.$student['firstname'].''.$student['lastname'] .'&nbsp;&nbsp;'; ?></td></tr>
...
<div class="modal fade" id="exampleModalCenterStudent_absent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" style="text-align:center; font-size:15px;"><b>Student Absent Today-<?php echo date('d-m-Y'); ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       ...
       <table class="" style="width:100%;" >
        <thead>
            ...
            $i = 0;
                    ...
                    foreach($student_leave_request_absent as $student)
                    {
                    if($cls['id']==$student['class_id'])
                    {
                    ...
                    echo  $student['admission_no'].'-&nbsp;&nbsp;&nbsp;&nbsp;'.$student['firstname'].''.$student['lastname'] .'&nbsp;&nbsp;'; ?>
                    </td></tr>
                    <?php
                    }
...
<!--
<div class="modal fade" id="exampleModalCenterAbsentStudent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Student Absent Today-<?php echo date('d-m-Y'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <table class="styled-table">
        <thead>        
            ...
            ?>
            <tr>
            <td><span style="color:#da3400"><h4><?php  echo $cls['class'];  ?></h4></span>
            </td></tr>
            <?php

            foreach($student_absent_request as $student)
            {
            if($cls['id']==$student['class_id'])
            {
            ?>
