       ...
       font-size:15px; 
        ...
        <tr class="firsttable"><td class="firsttable">No</td><td class="firsttable">Subject Code</td>
        <td class="firsttable">Subject Name</td><td class="firsttable">Paper</td>
        <td class="firsttable">Bundle Code</td><td class="firsttable">Count Of Papers</td><td class="firsttable">Amount</td></tr>
        <tr class="firsttable"><td class="firsttable">1</td><td class="firsttable"><?php echo $assignsubjects['subjectcode'];  ?></td>
        <td class="firsttable"><?php echo $assignsubjects['subjectname'];  ?></td><td class="firsttable"><?php echo $assignsubjects['subjectpaper_papername'];  ?></td>
        
        <td class="firsttable"><?php echo $assignsubjects['valuation_bunblecode'];  ?></td>
        ...
        <td style="width:60%;">Name:&nbsp;&nbsp;&nbsp;<?php echo $assignsubjects['staffname'];  ?></td>
        </tr>
...
font-weight:bold;
  white-space: nowrap;  
        ...
        <img src="<?php  echo base_url(); ?><?php echo $assignsubjects['valuation_qrcode'];  ?>" style="width:120px; height:120px;" >
        </td>
        <td style="width:50%;  text-align:center;">
        <div class="item">
        <span class="caption" style="width:190px;margin: auto; "><?php echo $assignsubjects['subjectcode'];  ?></span>
        <img src="<?php  echo base_url(); ?>/uploads/valuationcamp/barcode/<?php echo $assignsubjects['valuation_barcode'];  ?>" style="width:220px; height:60px;" >
