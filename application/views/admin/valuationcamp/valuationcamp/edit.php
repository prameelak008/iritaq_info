        ...
        <div class="row">
            ...
            //if ($this->rbac->hasPrivilege('online_examination_instruction', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <form action="<?php echo site_url('admin/valuation/update_valuationcenter') ?>"  id="valuation_details" name="valuation_details" method="post" accept-charset="utf-8">
                               ...
                               <!--
                                <div class="form-group">
                                    ...
                                    <select autofocus="" required="required" id="exam_group_id" name="exam_group_id" class="form-control" >
                                         ...
                                         <option value="<?php  echo $valuation_centerbyid['valuation_centerexam_group_id']; ?> "> 
                                         <?php  echo $valuation_centerbyid['name']; ?></option>
                                ...
                                <div class="form-group">  
                                    ...
                                    <select  id="exam_id" required="required" name="exam_id" class="form-control" onchange="getsubjectid()" >
                                       <option value="<?php   echo $valuation_centerbyid['valuation_centerexamid'];      ?> "><?php   echo $valuation_centerbyid['exam'];      ?></option>
                                    </select>
                                ...
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('title'); ?> </label><small class="req"> *</small>
                                 ...
                                 <input autofocus="" id="valuation_id" name="valuation_id"  type="hidden" class="form-control"  value="<?php echo $valuation_centerbyid['valuation_centerid']; ?>" />
                                 
                                <input autofocus="" required="required" id="valuation_name" name="valuation_name"  type="text" class="form-control"  value="<?php echo $valuation_centerbyid['valuation_centername']; ?>" />
                                ...
                                <input autofocus="" required="required" id="valuation_location" name="valuation_location"  type="text" class="form-control"  value="<?php echo $valuation_centerbyid['valuation_centerlocation']; ?>" />
                                ...
                                <input autofocus="" id="fromdate"  required="required"name="fromdate"  type="date" class="form-control"  value="<?php echo date('Y-m-d',strtotime($valuation_centerbyid['valuation_centerfromdate']))?>" />
                                ...
                                <input autofocus="" id="todate" required="required" name="todate"  type="date" class="form-control"  value="<?php echo date('Y-m-d',strtotime($valuation_centerbyid['valuation_centertodate']))?>" />
                                ...
                                <input type="date" name="enter_mark" id="enter_mark" class="form-control" value="<?php echo set_value('rack_no', $valuation_centerbyid['valuation_closingdate']); ?>"/>
                                ...
                                <textarea name="close_enter_marks" placeholder="" class="form-control ckeditor"><?php echo $valuation_centerbyid['valuation_close_entermarks_msg']; ?>
