                ...
                <form role="form" id="myform" action="<?php echo site_url('admin/enquiry') ?>" method="post" class="">
                ...
                <input type="text" autocomplete="off" name="from_date" class="form-control  date date_betweenfrom" onchange="validatedate()"     value="<?php  echo date('d-M-Y') ?>">
                ...
                <input type="text" autocomplete="off" name="to_date" class="form-control  date date_betweento" onchange="validatedate()"    value="<?php  echo date('d-M-Y') ?>">
                ...
                <button type="button" id="resetButton" class="btn btn-warning btn-sm pull-right custombtn" >Reset</button>


                <button type="button" id="resetBtn" class="btn btn-primary btn-sm pull-right custombtn" onclick="window.history.back();">
                ...
                <input type="text" id="date" name="date" class="form-control date valid-future-date" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="">
                ...
                <input type="text" id="date_of_call" name="follow_up_date"class="form-control date valid-future-date" value="<?php echo set_value('follow_up_date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="">
                </div>
                </div>
                <div class="col-sm-4">
                <div class="form-group">
