                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('postal_receive', 'can_delete')) { ?>
                                                        ...
                                                        <?php if ($value->image !== "") { ?><a data-placement="left" href="<?php echo base_url(); ?>admin/receive/imagedelete/<?php echo $value->id; ?>/<?php echo $value->image; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return doconfirm();"  data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } else { ?>
                                                            <a data-placement="left" href="<?php echo base_url(); ?>admin/receive/delete/<?php echo $value->id; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return doconfirm();"  data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } ?>
                                                    <?php } ?>
