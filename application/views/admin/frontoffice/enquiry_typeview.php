                                        ...
                                        foreach ($enquiry_type_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/enquirytype/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return doconfirm();"  data-original-title="Delete">
