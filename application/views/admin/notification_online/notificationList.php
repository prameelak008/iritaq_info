                                        ...
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right pt5">
                                                <?php if (($this->rbac->hasPrivilege('notice_board', 'can_edit')) || ($notification["created_id"] == $user_id)) { ?>
                                                    ...
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url() ?>admin/notification/delete/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" data-original-title="<?php echo $this->lang->line('add'); ?>" onclick="return doconfirm();" >
