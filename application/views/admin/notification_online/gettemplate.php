<style type="text/css">
    ...
    .lead_template_variable {
        ...
        margin-bottom: 5px;
            ...
            <div class="col-md-12">
            <div class="form-group">
            <label for="form_message"><?php echo $this->lang->line('template_id'); ?> (<?php echo $this->lang->line('this_field_is_required_only_for_indian_sms_gateway'); ?>)</label>
	        ...
	        <div class="col-md-12">        
            <div class="form-group">
            <input type="radio" id="checktemplate" name="checktemplate"  <?php
            if ($record->is_template== "0" || $record->is_template== "1")
            {
            echo "checked";
            }
            ?>   value="1"><label for="form_message"><?php echo $this->lang->line('template'); ?></label><small class="req"> *</small>
            ...
            <div class="form-group">
            <input type="radio" id="checktemplate" name="checktemplate"  <?php
            if ($record->is_template== "2" ) {
            echo "checked";
            }
            ?> value="2"><label for="form_message"><?php echo $this->lang->line('template').'&nbsp;'.$this->lang->line('two'); ?></label><small class="req"> *</small>
            <textarea id="form_message" name="template_message_two" class="form-control" rows="7"><?php echo $record->template_two; ?></textarea>
            </div>
            </div>
