                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="date" name="date"  placeholder="" onchange="validatedate()" type="text" class="form-control date date_betweenfrom"  value="<?php echo set_value('date'); ?>" />
                                            <span class="text-danger"><?php echo form_error('date'); ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('publish_on'); ?></label><small class="req"> *</small>
                                            <input id="publish_date" name="publish_date" onchange="validatedate()" placeholder="" type="text" class="form-control date date_betweento"  value="<?php echo set_value('publish_date'); ?>" />
