        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- left column -->
                            ...
                            <form id="form1" action="<?php echo site_url('admin/Onlinenotification/setting') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    ...
                                    <?php
                                        ...
                                        if ($note_value->display_whatsapp) 
                                        {
                                        ?>
                                        <label class="checkbox-inline">
                                ...
                                <td> <?php
                                    ...
                                    if (!empty($note_value)) 
                                    {
                                    echo "Template-2".'&nbsp;&nbsp;&nbsp;'.$note_value->template_two;
                                    }
                                    ?>
...
<div class="modal fade" id="templateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo site_url('admin/Onlinenotification/savetemplate') ?>" method="post" id="templateForm">
                ...
                <button type="submit" class="template_update btn btn-primary" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing.."><?php echo $this->lang->line('save');122 ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    $(document).ready(function () 
    {
        $(document).on('click', '.button_template', function () {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: baseurl + "admin/Onlinenotification/gettemplate",
                data: {'id': id},
                beforeSend: function () {
                },
