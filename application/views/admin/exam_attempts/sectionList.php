            ...
            <form action="<?php echo site_url('admin/attempts/') ?>"  id="attempts" name="attempts" method="post" accept-charset="utf-8">
            <div class="box-body">
            ...
            <?php echo (set_value('exam_type') == $typ['exam_type_id']) ? "selected=selected" : ""; ?>>
            ...
            <input autofocus="" id="attempts" name="attempts" placeholder="" type="number" class="form-control"  value="<?php echo set_value('attempts'); ?>" />
            ...
            <textarea name="description" placeholder="" class="form-control ckeditor"></textarea>
