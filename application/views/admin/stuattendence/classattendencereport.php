                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="lateday">
                                                ...
                                                foreach ($attendencetypeslist as $key_type => $value_type) {
                                                    ...
                                                    <b>
                                                        <?php
                                                        $att_type = str_replace(" ", "&nbsp;", ucfirst($value_type['type']));
                                                    ...
                                                    foreach ($student_array as $student_key => $student_value) {                                                      
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                $total_school_days = $monthAttendance[$i][$student_value['student_session_id']]['present'] + $monthAttendance[$i][$student_value['student_session_id']]['late_with_excuse'] + $monthAttendance[$i][$student_value['student_session_id']]['late'] + $monthAttendance[$i][$student_value['student_session_id']]['half_day'] + $monthAttendance[$i][$student_value['student_session_id']]['absent'] + $monthAttendance[$i][$student_value['student_session_id']]['monthly_leave'] + $monthAttendance[$i][$student_value['student_session_id']]['class_leave'] + $monthAttendance[$i][$student_value['student_session_id']]['special_leave'];
                                                            ...
                                                            <th><?php 
                                                            print_r($monthAttendance[$i][$student_value['student_session_id']]['present']); ?></th>
                                                            <!--th><?php print_r($monthAttendance[$i][$student_value['student_session_id']]['late_with_excuse']); ?></th-->
                                                            <th>
                                                                <?php print_r($monthAttendance[$i][$student_value['student_session_id']]['late'] + $monthAttendance[$i][$student_value['student_session_id']]['late_with_excuse']); ?></th>
                                                            ...
                                                            <th><?php print_r($monthAttendance[$i][$student_value['student_session_id']]['monthly_leave']); ?></th>

                                                            <th><?php print_r($monthAttendance[$i][$student_value['student_session_id']]['class_leave']); ?></th>

                                                            <th><?php print_r($monthAttendance[$i][$student_value['student_session_id']]['special_leave']); ?></th>
