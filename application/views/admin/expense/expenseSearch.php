            ...
            <div class="box-body">
            <form role="form"  action="<?php echo site_url('admin/expense/search') ?>" method="post" class="common-reset-form" id="expenseform" >
            <div class="row">
            <div class="col-md-6">
            <div class="row">

            <?php echo $this->customlib->getCSRF(); ?>
            <div  id="select_col"   class="col-sm-6 col-md-6">
            <div class="form-group">
            <label><?php echo $this->lang->line('search') . " " . $this->lang->line('type'); ?></label><small class="req"> *</small>
            <select class="form-control" name="search_type"  id="search_type" onchange="adjustSelectBox(this.value); showdate(this.value)">
         ...
         <button type="button" id="resetBtn" class="btn btn-default btn-sm resetstyle pull-right" style="margin-right:10px">Reset</button>
            ...
            <input autofocus="" type="text" value="<?php echo set_value('search_text', ""); ?>" name="search_text" id="search_text" class="form-control" placeholder="Search by Name">
            ...
            <script type="text/javascript">
            $(document).ready(function () {
            initDatatable('expense-list','admin/expense/getsearchexpenselist_default', {}, [], 100);
            });
            ...
            function adjustSelectBox(value) {  
            const selectCol = document.getElementById('select_col');    
            if (value === 'period') {
            selectCol.className = 'col-sm-6 col-md-6';
            } else {
            selectCol.className = 'col-sm-12 col-md-12';
            }
            }

            document.addEventListener("DOMContentLoaded", function () {
            const selectedValue = document.getElementById('search_type').value;
            adjustSelectBox(selectedValue);
            });
