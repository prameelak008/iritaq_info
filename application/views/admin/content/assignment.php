            ...
            <th><?php echo $this->lang->line('image'); ?>
            </th>
...
if (!empty($data['note'])) {
    ...
    echo '<span class="trashstyle">No Description</span>';
}
?>
            ...
            ?>
            <a data-placement="left" href="<?php echo base_url(); ?>admin/content/deleteassignment/<?php echo $data['id'] ?>/assignment" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
