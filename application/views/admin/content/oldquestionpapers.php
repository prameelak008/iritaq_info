            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary" id="study_material">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('old_question_papers_list'); ?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('old_question_papers_list'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                if ($this->rbac->hasPrivilege('upload_content', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/content/deleteassignment/<?php echo $data['id'] ?>/oldquestionpapers" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
