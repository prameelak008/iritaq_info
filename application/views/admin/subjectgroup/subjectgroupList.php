                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table width="100%">
                                                    ...
                                                    foreach ($subjectgroup->group_subject as $group_subject_key => $group_subject_value) {
                                                        ?>
                                                        <tr><td>
                                                                <?php echo "<div>" . $group_subject_value->name .'&nbsp;&nbsp;&nbsp;&nbsp;'.  $group_subject_value->code ."</div>"; ?>
                                                            </td></tr>
                                            ...
                                            <td class="mailbox-date pull-right no_print">
                                                ...
                                                if ($this->rbac->hasPrivilege('subject_group', 'can_delete')) {
                                                    ?>
                                                    <a  href="<?php echo base_url(); ?>admin/subjectgroup/delete/<?php echo $subjectgroup->id; ?>"class="btn btn-default btn-xs no_print displayinline" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
