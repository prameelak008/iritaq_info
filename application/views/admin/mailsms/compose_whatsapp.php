        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <form action="<?php echo site_url('admin/mailsms/send_group_whatsapp') ?>" method="post" id="group_form">
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                        ...
                        <div class="tab-pane" id="tab_perticular">
                            <form action="<?php echo site_url('admin/mailsms/send_individual_whatsapp') ?>" method="post" id="individual_form">
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                               <label class="pr20"><?php echo $this->lang->line('send_through'); ?><small class="req"> *</small></label>
                                                 ...
                                                 <label class="checkbox-inline">
                                                    <input type="checkbox" value="push_whatsapp" name="individual_send_by[]"><?php echo $this->lang->line('WhatsApp'); ?>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <!--<label><?php echo $this->lang->line('template_id'); ?> </label> (<?php echo $this->lang->line('this_field_is_reqiured_only_for_indian_sms_gateway');?>)-->
                                                <input type="hidden" name="individual_template_id" value="Individual Message" id="individual_template_id" class="form-control" autocomplete="off">
                                            </div>
                                ...
                                <div class="box-footer">
                                    <div class="pull-right">
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <button type="button" class="btn btn-success submit_individual" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Sending" ><i class="fa fa-clock-o"></i> <?php echo $this->lang->line('schedule'); ?></button>
                        ...
                        <form action="<?php echo site_url('admin/mailsms/send_class_whatsApp') ?>" method="post" id="class_form">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="pr20"><?php echo $this->lang->line('send_through'); ?><small class="req"> *</small></label>
                                                 ...
                                                 <label class="checkbox-inline">
                                                    <input type="checkbox" value="push_whatsapp" name="class_send_by[]"> <?php echo $this->lang->line('WhatsApp'); ?>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!--<label><?php echo $this->lang->line('template_id'); ?></label> (<?php echo $this->lang->line('this_field_is_reqiured_only_for_indian_sms_gateway');?>)-->
                                                <input type="hidden" name="class_template_id" id="class_template_id" class="form-control" autocomplete="off" value="ClassWise">
                        ...
                        <div class="tab-pane" id="tab_birthday">
                            <form action="<?php echo site_url('admin/mailsms/send_birthday_whatsapp') ?>" method="post" id="birthday_form">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="pr20"><?php echo $this->lang->line('send_through'); ?><small class="req"> *</small></label>
                                                <label class="checkbox-inline">
                                                <input type="checkbox" value="push_whatsapp" name="birthday_send_by[]"><?php echo $this->lang->line('WhatsApp'); ?>
                                                </label>
                                            ...
                                            <input type="hidden" name="birthday_template_id" id="birthday_template_id" class="form-control" autocomplete="off" value="Birthday Wishes">
                                            </div>
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
