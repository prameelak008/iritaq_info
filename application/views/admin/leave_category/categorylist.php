            ...
            if ($this->rbac->hasPrivilege('section', 'can_add')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <h3 class="box-title"><?php echo $this->lang->line('add').'&nbsp;'.$this->lang->line('category'); ?></h3>
                        </div>
                        ...
                        <form action="<?php echo site_url('admin/leave_category/index') ?>"  name="leave_category" method="post" accept-charset="utf-8">
                            <div class="box-body">
                              <?php
                            ...
                            */
                            ?>
                                ...
                                <input autofocus="" id="shortname" name="shortname" placeholder="" type="text" class="form-control"  value="<?php echo set_value('shortname'); ?>" />
                                <span class="text-danger"><?php echo form_error('shortname'); ?></span>
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('color'); ?> </label><small class="req"> *</small>
                                     ...
                                     <input type="color" id="favcolor" name="favcolor" class="form-control" value="#cfcece">
