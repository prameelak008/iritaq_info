                ...
                <!-- form start -->
                <form  action="<?php echo site_url('admin/incomehead/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" class="common-reset-form" >
                <div class="box-body">
                ...
                <td class="mailbox-name ellipsis-text" title="<?php echo $category['description']; ?>">
                ...
                <a data-placement="left" href="<?php echo base_url(); ?>admin/incomehead/delete/<?php echo $category['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"  onclick="return doconfirm();" >
                <i class="fa fa-remove"></i>
                </a>
