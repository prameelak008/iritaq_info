            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('user/user/admitcard') ?>" method="post" class="row">
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4" >
                                <div class="form-group">  
                                    ...
                                    <select  id="session_id" name="session_id" class="form-control" >
                                        <option  value="<?php echo $students_list['sesidd']; ?>"><?php echo $students_list['sesname']; ?></option>
                           ...
                           <div class="col-sm-6 col-lg-4 col-md-4" >
                                <div class="form-group">  
                                    ...
                                    <select id="class_id" name="class_id" class="form-control" >
                                        <option value="<?php  echo $students_list['classesidd'];?>"><?php  echo $students_list['classesname'];?></option>
                ...
                <option value="<?php echo $students_list['sectionsidd']; ?>"><?php echo $students_list['sectionsname']; ?></option>
                                    </select>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4" >
                                <div class="form-group">
                                    ...
                                    <select  id="admitcard" name="admitcard" class="form-control" >
                                        ...
                                        <option value="<?php echo $admitcardlist->id ?>"><?php echo $admitcardlist->template; ?></option>
...
if(isset($student_Newvalue))
{

?>

                       
                        <form method="post" action="<?php echo base_url('user/user/printCard') ?>" id="printCard">
...
if($admin_approval['online_examination_subject_status']=='1' && $admin_approval['online_examination_admin_approve']=='1') 
{
?>
<button  class="btn btn-warning btn-sm  pull-right" type="button"  title="Waiting"><?php echo $this->lang->line('waiting_for_approval'); ?></button>
<?php 
}



elseif($admin_approval['online_examination_subject_status']=='2' && $admin_approval['online_examination_admin_approve']=='1') 
{
?>
<button  class="btn btn-warning btn-sm  pull-right" type="button"  title="Waiting"><?php echo $this->lang->line('waiting_for_approval'); ?></button>
<?php 
...
elseif($admin_approval['online_examination_subject_status']=='2' && $admin_approval['online_examination_admin_approve']=='2')
{
?>
<button  class="btn btn-info btn-sm printSelected pull-right" type="submit" name="generate" title="Approved"><?php echo $this->lang->line('generate'); ?></button>
<?php 
}
elseif($admin_approval['online_examination_subject_status']=='3' && $admin_approval['online_examination_admin_approve']=='3')
{
?>
<button  class="btn btn-danger btn-sm  pull-right" type="button" title="Rejected"><?php echo $this->lang->line('rejected_application'); ?></button>
...
<input type="checkbox"  checked="checked"  class="checkbox center-block"   name="exam_group_class_batch_exam_student_id[]" data-student_id="<?php echo $student_value->student_id; ?>" value="<?php echo $student_Newvalue->student_id; ?>">



            </td>
            <td><?php echo $student_Newvalue->admission_no; ?>
           </td>
            <td>

            

                <a   href="<?php echo base_url(); ?>student/view/<?php echo $student_Newvalue->student_id; ?>"><?php echo $this->customlib->getFullName($student_Newvalue->firstname,$student_value->middlename,$student_value->lastname,$student_value->middlename,$student_value->lastname); ?>
                </a>
            </td>

                <td><?php echo $student_Newvalue->father_name;
                                            
                                                        ?></td>

                                                            <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student_Newvalue->dob)); ?></td>
                                                            <td><?php echo $student_Newvalue->gender; ?></td>
                                                           <!-- <td><?php echo $student_Newvalue->category; ?></td>-->
                                                            <td><?php echo $student_Newvalue->mobileno; ?></td>
...
<script type="text/javascript">
                    ...
                    printWindow.document.write('<html><head><title><?php echo $this->customlib->getAppName(); ?></title></head><body>');
