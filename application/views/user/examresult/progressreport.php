                ...
                <form role="form" action="<?php echo site_url('user/exam/progressreport_print') ?>" method="post" class="row">
                ...
                <form  action="<?php echo base_url('user/exam/printprogressreport') ?>"  id="printMarksheet" name="printMarksheet" method="post">
                ...
                <div class="download_label"> <?php echo $this->lang->line('progress') . " " . $this->lang->line('report'); 
                ...
                <tr>
                <td style="text-align:center; color:#4e168d; font-size:18px;"><?php echo "Progress Report"; ?>
                </td>
                </tr>
                ...
                $(document).on('submit', 'form#printMarksheet2', function (e)
                {
                e.preventDefault();
                var form = $(this);
