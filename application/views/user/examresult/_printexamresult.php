                ...
                <td style="background-color:<?php echo $stylebackground_sty;  ?>"><?php echo $exam_result_value->get_cmarks ; ?></td>
                <td style="background-color:<?php echo $stylebackground_styo;  ?>"><?php echo $exam_result_value->get_marks ; ?></td>
