...
if ($exam_value->exam_type != "gpa") {
                        ?>
                              ...
                              <th><?php echo $this->lang->line('max') . " " . $this->lang->line('cmarks'); ?></th>
                              <th><?php echo $this->lang->line('min') . " " . $this->lang->line('cmarks') ?></th>


                              <th><?php echo $this->lang->line('marks') . " " . $this->lang->line('obtained'); ?></th>
                              <th><?php echo $this->lang->line('cmarks') . " " . $this->lang->line('obtained'); ?></th>
                    ...
                    if ($exam_value->exam_type == "basic_system") {
                        ?>
                              <th style="display:none;">
                                 <?php echo $this->lang->line('subject'); ?><?php echo $this->lang->line('result');  ?>
                              </th>

                              <th style="display:none;">
                                 <?php  echo $this->lang->line('cmarks'); ?><?php echo $this->lang->line('result');  ?>
                              </th>
...
if (!empty($exam_value->exam_result['result']))
 {
                        ...
                        foreach ($exam_value->exam_result['result'] as $exam_result_key => $exam_result_value) {
                           ...
                           $exam_grand_total = $exam_grand_total + $exam_result_value->max_marks+$exam_result_value->max_cmarks;


                            $exam_get_total   = $exam_get_total + $exam_result_value->get_marks+ $exam_result_value->get_cmarks;
                            ...
                            if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                ...
                                if ($exam_result_value->get_cmarks < $exam_result_value->min_cmarks)
                                 {
                                $exam_pass_c_status = 0;
                                 }
...
if ($exam_value->exam_type == "coll_grade_system" || $exam_value->exam_type == "school_grade_system") {
                            ...
                            if ($exam_value->exam_type == "basic_system") {
                                ...
                                <td><?php echo number_format($exam_result_value->get_marks+$exam_result_value->get_cmarks,2,'.',''); ?></td>
...
echo $this->lang->line('fail');
                                ...
                                /* if ($exam_pass_c_status) 
                                 ...
                                 if ($exam_pass_c_status=='1' && $exam_pass_status=='1') 
                                 {
                                 ?>
                                 <span class='label bg-green' style="margin-right: 5px;">
                                 <?php
