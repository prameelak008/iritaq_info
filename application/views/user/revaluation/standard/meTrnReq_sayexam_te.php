            ...
            <meta charset="utf-8">
            <title>Say Exam  Cash Transaction</title>
            <style>
            body{
            ...
            <form action="<?php  echo site_url('user/sayexam_temarks/meTrnPayment_sayexam');?>" method="post">
            <table width="100%" >
            <tr hidden>
            ...
            <td><input type="text" name="responseUrl" id="responseUrl" value="<?php echo site_url();?>user/sayexam_temarks/meTrnSuccess_sayexam" /></td>
            </tr>
            <tr><td></td></tr>
            <tr>
