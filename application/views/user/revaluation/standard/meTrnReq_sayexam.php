...
<br>
<center> <H3>  </H3></center>
	<form action="<?php  echo site_url('user/sayexam/meTrnPayment_sayexam');?>" method="post">
		<table width="100%" >
			...
			<tr hidden>	
				...
				<td><input type="text" name="responseUrl" id="responseUrl" value="<?php echo site_url();?>user/sayexam/meTrnSuccess_sayexam" /></td>
			</tr>
