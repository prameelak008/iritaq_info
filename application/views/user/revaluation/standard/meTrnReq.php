...
<br>
<center> <H3>  </H3></center>
	<form action="<?php  echo site_url('user/revaluation/meTrnPayment');?>" method="post">
		<table width="100%" >
			...
			<tr hidden>	
				...
				<td><input type="text" name="responseUrl" id="responseUrl" value="<?php echo site_url();?>user/revaluation/meTrnSuccess" /></td>
			</tr>
