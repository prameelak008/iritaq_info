                    ...
                    <h3 class="box-title"><i class="fa fa-search"></i> Application For Revaluation</h3>
                    </div>
                    
                    <div class="box-body">
                        
                    <form role="form" action="<?php echo site_url('user/revaluation/exam_revaluation') ?>" method="post" class="row">
                    ...
                    <?php
                    if(empty($revaluationfee_payment))
                    {
                    if (empty($marksheet)) 
                    {
                    ?>
                    ...
                    {
                    $revaluation_subject[]       =           $gt['exam_group_exam_revaluation_subject_id'];
                    }
                    ...
                    <form name="" method="POST" action="<?php   echo site_url('user/revaluation/send_request');?>">
                    ...
                    <span style="font-weight:bold;"></b>Apply Subject  For Revaluation :<b></span>
                    <br>
                    <br>
                    ...
                    <th colspan="2" class="headerclass"><b>Marks Obtained</b></th>
                    ...
                    //echo $student_value['exam_group_class_batch_exam_subject_id'];
                    
                    $student_val= $exam_result_value->exam_group_class_batch_exam_subject_id; 

                    $checked = in_array($student_val, $revaluation_subject) ? "checked" : "";
                    ...
                    type="checkbox" 
                    class="checkbox" 
                    name="exam_group_exam_results_id[]"  
                    value="<?php echo $exam_result_value->exam_group_exam_results_id; ?>" 
                    <?php echo $checked; ?>
                    >
                    ...
                    <td>
                    <?php $obtainedtotal= $exam_result_value->get_cmarks+$exam_result_value->get_marks;
                    ...
                    <!--50/Paper-->
                     ...
                     <?php
                    if($revaluation_feecharge['examfees_charge_fees_charge']!="")
                    {
                    echo $revaluation_feecharge['examfees_charge_fees_charge'].''.'/Paper';
                    }
                    else
                    {
                    echo "0";
                    ...
                    <?php
                    if($revaluation_feecharge['examfees_charge_processing_charge']!="")
                    {
                    echo $revaluation_feecharge['examfees_charge_processing_charge'];
                    }
                    else
                    {
                    echo "0";
                    ...
                    <?php
                    if($revaluation_feecharge['examfees_charge_effectivedate']!="")
                    {
                    echo $revaluation_feecharge['examfees_charge_effectivedate'];
                    }
                    else
                    {
                    echo "00:00:0000";
                    ...
                    <?php  
                    if($revaluation_approval['exam_group_exam_revaluation_approvedstatus']>=0)
                    {
                    ?>
                    <table style="height:50%;">                        
                    <tr><td><input type="submit" name="submit" value="Apply For Revaluation" onclick="return doconfirm();" class="btn btn-primary pull-right btn-sm checkbox-toggle"/></td></tr>
                    </table>
                    <?php
                    }
                    
                    
                    elseif($revaluation_approval['exam_group_exam_revaluation_approvedstatus']==1)
                    {
                    ?>
                    ...
                    <div class="box-body">
                            <div style="width:100%">
                            <span>
                            <h5 style="text-align:center">REVALUATION STATUS </h5
                            </div>
                           
                           
                           
                          <form method="post" action="<?php echo base_url('user/revaluation/printrevaluation') ?>" id="printMarksheet">
           ...
           // $gcount= $count-1;
            ...
            <td colspan="2"><b><?php   //$tot=$totalamt+20;
            $tot=$totalamt+$revaluation_feecharge['examfees_charge_processing_charge'];
            ...
            <br>
                    ...
                    <input type="submit" name="submit" value="Print Revaluation" class="btn btn-success pull-right btn-sm checkbox-toggle" style="margin-right:5px; "/>
                    ...
                    <input type="hidden" name="post_exam_id" value="<?php echo $exam_id; ?>">
                    <input type="hidden" name="post_exam_group_id" value="<?php echo $ex_group; ?>">
                    
                    
                    
                    
                    
                    <input type="checkbox" style="visibility:hidden" class="checkbox center-block" checked="checked"  name="exam_group_class_batch_exam_student_id[]" data-student_id="<?php  echo $exam_group_class_batch_exam_student_id; ?>" value="<?php  echo $exam_group_class_batch_exam_student_id; ?>" />
                    ...
                    <input type="submit" name="submit" value="PrintRevaluation" class="btn btn-success pull-right btn-sm checkbox-toggle"/>
                    ...
                    */
                    ...
                    function doconfirm()
                    {
                    job=confirm("You’re about to apply for revaluation");
                    if(job!=true)
                    {
                    return false;
                    }
                ...
                dataType: "JSON",
                beforeSend: function () {
                subsubmit_button.prop('disabled', true); // Use prop instead of button('loading')
                },
                success: function (response) {
                Popup(response.page);
                },
                ...
                complete: function () {
                subsubmit_button.prop('disabled', false);
                }
                });
                } else {
                ...
                $(this).closest('table').find('td input:checkbox').prop('checked', this.checked);
                    ...
                    printWindow.document.write('<html><head><title>Jamia al Jalaliyya</title></head><body>');
