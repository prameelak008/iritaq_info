                            ...
                            <?php echo $students_listt['profile_roll_no']; ?> 
                            </span>
                            </td>
                            ...
                            <td><?php /*$feetotal= $gcount*50;*/
                             
                             
                          
                            $feetotal= $gcount*$revaluation_feecharge['examfees_charge_fees_charge'];
                           ...
                           <!--20.00-->
                            ...
                            <tr>
                            <td>Total Amount</td>
                            <td><?php   $feegrandtotal=$feetotal+$revaluation_feecharge['examfees_charge_processing_charge'];
                            ...
                            <td><?php  echo $revaluationfee_payment['fees_revaluationpayment_transaction_no']; ?></td>
                            </tr>
                            ...
                            <td><?php  echo number_format($revaluationfee_payment['fees_revaluationpayment_amount'],2); ?></td>
                            </tr>
                            
                            <tr>
                            <td>Order Number &nbsp;:</td>
                            <td><?php  echo $revaluationfee_payment['fees_revaluationpayment_orderid']; ?></td>
                            </tr>
                            
                            
                            <tr>
                            <td>Date &nbsp;:</td>
                            <td><?php  echo $revaluationfee_payment['fees_revaluationpayment_transdate']; ?></td>
                            </tr>
