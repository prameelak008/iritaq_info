            ...
            // echo $students_listt['roll_no']; 
            
            echo $students_listt['profile_roll_no'];
            ?>
            </span>
            </td>
            ...
            <!--<td><?php echo $improve['gtmark'];  ?></td>-->
            <td><?php 
            
            // $obtainedtotal= $say['gtcmark']+$say['gtmark']; 
            ...
            <td style="padding-right:15px;text-align: right;"><?php $feetotal= $gcount*$improvementfee_feecharge['examfees_charge_fees_charge'];
            ...
            <?php echo $improvementfee_feecharge['examfees_charge_processing_charge']; ?></td>
            </tr>
            
            <tr>
            <td>Total Amount</td>
            <td style="padding-right:15px;text-align: right;"><?php   $feegrandtotal=$feetotal+$improvementfee_feecharge['examfees_charge_processing_charge'];
            ...
            <td><?php  echo $improvementfee_payment['fees_improvementpayment_transaction_no'];  ?></td>
            </tr>
            
            <tr>
            <td>Transaction Amount&nbsp;:</td>
            <td><?php  echo $improvementfee_payment['fees_improvementpayment_amount'];  ?></td>
            </tr>
            
            <tr>
            <td>Order Number&nbsp;:</td>
            <td><?php  echo $improvementfee_payment['fees_improvementpayment_orderid'];  ?></td>
            </tr>
            
            <tr>
            <td>Date&nbsp;:</td>
            <td><?php  echo $improvementfee_payment['fees_improvementpayment_transdate'];  ?></td>
            </tr>
            </tbody>
            </table>
            </div>
