            ...
            <h6 class="box-title"><i class="fa fa-book"></i> Application For SayExam-CE</h6>
            </div>
                    
            <div class="box-body">
            <div style="width:100%">
            <span>
            <h5 style="text-align:center">IMPROVEMENT EXAM PAYMENT </h5>
            </div>
            <form action="<?php echo site_url('user/improvement/meTrnReq_improvement'); ?>"  method="POST" >
            ...
            <?php if($improvementfee_feecharge_ce['examfees_charge_processing_charge']!="")
            {
            echo $improvementfee_feecharge_ce['examfees_charge_processing_charge'];
            }
            else
            {
            echo "0";
            ...
            //$totalfee="50";
             ...
             $totalamt= "0";
             $totalfee=  $improvementfee_feecharge_ce['examfees_charge_fees_charge'];
             $fine    =  $improvementfee_feecharge_ce['examfees_charge_fine'];
             $date    =  $improvementfee_feecharge_ce['examfees_charge_effectivedate'];
           ...
           // $gcount= $count-1;
            ...
            $tot =     $totalamt+$improvementfee_feecharge_ce['examfees_charge_processing_charge']+$totfine;
