                ...
                ?>
                	  ...
                	  <tr>
                		  ...
                		  <?php foreach ($childrens as $chil)
                {
                	?>
                 <td>
                  
                 <div class="box-body box-profile"> 
                <a href="<?php echo site_url();?>user/user/updatesesion/<?php echo $chil['sid'];?>"><img class="profile-user-img img-responsive img-circle"  src="<?php
                if (!empty($chil['image'])) {
                        echo base_url() . $chil['image'];
                    } else {
                ...
                <span style="font-family:'Open Sans',Helvetica,Arial,sans-serif; font-size:14px;"><?php echo $chil['firstname'].'&nbsp;'.$chil['lastname']; ?></span>
                	</a>
                ...
                if (!empty($student['admission_date']) && $student['admission_date'] != '0000-00-00') {
                    ...
                    ?>
                									...
                									<td><a href="<?php echo base_url(); ?>user/user/editstudent/<?php echo $student['id']; ?>" class="btn btn-warning btn-xs"  
                ...
                echo $exam_value->exam;
                        ...
                        $withheldFound = false;
                        foreach ($exam_value->exam_result['result'] as $resultObject) {
                        if (isset($resultObject->attendence) && $resultObject->attendence == 'Withheld') {
                        $withheldFound = true;
                        break; 
                        }
                        }
                        ...
                        ?>  
                        <br>
                        <span style="font-size:20px; text-align:center;">Your <?php echo $exam_value->exam ?> Result has been <span style="color:red;">Withheld</span>.Please Contact Admistrative Office for more information.</span>
                         <br>
                          <br>
                        <?php
                        } 
                        ...
                        */
                        ...
                        if($exam_result_value->attendence=="Withheld")
                        {
                        echo "Withheld";   
                        }
                        ?>
                        ...
                        <thead>
                        <th><?php echo $this->lang->line('subject') ?>444</th>
                        <?php
                        if ($exam_value->exam_type == "gpa") {
                        ?>
                        <th><?php echo $this->lang->line('grade') . " " . $this->lang->line('point') ?> </th>
