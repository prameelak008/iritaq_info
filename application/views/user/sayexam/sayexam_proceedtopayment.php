            ...
            <div style="width:100%">
            <span>
            <h5 style="text-align:center">SAY EXAM  PAYMENT-CE </h5>
            </div>
            <form action="<?php echo site_url('user/sayexam/meTrnReq_sayexam'); ?>"  method="POST" >
            ...
            <?php if($sayexamfee_feecharge_ce['examfees_charge_processing_charge']!="")
            {
            ...
            $totalfee=$sayexamfee_feecharge_ce['examfees_charge_fees_charge'];
             ...
             $fine  =  $sayexamfee_feecharge_ce['examfees_charge_fine'];
             $date  =  $sayexamfee_feecharge_ce['examfees_charge_effectivedate'];
           ...
           // $gcount= $count-1;
            ...
            $tot =     $totalamt+$sayexamfee_feecharge_ce['examfees_charge_processing_charge']+$totfine;
