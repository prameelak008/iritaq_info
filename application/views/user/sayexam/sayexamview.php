            ...
            <style type="text/css">
                    ...
                    <h6 class="box-title"><i class="fa fa-book"></i> Application For SAYEXAM</h6>
                            ...
                            <div style="width:100%">
                            <span>
                           <h5 style="text-align:center"><b>APPLICATION FOR SAYEXAM</b></h5>
                           <h6 style="text-align:center; color:#445257;"><b><?php  echo $Exam_group_list->name.'&nbsp;&nbsp;-&nbsp;&nbsp;'. $Exam_group_list->exam; ?></b></h6>
                            </div>
                    ...
                    <form name="" method="POST" action="<?php   echo site_url('user/sayexam/proceedtopayment');?>">
            ...
            <input type="submit" name="proceedpayment" value="PROCEED TO PAYMENT" class="btn btn-success" >
                    ...
                    dataType:"JSON",
                    url: "<?php echo site_url('user/improvement/getstudentbatch_id');?>",
