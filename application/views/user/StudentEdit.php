								   ...
								   <div class="row">
                                        <?php if (!$adm_auto_insert) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" readonly="readonly" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('admission_no', $student['admission_no']); ?>" />
                                        ...
                                        <?php }if ($sch_setting->roll_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="roll_no" readonly="readonly" name="roll_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('roll_no', $student['roll_no']); ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                              ...
                                              <input autofocus="" readonly="readonly" id="class_id" name="class_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('class', $stu['class']); ?>" /> 
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?></label>
												  ...
												  <input autofocus="" readonly="readonly" id="section_id" name="section_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('section', $stu['section']); ?>" /> 
                                        ...
                                        <?php if ($sch_setting->admission_date) { 
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input  id="admission_date" name="admission_date" placeholder="" type="text" class="form-control "  value="<?php echo set_value('admission_date', $admission_date) ?>" readonly="readonly" />
                                         ...
                                         if ($sch_setting->student_sign) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="filestyle form-control" type='file' name='studentsign' id="studentsign" size='20' />
                                                </div>
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">
    <?php /*echo $this->lang->line('national_identification_no');*/ ?>Emirates Id
                                                    </label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getStudentsByClassAndSection() {
            ...
            $.ajax({
                type: "GET",
                url: baseurl + "user/user/getByClassAndSectionExcludeMe",
...
<script type="text/javascript">
 ...
 $('.sibling_msg').html("<div class='alert alert-danger text-center'> <?php echo $this->lang->line('no_student_selected'); ?> </div>");
            ...
            $.ajax({
                type: "GET",
                url: baseurl + "user/user/getStudentRecordByID",
