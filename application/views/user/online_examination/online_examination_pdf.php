                ...
                <table>
                <tr>
                <td><img src="<?php echo base_url();?>uploads/log/logo_pdf.png" width="570px" height="130" style="text-align:center; padding-left:30px;">
                </td>
                </tr>
                </table>
                </div>
                ...
                <td><b>Application No:<?php echo $studid['id']; ?></b></td>
                </tr>
                ...
                <?php 
                $newDate = date("d-F-Y", strtotime($fee_transcation['fees_payment_transdate']));
                echo $newDate;
                 ?></b></td></tr>  
                ...
                {
                ?>
                <img src="<?php echo base_url();?>/backend/default_format/copy_photo.png" style="width:150px; height:180px;" >
                ...
                <img src="<?php echo base_url();?>/<?php echo $studid['image']; ?>"  style="width:150px; height:180px;">
                ...
                <div  style="height:auto;min-height:370px !important; ">
                ...
                I hereby declare that the aforesaid information is correct to my knowledge and bear the responsibilty for the correctness of mentioned particular.
                        ...
                        <td class="approv" style="text-align:left;"><b> <?php echo $studid['firstname']; ?></b></td>         
                        ...
                        {
                        ?>
                        <img src="<?php echo base_url(); ?>/<?php echo $studid['studentsign']; ?>" style="height:20px; width:60px;">
                        <?php 
                        } 
                        ?>
                        </td>
                ...
                <!-- <tr style="line-height: 18px;">-->
                <!--<td class="tbl">Fine</td>-->
                <!--<td  class="tbl" style="padding-right:20px; text-align:right;"><?php echo number_format((float)$applicationfee['application_examfee_finefees'], 2, '.', ''); ?></td>-->
                <!--</tr> -->
                ...
                <div class="footer" style="width:100%;  ">
                <br>
                <div class="declaration" style="text-align:center; line-height: 4px; font-size:20px;margin-top:30px;"><b>CLEARANCE REPORT</b>
                </div><br>
                ...
                It is stated that the student named <b><?php echo $studid['firstname']; ?></b> holding  the register number <b><?php echo $studid['admission_no']; ?></b>, is qualified to  attend
