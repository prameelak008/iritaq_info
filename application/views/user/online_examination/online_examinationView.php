        ...
        */
        ...
        <tr>
        <th rowspan="2" class="" style="padding-left:10px;" >
        ...
        <th  class="headerclass"  ><b>Subjects</b></th>
                ...
                foreach($getsubjectid as $sub) 
                {
                   ...
                   if(in_array($sub['subjectid'], $online_examination_subject))
                   {
                    ...
                    $check="<i class='fa fa-check' style='color:#51a19e'></i>";
                   }
                   else
                   {
                   //$checked="";
                ...
                ?>
                    ...
                    <tr style="width:20px; background-color: <?php  echo $backgroundcolor;   ?>;">
        ...
        <?php echo $check; ?>
                    ...
                    <input type="hidden"  id="session_id" name="session_id" value="<?php echo $sub['session_id']; ?>">           
        ...
        $class_id=$online_exam_accept['online_examination_class_id'];
        
        $section_id=$online_exam_accept['online_examination_section_id'];
        ...
        <!--<a title="Delete Pdf" onclick="return doconfirm();" href="<?php echo site_url();?>user/user/delete_appliedpdf/<?php echo $studid; ?>/<?php echo $groupid; ?>/<?php echo $exambatchid; ?>" class="btn btn-danger">
        
          CANCEL APPLICATION</a>-->
        
        </span>
        
        <!--<input type="button" value="PRINT APPLICATION" id="btnPrint" class="btn btn-default" />-->
        ...
        ?>
                    ...
                    <form name="" method="POST" action="<?php  echo site_url('user/user/print_format');  ?>"/>
                    <input type="hidden" id="groupid" name="examgroupp" value="<?php echo $sub['grpidd']; ?>">
                    <input type="hidden"  id="exambatchid" name="examgroupbatchh" value="<?php echo $sub['grpid']; ?>">
                    ...
                    <!--<a href="<?php echo site_url();?>user/user/viewprintreceipt/<?php echo $sub['grpidd']; ?>/<?php echo $sub['grpid']; ?>/<?php echo $sub['class_id']; ?>/<?php echo $sub['section_id']; ?>/<?php echo $sub['session_id'];  ?>" class="btn btn-success" ><i class="fa fa-download">DOWNLOAD</i></a>-->
        <input type="button" value="PRINT APPLICATION" id="btnPrint" class="btn btn-default" />
                    <table style="width:100%;">
                    <tr>
                    <td style="text-align:right;">            
                    <input type="button" id="btnprintreceipt"  value="PRINT RECEIPT" class="btn btn-success"  >         
                    </td>
                    </tr>
                   </table>
        ...
        */
        ...
        // frameDoc.document.write('<link rel="stylesheet" href="' + base_url + 'backend/dist/css/idcard.css">');
            ...
            $.ajax({
                ...
                url: base_url + "user/user/viewprintreceipt",       
               data: {studid:studid,group:group,exambatchid:exambatchid,class_id:class_id,section_id:section_id,session_id:session_id},       
                datatype : 'JSON',      
