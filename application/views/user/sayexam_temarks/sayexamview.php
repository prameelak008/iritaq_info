            ...
            <h6 class="box-title"><i class="fa fa-book"></i> Application For Say Exam-TE</h6>
            </div>
            ...
            <div style="width:100%">
            <span>
            <h5 style="text-align:center"><b>APPLICATION FOR TE SAYEXAM</b></h5
            </div>
                        
                            
            <form name="" method="POST" action="<?php   echo site_url('user/sayexam_temarks/proceedtopayment');?>">
            ...
            <td><?php echo $say['get_marks'];  ?></td>
            <td><?php  
            //$obtainedtotal= $say['gtcmark']+$say['gtmark']; 
            $obtainedtotal= $say['get_marks'];
            ?>
            <?php
