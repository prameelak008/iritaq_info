                ...
                <h6 class="box-title"><i class="fa fa-book"></i> Application For SayExam</h6>
                </div>
                ...
                <div style="width:100%">
                <span>
                <h5 style="text-align:center">SAY EXAM  PAYMENT </h5>
                </div>
                
                
                
                
                <form action="<?php echo site_url('user/sayexam_temarks/meTrnReq_sayexam'); ?>"  method="POST" >
                ...
                <td><?php if($sayexamfee_feecharge_te['examfees_charge_processing_charge']!="")
                {
                ...
                $fine          =  $sayexamfee_feecharge_te['examfees_charge_fine'];
                $date          =  $sayexamfee_feecharge_te['examfees_charge_effectivedate'];
                ...
                <tr><td colspan="2" style="text-align:right;padding-right:20px"><b>Total Amount</b>
                ...
                <td colspan="2"><b>
                <?php   $tot=$totalamt+$sayexamfee_feecharge_te['examfees_charge_processing_charge']+$totfine; 
