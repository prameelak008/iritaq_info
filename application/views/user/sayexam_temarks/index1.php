...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-map-o"></i> <?php echo $this->lang->line('sayexam'); ?> <small><?php echo $this->lang->line('student_fee1'); ?></small>  </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('applyexam'); ?> </h3>
...
<input type="hidden" id="exam_groupidd" name="exam_groupidd" value="<?php  echo $ex_group;  ?>"> 
...
<span style="font-weight:bold;"></b> <?php echo $this->lang->line('applyexam'); ?><b></span>
<br>
<br>

<table class="table table-striped table-hover" id="denifittable" border="2" cellspacing="0" width="100%">
...
<p>Division:80% & above=First Class with distinction,50%-79%=Second Class,35%-50%=Third Class</p>
    ...
    <tr>
    <td>Application Fee  :   <i class="fa fa-rupee"></i>500/Paper</td>
    <td>
    </td>
    </tr>
    ...
    <tr>
    <td>Processing Charge : <i class="fa fa-rupee"></i>20</td>
    <td>
