                    ...
                    <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('student_list'); ?></h3>
                    </div>
  ...
  <!--
            ...
            <i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?>
                    ...
                    <div class="box-header ptbnull"><?php echo $this->lang->line('student_list'); ?></div>
                  ...
                  <?php echo form_open('semester_enrollment/enroll/view/' . $stud['id'], ['style' => 'display:inline']); ?>
                  <input type="hidden" name="sem_group_id" value="<?php echo $sem_groups['sem_group_id']; ?>">
                  <button type="submit" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>">
                  ...
                  <?php echo form_open('semester_enrollment/enroll/edit/' . $stud['id'], ['style' => 'display:inline']); ?>
                  <input type="hidden" name="sem_group_id" value="<?php echo $sem_groups['sem_group_id']; ?>">
                  <button type="submit" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>">
                  <i class="fa fa-pencil"></i>
                    ...
                    <!-- <a href="<?php echo base_url(); ?>semester_enrollment/enroll/edit/<?php echo $stud['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                    <i class="fa fa-pencil"></i>
                    </a> -->
