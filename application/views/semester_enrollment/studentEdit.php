        ...
        <form action="<?php echo site_url("semester_enrollment/enroll/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        <div class="box-body">
