    ...
    <div class="col-md-12" style="width:100%; padding:0;">
        <div class="box box-primary">
         ...
         <div class="box-header ptbnull">
                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('enroll'); ?></h3>
                    </div>
                ...
                */
                ...
                <div class="promotion-grid">
                    ...
                    <div class="section-card">
                        <div class="section-title"><?php echo $this->lang->line('enroll'); ?></div>

                        <form role="form" action="<?php echo site_url('semester_enrollment/Enroll/forward_to_enrol') ?>" method="post">
                    ...
                    ?>
                    <tr>
                    <form method="POST" action="<?php echo site_url('semester_enrollment/Enroll/afflited_enrol');?>"  name="form" />
                    <td><?php  echo $sl; ?>
                ...
                $(document).ready(function () {
                var selectedCourse      = "<?php echo set_value('entrance_course'); ?>";
                var selectedInstitute   = "<?php echo set_value('entrance_institute'); ?>";

                if (selectedCourse) {
                // Load institutes for this course
                getinstitutebycourse(selectedCourse, selectedInstitute);
                }
                // When user changes course manually
                $('#entrance_course').on('change', function () {
                getinstitutebycourse($(this).val(), '');
                });
                });
        ...
        success: function (data) {
        $.each(data, function (i, obj) {
        var sel = (entrance_institute == obj.entranceexam_insituteid) ? "selected" : "";
        div_data += "<option value='" + obj.entranceexam_insituteid + "' " + sel + ">" + obj.entranceexam_insitutename + "</option>";
        });
        $('#entrance_institute').append(div_data).trigger('change');
        }
        });
        }
        }
