            ...
            <li class="list-group-item listnoback">
            <b><?php echo $this->lang->line('programee'); ?></b> 
            <a class="pull-right text-aqua"><?php echo $student['p_name'] ; ?></a>
            <br>
            <a class="pull-right text-aqua"><?php echo $student['stm_name'] ; ?></a>
            <br>
            <a class="pull-right text-aqua"><?php echo $student['batch_group_name'] ; ?></a>
            </li>
            ...
            ?>
            <li class="pull-right dropdown" style="margin-right:50px;">
            ...
            ?>
            <tr>
            <td><?php echo $this->lang->line('student').'&nbsp;'.$this->lang->line('sign'); ?></td>
            <td>
            ...
            if (!empty($student["studentsign"]))
            {
            echo base_url() . $student["studentsign"];
            } else {
            ...
            <a href="<?php echo base_url(); ?>student/doc_delete/<?php echo $value['id'] . "/" . $value['student_id']; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
            ...
            <div class="table-responsive">
            <table class="table table-striped table-hover ptt10" id="headerTable" border="1">
            <thead>
            <tr>
            <th style="text-align:center;"><?php echo $this->lang->line('subject'); ?></th>
            <th colspan="2" style="text-align:center;">CE</th>
            <th colspan="2" style="text-align:center;">TE</th>
            ...
            <th><?php echo $this->lang->line('max') . " " . $this->lang->line('marks') ?></th>
            <th><?php echo $this->lang->line('min') . " " . $this->lang->line('marks') ?></th>
            <th><?php  echo $this->lang->line('max') . " " .$this->lang->line('total'); ?></th>
            <th>CE</th> 
            <th>TE</th>
            <th></th>
            <th></th>
            ...
            */
            ...
            <td><?php echo ($exam_result_value->max_cmarks+$exam_result_value->max_marks); ?></td>
            ...
            */
            ...
            <h5 class="description-header"><span>Result:
            <?php
            ...
            ?>
            <span style="<?php echo $backgroundcolor; ?>"><?php echo $result_status; ?></span>
            </span>
            </h5>
            </div>
            </div>
            ...
            <div class="col-sm-3 col-lg-3 col-md-3">
            <div class="description-block">
            <h5 class="description-header"><span>Division:<?php echo $clas; ?></span></h5>
            </div>
            </div>
            ...
            <div class="col-sm-3 col-lg-3 col-md-3">
            <div class="description-block">
            <h5 class="description-header"><span>Total:<?php     echo number_format((float)$grandobtainedtotal, 2, '.', ''); ?></span></h5>
            </div>
            </div>
            ...
            $.ajax({
            url: "<?php echo site_url("semester_enrollment/enroll/disable_reason") ?>",
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
            ...
            $.ajax({
            type: "post",
            url: base_url + "semester_enrollment/enroll/getUserLoginDetails",
            ...
            $.ajax({
            type: "post",
            url: base_url + "semester_enrollment/enroll/enablestudent/"+student_id,
            data: {'student_id': student_id},
            dataType: "json",
            success: function (data) {
            ...
            $.ajax({
            type: "post",
            url: base_url + "semester_enrollment/enroll/getlogindetail",
            data: {'student_id': student_id},
            dataType: "json",
            success: function (response) {
            var data = "";
