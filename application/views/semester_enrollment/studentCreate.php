                        ...
                        <a href="<?php echo site_url('semester_enrollment/enroll/import') ?>">
                        ...
                        <div class="col-md-6">				
                        <div class="pull-right box-tools impbtntitle">
                        <form name="frm" method="POST" action="<?php echo site_url('semester_enrollment/enroll/listlogindetails');?>">
                        ...
                        <form id="form1" action="<?php echo site_url('semester_enrollment/Enroll/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="common-reset-form" >                       
                        <div class="">
                        <div class="bozero">
                        ...
                        <!-- <span class="text-danger" id="form_error_file"><?php echo form_error('file'); ?></span> -->
                        ...
                        <!-- <span class="text-danger"><?php echo form_error('studentsign'); ?></span> -->
