...
class TransactionRequestBean extends RequestValidate
{
    ...
    public function getEncryptedData()
    {
        try {
            ...
            if (!$this->isBlankOrNull($this->session_studid)) {
            $clientMetaData .= "{session_studid:" . $this->session_studid . "}";
            }
            ...
            // if (!$this->isBlankOrNull($this->admission_range)) {
            // $clientMetaData .= "{admission_range:" . $this->admission_range . "}";
            // }
            
            // if (!$this->isBlankOrNull($this->admission_application_no)) {
            // $clientMetaData .= "{admission_application_no:" . $this->admission_application_no . "}";
            // }
            
            // if (!$this->isBlankOrNull($this->ayear))
            // {
            // $clientMetaData .= "{ayear:" . $this->ayear . "}";
            // }
