...
{ 
     ...
     * @param string $iv
     */
    function __construct($data = null, $key = null, $blockSize = null, $mode = null, $iv = null)
    {
        $this->data = $data;
        $this->key = $key;
    ...
    public function setBlockSize($value)
    {
        switch ($value) {
            case 128 :
                $cipher = AESPAY::AES_CIPHER_128;
                break;
            case 192 :
                $cipher = AESPAY::AES_CIPHER_192;
                break;
            case 256 :
                $cipher = AESPAY::AES_CIPHER_256;
                break;
        }
        return $cipher;
    }
    ...
    public function setMode($value)
    {
        switch ($value) {
            ...
            case AESPAY::M_OFB :
                $mode = AESPAY::M_OFB;
                break;
            case AESPAY::M_STREAM :
                $mode = AESPAY::M_STREAM;
                break;
            default :
                $mode = AESPAY::M_ECB;
                break;
