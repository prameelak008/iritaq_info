...
if ($_POST) {
    ...
    if (isset($responseData['clnt_rqst_meta'])) {
        ...
        $feepay = array(
        'fees_payment_responsecode'   => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
        'fees_payment_statuscode'     => $txnmsg_msg,
        'fees_payment_student_id'     => isset($responseData['student_id']) ? $responseData['student_id'] : null,
        'fees_payment_class_id'       => isset($responseData['class_id']) ? $responseData['class_id'] : null,
        'fees_payment_section_id'     => isset($responseData['section_id']) ? $responseData['section_id'] : null,
        'fees_payment_session'        => isset($responseData['session_id']) ? $responseData['session_id'] : null,
        'fees_payment_examgroup'      => isset($responseData['examgroup']) ? $responseData['examgroup'] : null,
        'fees_payment_exam'           => isset($responseData['examgroupbatch']) ? $responseData['examgroupbatch'] : null,
        'fees_payment_orderid'        => isset($responseData['txn_status']) ? $responseData['txn_status'] : null,
        'fees_payment_transdate'      => isset($responseData['tpsl_txn_time']) ? $responseData['tpsl_txn_time'] : null,
        'fees_payment_transaction_no' => isset($responseData['clnt_txn_ref']) ? $responseData['clnt_txn_ref'] : null,
        'fees_payment_orderid'        => isset($responseData['tpsl_txn_id']) ? $responseData['tpsl_txn_id'] : null,
        'fees_payment_amount'         => isset($responseData['txn_amt']) ? $responseData['txn_amt'] : null,
        'fees_payment_created_date'   => date('d-m-y H:i:s'),
        'fees_payment_onlinestatus'   =>"Worldline-3rd Stage",
        'fees_payment_errormsg'       => isset($responseData['txn_err_msg']) ? $responseData['txn_err_msg'] : null,
        'fees_payment_year'           => date('Y'));
        
        
        $this->Pay_storemodel->insert_fees_payment($feepay);
