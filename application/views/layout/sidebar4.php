...
if ($this->rbac->hasPrivilege('print_consolidatedmarksheet', 'can_view')) {
            ?>
<li class="<?php echo set_Submenu('Examinations/examresult/consolidatedmarksheet'); ?>"><a href="<?php echo base_url(); ?>admin/examresult/consolidatedmarksheet"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('print') . " " . $this->lang->line('consolidated'); ?></a></li>
                                <?php
}
...
?>
    ...
    <li class="<?php echo set_Submenu('valuation_Camp/assign_subject'); ?>"><a href="<?php echo site_url('admin/valuation/assign_subject'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('assign') . " " . $this->lang->line('subjects') ?></a></li>
    <?php } ?>
...
<li class="<?php echo set_Submenu('onlineExamination'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam_list"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('onlineExamination') ?></a></li>
<li class="<?php echo set_Submenu('approve_onlineExamination'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam_list/approve_onlineexam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('approve_onlineExamination') ?></a></li>
...
<li class="<?php echo set_Submenu('onlineexam_list/online_examination_instruction'); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam_list/online_exam_instruction"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('online_examination_instruction') ?></a></li>
