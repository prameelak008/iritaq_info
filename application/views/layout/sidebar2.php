...
<i class="fa fa-file-o"></i> <span><?php echo $this->lang->line('onlineExamination'); ?></span></a>
</li>
        ...
        ?>
         ...
         <li class="treeview <?php echo set_Topmenu('onlineExamination'); ?>">
                        ...
                        <ul class="treeview-menu">
                                    ...
                                    {
                                    ?>
                                <li class="<?php echo set_Submenu(''); ?>"><a href="<?php echo base_url(); ?>admin/onlineexam_list"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('onlineExamination') ?></a></li>
                                <?php
                                }
