  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/css/topbar_style.css">
                ...
                <li class="col-lg-3 col-md-3 col-sm-6 <?php echo ($this->uri->segment(2) == 'Semester_period_attendance') ? 'active' : ''; ?>"><a href="<?php echo base_url(); ?>semester_activities/Semester_period_attendance/index"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('period').'&nbsp;'.$this->lang->line('attendance'); ?></a></li>  
