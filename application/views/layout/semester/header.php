                ...
                <?php
                $programs           =    $this->Semester_enrollment_model->get_program_list();
                ?>
                <style>
                .semester-badge {
                font-size: 12px;
                ...
                background: linear-gradient(135deg, #e2e5e7 0%, #e2e5e7 100%);
                color: white;
                }
    ...
    <div class="modal fade" id="semesterHistoryModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">
                        <i class="fas fa-history"></i> Select Semester to View
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="semester-info-box">
                        ...
                        <p class="mb-1"><strong>Student:</strong><?php   echo $firstname; ?> </p>
                        <p class="mb-1"><strong>Program:</strong> B.Tech Computer Science</p>
                        <p class="mb-1"><strong>Current Semester:</strong> Semester 2</p>
                        <p class="mb-0"><strong>Batch:</strong> 2024-2028</p>
                    </div>

                    <!-- Selection Form -->
                    <form id="semesterHistoryForm">
                        <div class="row">
                            <!-- Program Dropdown -->
                            <div class="col-md-6">
                                <!-- <div class="form-group">
                                    <label>Program <small class="text-danger">*</small></label>
                                    <select id="program_id" name="program_id" class="form-control" required>
                                        <option value="">-- Select Program --</option>
                                        <option value="1" selected>B.Tech Computer Science</option>
                            ...
                            <span class="text-danger"><?= form_error('sem_type'); ?></span>
                                ...
                                <!-- <div class="form-group">
                                    <label>Batch <small class="text-danger">*</small></label>
                                    <select id="batch_id" name="batch_id" class="form-control" required>
                                        <option value="">-- Select Batch --</option>
                                        <option value="1" selected>2024-2028</option>
                                        <option value="2">2023-2027</option>
                                        <option value="3">2022-2026</option>
                                    </select>
                                </div> -->
                            </div>
                        </div>
                        ...
                        <!-- <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Select Semester to View <small class="text-danger">*</small></label>
                                    <select id="semester_id" name="semester_id" class="form-control form-control-lg" required>
                                        <option value="">-- Select Semester --</option>
                                        <option value="1">Semester 1 (Completed) - Jul 2024 to Dec 2024</option>
                                        <option value="2" selected>Semester 2 (Current) - Jan 2025 to May 2025</option>
                                    </select>
                                </div>
                            </div>
                        </div> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="btn-group-toggle" data-toggle="buttons">
                                    <button type="button" class="btn btn-outline-info quick-access-btn" id="viewCurrentSem">
                                        <i class="fas fa-eye"></i> Current Semester
                                    </button>
                                    <button type="button" class="btn btn-outline-warning quick-access-btn" id="viewPreviousSem">
                                        <i class="fas fa-step-backward"></i> Previous Semester
                                    </button>
                                    <!-- <button type="button" class="btn btn-outline-success quick-access-btn" id="viewAllSemesters">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Your Semester History:</strong>
                                    <div class="mt-2">
                                        <span class="badge badge-success mr-1">Semester 1 (Completed)</span>
                                        <span class="badge badge-primary mr-1">Semester 2 (Current)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="viewHistoryBtn">
                        <i class="fas fa-search"></i> View Selected Semester
                    </button>
                </div>
                ...
                <button class="btn history-btn btn-sm" data-toggle="modal" data-target="#semesterHistoryModal">
