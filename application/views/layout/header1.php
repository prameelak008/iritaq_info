...
<li class="dropdown" data-placement="bottom" data-toggle="tooltip" title="<?php echo $this->lang->line('student') .'--'. $this->lang->line('staff').''.$this->lang->line('leave') ;?>">
...
<?php echo $this->lang->line('student').'&nbsp;'.$this->lang->line('approve').'&nbsp;'.$this->lang->line('leave'); ?>
...
{
?>
<?php echo $this->lang->line('today_you_have'); ?> <?php echo $stfcoun; ?>&nbsp;<?php echo $this->lang->line('staff').'&nbsp;'.$this->lang->line('approve').'&nbsp;'.$this->lang->line('leave'); ?>
