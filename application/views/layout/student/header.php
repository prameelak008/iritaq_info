                            ...
                            <!--
                            <li ><a href="<?php echo base_url(); ?>user/user/choose"><i class="fa fa-users ftlayer"></i> <span>Siblings</span></a></li>-->
                            ...
                            <i class="fa fa-download ftlayer"></i> <span><?php echo $this->lang->line('download_center'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <li class="<?php echo set_Submenu('content/refund'); ?>"><a href="<?php echo base_url(); ?>user/content/refund"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('refund'); ?></a></li>
                                ...
                                <li class="<?php echo set_Submenu('content/oldquestionppapers'); ?>"><a href="<?php echo base_url(); ?>user/content/oldquestionppapers"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('old_question_papers'); ?></a></li>
                            ...
                            <li class="treeview <?php echo set_Topmenu('Attendence'); ?>"><a href="<?php echo base_url(); ?>user/attendence/custom_report"><i class="fa fa-calendar-check-o ftlayer"></i> <span><?php echo $this->lang->line('subject').'&nbsp;'.$this->lang->line('attendance'); ?></span></a></li>
                            ...
                            <a href="#">
                            <i class="fa fa-file-text"></i> <span><?php echo $this->lang->line('examinations'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            
                            <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('Examinations/applyonlineExamination'); ?>">
                            <a href="<?php echo base_url(); ?>user/user/onlineExamination">
                            <i class="fa fa-angle-double-right"></i> <span><?php echo $this->lang->line('applyonlineExamination'); ?></span></a>
                            </li> 
                            ...
                            <li class="<?php echo set_Submenu('Examinations/print_admit_card'); ?>">
                            <a href="<?php echo base_url(); ?>user/user/admitcard">
                            <i class="fa fa-angle-double-right"></i> <span><?php echo $this->lang->line('print_admit_card'); ?></span></a>
                            </li>
                            
                            
                            <li class="<?php echo set_Submenu('Examinations/examresult_print'); ?>"><a href="<?php echo base_url(); ?>user/exam/examresult_print"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('print')." ".$this->lang->line('exam')." ".$this->lang->line('result'); ?></a></li>
                            
                            <li class="<?php echo set_Submenu('Examinations/exam_revaluation'); ?>"><a href="<?php echo base_url(); ?>user/revaluation/exam_revaluation"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_revaluation'); ?></a></li>
                            <!--<li class="<?php echo set_Submenu('Examinations/exam_revaluation'); ?>"><a href="<?php echo base_url(); ?>user/revaluation/inprogress"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_revaluation'); ?></a></li>-->
                            
                            
                             <li class="treeview <?php echo set_Topmenu('Attendence'); ?>"><a href="<?php echo base_url(); ?>user/attendence"><i class="fa fa-calendar-check-o ftlayer"></i> <span><?php echo $this->lang->line('progresscard'); ?></span></a></li>
                            ...
                            <a href="#">
                            <i class="fa fa-file-text"></i> <span><?php echo $this->lang->line('semester'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            ...
                            <?php if ($this->studentmodule_lib->hasActive('examinations')) {
                            ?>
                            <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                            <a href="#">
                            <i class="fa fa-file-text"></i> <span><?php echo $this->lang->line('sayexam'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            
                            <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('sayexam/sayexam_temarks'); ?>"><a href="<?php echo base_url(); ?>user/sayexam_temarks/sayexam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_te_sayexam'); ?></a></li> 
                            
                            <!--<li class="<?php echo set_Submenu('sayexam/sayexam_cemarks'); ?>"><a href="<?php echo base_url(); ?>user/sayexam_cemarks/sayexam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_ce_sayexam'); ?></a></li> -->
                            
                            
                            <li class="<?php echo set_Submenu('sayexam/sayexam'); ?>"><a href="<?php echo base_url(); ?>user/sayexam/sayexam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_ce_sayexam'); ?></a></li>
                            ...
                            <a href="#">
                            <i class="fa fa-file-text"></i> <span><?php echo $this->lang->line('improvement'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('Improvement/improvement'); ?>"><a href="<?php echo base_url(); ?>user/improvement/improvement"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_for_improvement'); ?></a></li>
                            </ul>
                            </li>
