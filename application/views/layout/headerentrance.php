                    ...
                    <div class="col-lg-7 col-md-9 col-sm-10 col-xs-7">
                        <div class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('student', 'can_view')) {?>
                                <form id="stentrance" method="POST" action="<?php echo site_url('admin/admin/entrancedashboard'); ?>" class="navbar-form navbar-left search-form">
                                     <div class="input-group">
                                        <input type="submit" name="btnexam" value="Entrance Exam"/>
                                    </div>
                                </form>
                                <form id="ststudent" method="POST" action="<?php echo site_url('admin/admin/dashboard'); ?>" class="navbar-form navbar-left search-form">
                                     <div class="input-group">
...
?>
            ...
            <?php $this->load->view('layout/sidebarentrance');?>
            <script>
                function defoult(id){
