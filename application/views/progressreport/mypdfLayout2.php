...
<thead>
    ...
    <tbody>
        ...
        <!-- and so on... -->
            ...
            <img src="<?php echo base_url();?>backend/pdf_layout/<?php echo $layout['progress_card_footer1'];   ?>" width="100%">
            </div>
            </div>
     ...
     <img src="<?php  echo base_url(); ?>backend/check/downloadnocheck.png"/>
      ...
      <img src="<?php  echo base_url(); ?>backend/check/downloadnocheck.png"  />
        ...
        <td class="tdcls"   colspan="4" align ="center"  >&nbsp;&nbsp;&nbsp;&nbsp;</td>
            ...
            <img src="<?php echo base_url();?>backend/pdf_layout/<?php echo $layout['progress_card_footer2'];   ?>" width="100%">
            </div>
            </div>
     ...
     <img src="<?php  echo base_url(); ?>backend/check/downloadnocheck.png"/>
      ...
      <img src="<?php  echo base_url(); ?>backend/check/downloadnocheck.png"  />
        ...
        <td class="tdcls"   colspan="4" align ="center"  >&nbsp;&nbsp;&nbsp;&nbsp;</td>
            ...
            <img src="<?php echo base_url();?>backend/pdf_layout/<?php echo $layout['progress_card_footer3'];   ?>" width="100%">
            </div>
            </div>
