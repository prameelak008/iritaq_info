        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('report/subjectresultreport_sayexamte') ?>" method="post">
                    ...
                    if (isset($studentList)) {
                        ...
                        <div class="box-body">
                            <div class="table-responsive no-padding">
                                ...
                                <?php echo $this->lang->line('say').'&nbsp;'.$this->lang->line('examinations').'&nbsp;'.$this->lang->line('TE').'&nbsp;'.$sess['session']; ?>
                                        ...
                                        if (!empty($student_list_array)) {
                                            ...
                                            foreach ($student_list_array as $student_list_value) {
                                                ?>
                                                    ...
                                                    $this->db->join('exam_group_exam_sayexam_temarks','exam_group_exam_sayexam_temarks.exam_group_exam_sayexam_subject_id=exam_group_class_batch_exam_subjects.id');
                                                    $this->db->where('exam_group_exam_sayexam_temarks.exam_group_exam_sayexam_student_studentid',$student_list_value['student_id']);
                                                    $this->db->where('exam_group_exam_sayexam_temarks.exam_group_exam_sayexam_subject_id',$subject_value->id);
                                                    $this->db->where('exam_group_exam_sayexam_temarks.exam_group_exam_sayexam_examid',$subject_value->exam_group_class_batch_exams_id);
                                                    $this->db->where('exam_group_exam_sayexam_temarks.exam_group_exam_sayexam_session_id',$current_session);
                                                    $query=$this->db->get();
