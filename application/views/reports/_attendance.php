        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('staff_attendance_reportbyhour', 'can_view')) {
                            ?>  
                    
                    <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/staff_attendance_reportbyhour'); ?>"><a href="<?php echo base_url() ?>admin/staffattendance/attendancereportbyhour"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('staff_attendance_reportbyhour'); ?></a></li>
...
<li class="col-lg-4 col-md-4 col-sm-6 "><a href="<?php echo base_url() ?>report/daily_studentattendance_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('student_daily_attendence'); ?></a></li>


<li class="col-lg-4 col-md-4 col-sm-6 "><a href="<?php echo base_url() ?>report/daily_staffattendance_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('staff_daily_attendence'); ?></a></li>



<li class="col-lg-4 col-md-4 col-sm-6 "><a href="<?php echo base_url() ?>report/student_category_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('student_category'); ?></a></li>
                    ...
                    if (is_subAttendence()) {
                        if (($this->rbac->hasPrivilege('student_period_attendance_report', 'can_view'))) {
                            ...
                            <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_subSubmenu('Reports/attendence/dayreportbymonthstudent'); ?>"><a href="<?php echo site_url('admin/subjectattendence/dayreportbymonthstudent'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('day') . " " .$this->lang->line('student') . " " . $this->lang->line('period') . " " . $this->lang->line('attendance'); ?></a></li> 
                            <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_subSubmenu('Reports/attendence/reportbetween_bydate'); ?>"><a href="<?php echo site_url('admin/subjectattendence/reportbetween_bydate'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('period'). '&nbsp; ' . $this->lang->line('attendance').'&nbsp;'.$this->lang->line('between').'&nbsp;'.$this->lang->line('date')  ?></a></li>
