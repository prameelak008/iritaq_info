...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form id='form1' action="<?php echo site_url('report/daily_studentattendance_report') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        <select autofocus="" id="class" name="class" class="form-control" >
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                         ...
                                         $date_fr;
                                        foreach ($student_absent_request as $ky) {
                                            ?>
                                            <tr>
      ...
      $query = $this->db->query("select * from student_applyleave    where  '" . $date_fr . "'  between  student_applyleave.from_date and student_applyleave.to_date  and student_applyleave.status='1' and student_applyleave.student_session_id   = '".$ky['id']."'");
        $res= $query->row_array();                                                
