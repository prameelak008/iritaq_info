        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('report/subjectresultreport') ?>" method="post">
                    ...
                    if (isset($studentList)) {
                        ...
                        <div class="box-body">
                            <div class="table-responsive no-padding">
                                <div class="download_label"> <?php echo $this->lang->line('select_criteria'); ?> "<br>";
                 ...
                 if($result_value['attendence'] == 'present') { ?>
                 ...
                 <?php }    
                 // echo $this->lang->line($result_value['attendence']);                                                       
                 // .($result_value['get_exam_grade'] == "-" ? "": " (" . $result_value['get_exam_grade'] . ")" );
                                                                        }
                                                                    ...
                                                                    if ($result_value['attendence'] == 'present') {
                                                                        // Calculate and accumulate present count for each subject
                                                                        if (!isset($subjectPresentCount[$result_key])) {
                                                                            $subjectPresentCount[$result_key] = 1;
                                                                        } else {
                                                                            $subjectPresentCount[$result_key]++;
                                                                        }
                                                                    }
                                                                    ?>
                                                                </td>
...
//                                                        print_r($student_list_value);
                                                            if ($student_list_value['total_subject'] > 0 && $student_list_value['result_total_subject'] >= 1)
                                                                ...
                                                                if (!empty($subjectPresentCount)) {
                                                                    echo '<tr><td></td>';
                                                                    foreach ($subjectPresentCount as $subjectCount) {
                                                                        echo '<td style="text-align: left">' . $subjectCount . '</td>';
                                                                    }
                                                                    echo '</tr>';
                                                                }
                                                                ?>
