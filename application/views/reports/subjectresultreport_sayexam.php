        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('report/subjectresultreport_sayexam') ?>" method="post">
                    ...
                    ?>
                        ...
                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('select_criteria'); ?> </h3>
                        </div>
                        
                        
                        <div class="box-body">
                            <div class="table-responsive no-padding">
                            <div class="download_label"><?php echo $this->lang->line('select_criteria'); ?>
                            
                                 <span  >
                                 <h1>    
                                  <?php echo $this->lang->line('say').'&nbsp;'.$this->lang->line('examinations').'&nbsp;'.$sess['session']; ?>
                                    </h1><br>
                                    <span style=""><h5>
                                    <?php
                                        ...
                                        if (!empty($student_list_array)) {
                                            ...
                                            foreach ($student_list_array as $student_list_value) {
                                                ?>
                                                    ...
                                                    $this->db->join('exam_group_exam_sayexam','exam_group_exam_sayexam.exam_group_exam_sayexam_subject_id=exam_group_class_batch_exam_subjects.id');
                                                    $this->db->where('exam_group_exam_sayexam.exam_group_exam_sayexam_student_studentid',$student_list_value['student_id']);
                                                    $this->db->where('exam_group_exam_sayexam.exam_group_exam_sayexam_subject_id',$subject_value->id);
                                                    $this->db->where('exam_group_exam_sayexam.exam_group_exam_sayexam_examid',$subject_value->exam_group_class_batch_exams_id);
                                                    $this->db->where('exam_group_exam_sayexam.exam_group_exam_sayexam_session_id',$current_session);
                                                    $query=$this->db->get();
                                                    $getstatus= $query->row_array();
                                                    ...
                                                    <span style="color:green; font-size:19px ;text-align:center !important;"> &#x2705;</span>
                                                    
                                                    <?php
                                                    if (!isset($subjectCheckCounts[$subject_value->id])) {
                                                    $subjectCheckCounts[$subject_value->id] = 1;
                                                    } 
                                                    else 
                                                    {
                                                    $subjectCheckCounts[$subject_value->id]++;
                                                    }
                                                    } 
                                                    else 
                                                    {
                                                    ?>
                                                    <span style="color:green; font-size:25px ;text-align:center !important;"> &#x2610;</span>
                                                    <?php
                                                    }
                                                    ?>
                                                ...
                                                <td></td>  
                                                <td></td>  
                                                <td style="text-align:left; font-weight:bold;"><?php  echo $this->lang->line('total').'&nbsp;'.$this->lang->line('students'); ?></td>
                                                <?php
                                                foreach ($subjectList as $subject_key => $subject_value)
                                                {
                                                ?>
                                                ...
                                                $query = $this->db->get();
                                                $getstatus = $query->row_array();
                                                if($getstatus['row_count']>0)
                                                {
                                                echo $getstatus['row_count']; 
                                                }
                                                else
                                                {
