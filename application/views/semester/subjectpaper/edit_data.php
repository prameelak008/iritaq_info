            ...
            <form id="form1" action="<?php echo site_url('semester/Semester_Subjectpaper/edit/'.$id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            */
            ...
            ?>
            <option value="<?php echo $subs['id'] ?>" <?php if ($edit_subject_paper['id'] == $subs['id']) { echo "selected=selected"; } ?>><?php echo $subs['name'].'&nbsp;-&nbsp;'.$subs['code'] ?></option> 
            <?php } ?>
            </select>
            ...
            <input type="text" name="paper_code" id="paper_code" class="form-control" value="<?php echo $edit_subject_paper['sem_paper_code']  ?>" />
            ...
            <input type="text" name="papername" id="papername" class="form-control"  value="<?php echo $edit_subject_paper['sem_paper_paper']  ?>"/>          
            ...
            <textarea class="form-control" name="description" id="description"><?php echo $edit_subject_paper['sem_paper_description']  ?></textarea>        
            ...
            <a data-placement="left" href="<?php echo site_url('semester/Semester_Subjectpaper/delete/' . $paper['sem_paper_id']); ?>" onclick="return doconfirm();"   class="btn btn-default btn-xs"   data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash trashstyle" style="color:#cb1515;"></i></a>
            </td>
            </tr>
            <?php $sl++;
            } ?>
