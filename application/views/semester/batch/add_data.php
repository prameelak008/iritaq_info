            ...
            <h3 class="box-title"><?php echo $this->lang->line('add').'&nbsp;'.$this->lang->line('batch'); ?></h3>
            </div><!-- /.box-header -->
        ...
        -->
            ...
            {
            ?>
            <option value="<?php echo  $batch['batch_group_id']; ?>"<?php if(set_value('batch_type')==$batch['batch_group_id']) { echo "selected=selected"; }        ?> ><?php echo  $batch['batch_group_name'].'&nbsp;&nbsp;'.$batch['batch_group_year']; ?> </option>
            <?php 
            }
            ?>
            </select> 
            ...
            $('#programee').append('<option value="' + value.id + '">' + value.p_name + '</option>');
            });
            }
            });
            }
