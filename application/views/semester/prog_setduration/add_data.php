            ...
            <input id="programee_id" name="programee_id" placeholder="programee Identify Number" type="text" class="form-control"  value="<?php  echo $max; ?>"/>
            ...
            <input id="programee_code" name="programee_code" placeholder="programee Identify Code" type="text" class="form-control"  value="<?php echo set_value('programee_code'); ?>" />
            ...
            <input id="programee_name" name="programee_type" placeholder="programee Type" type="text" class="form-control"  value="<?php echo set_value('programee_type'); ?>" />
            ...
            <input id="programee_name" name="programee_name" placeholder="programee Identify Name" type="text" class="form-control"  value="<?php echo set_value('programee_name'); ?>" />
            ...
            <td><?php  echo $programee['p_name']; ?></td>
             <td><?php  echo $programee['p_type']; ?></td>
            <td>
            ...
            <a data-placement="left" href="<?php echo site_url('semester/programee/delete/' . $programee['id']); ?>" onclick="return doconfirm();"   class="btn btn-default btn-xs"   data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash" ></i></a>
            </td>
            </tr>
            <?php } ?>
            </tbody>
