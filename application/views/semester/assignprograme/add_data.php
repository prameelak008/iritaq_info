        ...
        <?php
          ...
          <form id="form1" action="<?php echo site_url('semester/assignprogramme/') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          ...
          */
          ...
          <?php
          foreach($programelist as $prog)
          {
          ?>
          <option value="<?php echo $prog['id']; ?>">
          <?php
          if(set_value('programme')==$prog['id'])
          {
          ...
          <?php
          if(set_value('facultydept')==$fac['id'])
          {
          echo "selected=selected" ;  
          }
          ?>>
