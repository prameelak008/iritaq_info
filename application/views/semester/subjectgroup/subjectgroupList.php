        ...
        <form id="form1" action="<?php echo site_url('semester/Semester_subjectgroups') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
        ...
        */
        ...
        <div class="checkbox">
        <label>
        <input type="checkbox" name="subject[]" value="<?php echo $subject['id'] ?>" <?php echo set_checkbox('subject[]', $subject['id']); ?> >
        ...
        <textarea class="form-control" id="description" name="description" placeholder="" rows="5" placeholder="Enter ..."><?php echo set_value('description'); ?></textarea>
        ...
        <div class="table-responsive mailbox-messages" id="subject_list">
                                           ...
                                           <td class="mailbox-name">
                                            ...
                                            <td class="mailbox-date pull-right no_print">
                                                ...
                                                if ($this->rbac->hasPrivilege('subject_group', 'can_edit')) {
                                                    ?>
                                                     <a href="<?php echo base_url(); ?>semester/Semester_Subjectgroups/edit/<?php echo $subjectgroup->id; ?>" class="btn btn-default btn-xs no_print displayinline" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                <i class="fa fa-pencil"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('subject_group', 'can_delete')) {
                                                    ?>
                                                     <a  href="<?php echo base_url(); ?>semester/Semester_Subjectgroups/delete/<?php echo $subjectgroup->id; ?>"class="btn btn-default btn-xs no_print displayinline" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
