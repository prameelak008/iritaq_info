                                                            ...
                                                            foreach ($arrvalue as $arkey => $arvalue) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  class="mailbox-date pull-right">
                                                                        ...
                                                                        <a href="<?php echo base_url(); ?>feetype/delete/<?php echo $arkey; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
