...
<div class="content-wrapper">
    ...
    <!-- /.control-sidebar -->
    <form action="<?php echo site_url('cardtest/meTrnReq'); ?>"  method="POST" >
...
if (!empty($student['image'])) {
    ...
    <input type="submit" name="Print" value="Card" class="btn btn-sm btn-success"  >
                                 <!--<a href="javascript:void(0)" class="btn btn-sm btn-info PaySelected" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><i class="fa fa-print"></i> <?php echo $this->lang->line('card'); ?> </a>-->
...
<script type="text/javascript">
  ...
  $(document).on('click', '.collectSelected', function () {
    ...
    function Popup(data, winload = false)
    {
     ...
     $(document).on('click', '.PaySelected', function () 
        {
            ...
            if (array_to_print.length === 0) {
             ...
             {
                $.ajax({
                    url: '<?php echo site_url("cardtest/meTrnReq") ?>',
                    type: 'post',
                    data: {'data': JSON.stringify(array_to_print)},
                     beforeSend: function () 
                     {
