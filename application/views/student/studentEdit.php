        ...
        */
        ...
        <input type="hidden" name="student_id" id="studentoo_id" value="<?php echo set_value('id', $student['id']); ?>">
        ...
        <span class="text-danger" id="form_error_admission_no"><?php echo form_error('admission_no'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_roll_no"><?php echo form_error('roll_no'); ?></span>
        </div>
        </div>
        <?php } ?>
        <div class="col-md-3">
        ...
        <span class="text-danger" id="form_error_class_id"><?php echo form_error('class_id'); ?></span>
        </div>
        </div>
        ...
        <option value="<?php echo $student['section_id']; ?>"><?php echo $student['section']; ?></option>
        </select>
        <span class="text-danger" id="form_error_section_id"><?php echo form_error('section_id'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_firstname"><?php echo form_error('firstname'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_middlename"><?php echo form_error('middlename'); ?></span>
        </div>
        </div>
        <?php } ?>
        ...
        <span class="text-danger" id="form_error_lastname"><?php echo form_error('lastname'); ?></span>
        </div>
        </div>
        <?php } ?>
        <div class="col-md-3">
        ...
        <span class="text-danger" id="form_error_dob"><?php echo form_error('dob'); ?></span>
        </div>
        </div>
        </div>
        <div class="row">
        ...
        <div class="col-md-3">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('mobile_no'); ?></label><small class="req"> *</small>
        ...
        */
        ...
        if ($sch_setting->student_sign) 
        { 
        ?>            
        <div class="col-md-3">
        <div class="form-group">
        <label for="exampleInputFile"><?php echo $this->lang->line('student') . " " . $this->lang->line('sign'); ?></label>
        <div><input class="filestyle form-control" type='file' name='studentsign' id="studentsign" size='20' />
        </div>
        <span class="text-danger"><?php echo form_error('studentsign'); ?></span></div>
        </div>
        ...
        <div class="col-md-3">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('blood_group'); ?></label><small class="req"> *</small>
        <?php ?>
        <select class="form-control" rows="3" placeholder="" name="blood_group" id="blood_group">
        <option value="<?php echo $student['bloodgroup'];?>"><?php echo $student['bloodgroup'];?></option>
        ...
        <span class="text-danger" id="form_error_blood_group"><?php echo form_error('blood_group'); ?></span>
        </div>
        </div>
        ...
        <div class=" col-md-12 col-sm-3 col-xs-5"> 
        <?php
        if ($sch_setting->student_photo) { ?>
        <div class="col-md-3">
        <div class="form-group">
        ...
        <label for="exampleInputFile"><?php echo $this->lang->line('student') . "  " . $this->lang->line('photo'); ?>&nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
        ...
        // No image available, use gender-specific or default placeholder
        if (isset($student['gender']) && $student['gender'] == 'Female') {
        $image = base_url() . "uploads/student_images/default_female.jpg";
        } elseif (isset($student['gender']) && $student['gender'] == 'Male') {
        $image = base_url() . "uploads/student_images/default_male.jpg";
        } else {
        // If gender is unknown, use a general placeholder
        ...
        <span class="text-danger" id="form_error_house"><?php echo form_error('house'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_height"><?php echo form_error('height'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_weight"><?php echo form_error('height'); ?></span>
        </div>
        </div>
        ...
        <span class="text-danger" id="form_error_measure_date"><?php echo form_error('measure_date'); ?></span>
        </div>
        </div>
        <?php } ?>
        ...
        $default_image = base_url() . "uploads/student_images/default_female.jpg";
        } elseif ($sibling_value->gender == 'Male') {
        $default_image = base_url() . "uploads/student_images/default_male.jpg";
        } else {

        $default_image = base_url() . "uploads/student_images/default_avatar.jpg";
        }
        $image_url = $default_image;
        } else {

        $image_url = base_url() . $sibling_value->image;
        }
        ?>

        <img class="" src="<?php echo $image_url; ?>" alt="Image">
        ...
        <?php $newidd= $sibling_value->id ;?>

        <button type="button" class="btn btn-primary btn-sm" onclick="remove_newsibling(<?php echo $newidd; ?>)"><?php echo $this->lang->line('remove'); ?> <?php echo $this->lang->line('sibling'); ?>
        ...
        <label for="exampleInputFile"><?php echo $this->lang->line('father') . " " . $this->lang->line('photo'); ?>&nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
        <div class="siblingview">
        ...
        // {
        // No image available, use gender-specific or default 


        if (($student['father_pic']) =="")
        {

        $fatherimage = base_url() . "uploads/student_images/no_image.png";     
        }
        else
        {
        $fatherimage = base_url() . $student["father_pic"];
        }

        echo '<img src="' . $fatherimage . '" alt="Student Image">';
        ...
        <label for="exampleInputFile"><?php echo $this->lang->line('mother') . " " . $this->lang->line('photo'); ?>&nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
        <div class="siblingview">
        ...
        $motherimage = base_url() . "uploads/student_images/no_image.png";     
        }
        else
        {
        $motherimage = base_url() . $student["mother_pic"];
        }

        echo '<img src="' . $motherimage . '" alt="Mother Image">';
        ...
        <label for="exampleInputFile"><?php echo $this->lang->line('guardian') . " " . $this->lang->line('photo'); ?>&nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
        <div class="siblingview">
        ...
        $guardian_pic = base_url() . "uploads/student_images/no_image.png";     
        }
        else
        {
        $guardian_pic = base_url() . $student["guardian_pic"];
        }

        echo '<img src="' . $guardian_pic . '" alt="Guardian Image">';
        ...
        <div class="tshadow mb25 bozero">
        <h4 class="pagetitleh2"><?php echo $this->lang->line('previous'); ?> <?php echo $this->lang->line('study'); ?> <?php echo $this->lang->line('details'); ?></h4>
        <div class="around10">
        <div class="row">

        <div class="row around10" id="course_details">
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('laststudied').''.$this->lang->line('madarasaa'); ?></label>
        <input type="text" name="last_studied_madrasa" id="last_studied_madrasa" class="form-control" value="<?php echo set_value('last_studied_madrasa', $student['last_studied_madrasa']); ?>" />
        <span class="text-danger"><?php echo form_error('last_studied_madrasa'); ?></span>
        </div>
        </div>
        ...
        <input type="text" name="last_studied_madrasa_class" id="last_studied_madrasa_class" class="form-control" value="<?php echo set_value('last_studied_madrasa_class', $student['last_studied_madrasa_class']); ?>" />
        <span class="text-danger"><?php echo form_error('last_studied_madrasa_class'); ?></span>
        </div>
        </div>
        ...
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('register'); ?></label>

        <input type="text" name="previous_reg_no" id="previous_reg_no" class="form-control" value="<?php echo set_value('previous_reg_no', $student['previous_reg_no']); ?>" />
        <span class="text-danger"><?php echo form_error('previous_reg_no'); ?></span>
        </div>
        </div>
        <!--
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('laststudied_school'); ?></label>

        <input type="text" name="last_studied_school" id="last_studied_school" class="form-control" value="<?php echo set_value('last_studied_school', $student['previous_school']); ?>" />
        <span class="text-danger"><?php echo form_error('last_studied_school'); ?></span>
        </div>
        </div>
        -->
        ...
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('laststudied_class'); ?></label>

        <input type="text" name="last_studied_class" id="last_studied_class" class="form-control" value="<?php echo set_value('last_studied_class', $student['last_studied_class']); ?>" />
        <span class="text-danger"><?php echo form_error('last_studied_class'); ?></span>
        </div>
        </div>

        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('medium'); ?></label>

        <input type="text" name="previous_medium" id="previous_medium" class="form-control" value="<?php echo set_value('previous_medium', $student['previous_medium']); ?>" />
        <span class="text-danger"><?php echo form_error('previous_medium'); ?></span>
        </div>
        </div>
        </div>


        <div class="row around10" id="pg_course_details" >
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('last_studied_institute'); ?></label>
        <input type="text" name="last_studied_institute" id="last_studied_institute" class="form-control" value="<?php echo set_value('last_studied_institute', $student['last_studied_institute']); ?>" />
        ...
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('years_completed'); ?></label>

        <input type="text" name="years_completed" id="years_completed" class="form-control" value="<?php echo set_value('years_completed', $student['years_completed']); ?>" />
        ...
        <input type="text" name="previous_place" id="previous_place" class="form-control" value="<?php echo set_value('previous_place', $student['previous_place']); ?>" />
        <span class="text-danger"><?php echo form_error('previous_place'); ?></span>
        </div>
        </div>

        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('name_of_prominent_teacher'); ?></label>

        <input type="text" name="name_of_prominent_teacher" id="name_of_prominent_teacher" class="form-control" value="<?php echo set_value('name_of_prominent_teacher', $student['name_of_prominent_teacher']); ?>"  />
        <span class="text-danger"><?php echo form_error('name_of_prominent_teacher'); ?></span>
        </div>
        </div>
        ...
        <div class="col-md-4">
        <div class="form-group">
        <label for="exampleInputEmail1"><?php echo $this->lang->line('major_books_studied'); ?></label>

        <input type="text" name="major_books_studied" id="major_books_studied" class="form-control" value="<?php echo set_value('major_books_studied', $student['major_books_studied']); ?>" />
        ...
        <label for="exampleInputEmail1"><?php echo $this->lang->line('general_education'); ?></label>

        <input type="text" name="general_education" id="general_education" class="form-control" value="<?php echo set_value('general_education', $student['general_education']); ?>" />
        ...
        */
        ...
        <button type="button"  class="btn btn-primary pull-right custombtn" onclick="window.history.back();">
        ...
        {
        var sect=$('#section_id').val(); 

        if(sect=='10')
        {
        $('#pg_course_details').show();
        $('#course_details').hide();
        }
        else
        {
        $('#pg_course_details').hide();
        $('#course_details').show();
        }
        ...
        <div class="col-sm-10">
        <select  id="sibiling_class_id" name="sibiling_class_id" class="form-control" onchange="getsectionlist()"  >
        <option value=""><?php echo $this->lang->line('select'); ?></option>
        <?php
        foreach ($classlist as $class) {
        ?>
        ...
        <div class="col-sm-10">
        <select  id="sibiling_section_id" name="sibiling_section_id" class="form-control"   onchange="getnamelist()" >
        <option value=""   ><?php echo $this->lang->line('select'); ?></option>
        </select>
        ...
        var studentuser_id  	= $('#studentoo_id').val();

        $.ajax({
        type: "POST",   
        data: {student_id: student_id,studentuser_id:studentuser_id}, 

        url: "<?php echo site_url('student/newcheckifstudentexists');?>",
        ...
        function remove_newsibling(newidd)
        { 
        ...
        {
        var id=newidd;
        var student_id             =   $('#studentoo_id').val();
        $.ajax({
        type: "POST",   
        data: {id: id,student_id:student_id}, 

        url: "<?php echo site_url('student/newstudentdelete');?>",
        success:function(result)
        {
        ...
        url: "<?php echo site_url('sections/getByNewModalClass');?>",
        success:function(result)
        { 
        $('#sibiling_section_id').empty(); 
        var jsondata= JSON.parse(result);
        $('#sibiling_section_id').html('<option value=""></option>');                        
        $.each(jsondata, function(key, value) 
        {

        $('select[name="sibiling_section_id"]').append('<option value="'+ value.section_id +'">'+ value.section +'</option>');
        ...
        var class_id             =   $('#sibiling_class_id').val();   
        var section_id           =   $('#sibiling_section_id').val(); 
        //var sibiling_section_id  =   $('#sibiling_section_id').val(); 
        var current_student_id = $('.current_student_id').val();
        ...
        url: "<?php echo site_url('student/getByNewClassAndSectionExcludeMe');?>",
        success:function(result)
        { 

        $('#sibiling_student_id').empty(); 
        var jsondata= JSON.parse(result);
        $('#sibiling_student_id').html('<option value=""></option>');                        
        $.each(jsondata, function(key, value) 
        {



        $('select[name="sibiling_student_id"]').append('<option value="'+ value.id +'">'+ value.firstname +'</option>');
