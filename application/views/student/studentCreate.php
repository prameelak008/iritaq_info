<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">				
					...
					<div class="col-md-6">				
                    <div class="pull-right box-tools impbtntitle">
					<form name="frm" method="POST" action="<?php echo site_url('student/listlogindetails');?>">
					 <button type="submit" name="search" value="Download Login List" class="btn btn-primary"><i class="fa fa-list"></i> Login Details</button>
					 </form>					
                    </div>
					</div>
                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="common-reset-form" >                       
                        <div class="">
                            <div class="bozero">
                                <h4 class="pagetitleh-whitebg"><?php echo $this->lang->line('student'); ?> <?php /*echo $this->lang->line('admission');*/ ?> Institution Id</h4>
                                <div class="around10">
                                        ...
                                        //if (!$adm_auto_insert) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    $admission_no= $max_studentsid['admission_no'];
                                                    $this->db->select('*');
                                                    ...
                                                    <input autofocus="" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"   value="<?php echo $ad;?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger" id="form_error_gender"><?php echo form_error('gender'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('date_of_birth'); ?></label><small class="req"> *</small>
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control date invalid-future-date"  value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>" />
    ...
    ?>
                                                    ...
                                                    <span class="text-danger" id="form_error_category_id"><?php echo form_error('category_id'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->religion) { ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_religion"><?php echo form_error('religion'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->cast) { ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_cast"><?php echo form_error('cast'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->mobile_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_mobileno"><?php echo form_error('mobileno'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->student_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_email"><?php echo form_error('email'); ?></span>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
...
<?php if ($sch_setting->admission_date) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_admission_date"><?php echo form_error('admission_date'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->student_photo) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_file"><?php echo form_error('file'); ?></span></div>
                                            </div>
...
?>
    ...
    <?php ?>
                                                    ...
                                                    <span class="text-danger" id="form_error_weight" ><?php echo form_error('weight'); ?></span>
                                                </div>
                                            </div>
...
<?php } ?>
                                        ...
                                        <div class="col-md-3" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger" id="form_error_fees_discount"><?php echo form_error('fees_discount'); ?></span>
                                            </div>
                                        </div>
...
<?php if ($sch_setting->father_name) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_father_name" ><?php echo form_error('father_name'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->father_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_father_phone"><?php echo form_error('father_phone'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->father_occupation) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_father_occupation"><?php echo form_error('father_occupation'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->father_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputFile"><?php echo $this->lang->line('father'); ?> <?php echo $this->lang->line('photo'); ?> &nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
...
<?php if ($sch_setting->mother_name) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_mother_name"><?php echo form_error('mother_name'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->mother_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_mother_phone"><?php echo form_error('mother_phone'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->mother_occupation) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_mother_occupation"><?php echo form_error('mother_occupation'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->mother_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputFile"><?php echo $this->lang->line('mother'); ?> <?php echo $this->lang->line('photo'); ?> &nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
                                    ...
                                    if($sch_setting->guardian_name){
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" id="guardian_is" name="guardian_is" <?php
                                            ...
                                            <span class="text-danger" id="form_error_guardian_is"><?php echo form_error('guardian_is'); ?></span>
                                        </div>
                                    </div>
                                        <?php
                                    }
                                        ...
                                        ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-danger" id="form_error_guardian_name"><?php echo form_error('guardian_name'); ?></span>
                                                    </div>
                                                </div>
<?php } if ($sch_setting->guardian_relation) { ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="text-danger" id="form_error_guardian_relation"><?php echo form_error('guardian_relation'); ?></span>
                                                        </div>
                                                    </div>
                                    <?php } ?>
                                            </div>
                                        ...
                                        ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-danger" id="form_error_guardian_phone"><?php echo form_error('guardian_phone'); ?></span>
                                                    </div>
                                                </div>
                                            <?php } 
                                        ...
                                        ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-danger" id="form_error_guardian_occupation" ><?php echo form_error('guardian_occupation'); ?></span>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            </div>
                                    ...
                                    <?php if ($sch_setting->guardian_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger" id="form_error_guardian_email" ><?php echo form_error('guardian_email'); ?></span>
                                                </div>
                                            </div>
<?php } if ($sch_setting->guardian_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputFile"><?php echo $this->lang->line('guardian'); ?> <?php echo $this->lang->line('photo'); ?>&nbsp;<span  class="extstyle"><?php echo $this->lang->line('need_ext_image'); ?></span></label>
...
<?php } if ($sch_setting->guardian_address) { ?>
                                            <div class="col-md-6">
                                                ...
                                                <span class="text-danger" id="form_error_guardian_address"><?php echo form_error('guardian_address'); ?></span>
                                            </div>
<?php } ?>
                                    </div>
                                </div>
                                            ...
                                            <div class="row around10" id="course_details">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="last_studied_madrasa" id="last_studied_madrasa" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="last_studied_madrasa_class" id="last_studied_madrasa_class" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="previous_reg_no" id="previous_reg_no" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="last_studied_class" id="last_studied_class" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="previous_medium" id="previous_medium" class="form-control" />
                                            ...
                                            <div class="row around10"  id="pg_course_details" >
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="last_studied_institute" id="last_studied_institute" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="years_completed" id="years_completed" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="previous_place" id="previous_place" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name_of_prominent_teacher" id="name_of_prominent_teacher" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="major_books_studied" id="major_books_studied" class="form-control" />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="general_education" id="general_education" class="form-control" />
...
<?php } if ($sch_setting->local_identification_no) { ?>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">
    <?php //echo $this->lang->line('local_identification_no'); ?> Visa Number
                                                            </label>
