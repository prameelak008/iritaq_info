                        ...
                        <div class="box-body">
                            ...
                            */
                            ?>
                                    ...
                                    <input type="text" name="student_id" value="<?php echo set_value('id', $student['id']); ?>">
                                    <input type="text" name="sibling_name" value="<?php echo set_value('sibling_name', 0); ?>" id="sibling_name_next">
                                    <input type="text" name="sibling_id" value="<?php echo set_value('sibling_id', 0); ?>" id="sibling_id">
                                    <div class="row">
...
if (!empty($siblings)) {
    ?>
                                <div class="tshadow mb25 bozero sibling_div relative">
                                    ...
                                    <div class="around10">
                                        <div class="row">
                                            <input type="text" name="siblings_counts" class="siblings_counts" value="<?php echo $siblings_counts; ?>">
                                            <?php
                                            if (empty($siblings)) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal_sibling_body">
                <div class="form-horizontal">                   
                    <input type="text" name="current_student_id" class="current_student_id" value="0">
