...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i> <?php echo $this->lang->line('online_examination_instruction'); ?> <small>
                <?php echo $this->lang->line('online_examination_instruction'); ?></small> 
           </h1>
    </section>
    <!-- Main content -->
    <section class="content">
            ...
            if ($this->rbac->hasPrivilege('online_examination_instruction', 'can_add')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <h3 class="box-title"><?php echo $this->lang->line('update'); ?>&nbsp;<?php echo $this->lang->line('online_examination_instruction'); ?></h3>
                        </div>

                         
        <form action="<?php echo site_url('admin/otherexamlist/update_inst') ?>"  id="instruction" name="instruction" method="post" accept-charset="utf-8">
        ...
        <select autofocus="" id="exam_type" name="exam_type" class="form-control" required="required" >
        ...
        <input autofocus="" id="last_date_fee_withoutfine" name="last_date_fee_withoutfine" placeholder="" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_last_date_fee_withoutfine']; ?>" />
        ...
        <input autofocus="" id="last_date_fee_withfine" name="last_date_fee_withfine" placeholder="" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_last_date_fee_withfine']; ?>" />
        ...
        <input autofocus="" id="class_leave_for_studying" name="class_leave_for_studying" placeholder="" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_class_leave_for_studying']; ?>" />
        ...
        <input autofocus="" id="Examcommencement" name="Examcommencement" placeholder="" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_Examcommencement']; ?>" />
        ...
        <label for="exampleInputEmail1"><?php echo $this->lang->line('fee_details'); ?> </label><small class="req"> *</small>
         ...
         <textarea name="fee_details" placeholder="" class="form-control ckeditor"><?php echo $editonline_instructon['online_examination_fee_details']; ?>
        ...
        <textarea name="mode_of_payment" placeholder="" class="form-control ckeditor"><?php echo $editonline_instructon['online_examination_mode_of_payment']; ?></textarea>
        ...
        <textarea name="declaration" placeholder="" class="form-control ckeditor">
        <?php echo $editonline_instructon['online_examination_declaration']; ?></textarea>
        ...
        <input autofocus="" id="publishdate" name="publishdate" placeholder="Eg:29-04-2022" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_publishdate']; ?>" />
        ...
        <input autofocus="" id="lastdate_of_exam" name="lastdate_of_exam" placeholder="Eg:29-04-2022" type="text" class="form-control"  value="<?php echo $editonline_instructon['online_examination_lasdate_of_exam']; ?>" />
        ...
        <input autofocus="" placeholder="Eg:29-04-2022"  value="<?php echo $editonline_instructon['online_examination_closingdate_of_exam']; ?>" id="closingdate" name="closingdate" placeholder="" type="text" class="form-control"  value="<?php echo set_value('closingdate'); ?>" />
        ...
        <input type="time" class="form-control" name="closetime" value="<?php echo $editonline_instructon['online_examination_closetime']; ?>" />
        ...
        <textarea name="closemessage" placeholder="" class="form-control ckeditor"><?php echo $editonline_instructon['online_examination_closemessage']; ?></textarea>
        ...
        <textarea name="remarks_after_fees_payment" placeholder="" class="form-control ckeditor"><?php echo $editonline_instructon['online_examination_remarksafterpayment']; ?></textarea>
                                    ...
                                    foreach ($online_instructon as $instruction) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> 
                                                ...
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/otherexamlist/edit_inst/<?php echo $instruction['online_examination_id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                <i class="fa fa-pencil"></i>
                                                </a>


                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/otherexamlist/delete_inst/<?php echo $instruction['online_examination_id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return doconfirm();" >
