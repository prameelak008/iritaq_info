...
<div class="row">
    <div class="col-md-12">
        <h3 class="entered mt0"><?php echo $this->lang->line('edit')." ".$this->lang->line('online') . " " . $this->lang->line('admission'); ?></h3>
     </div>
            ...
            <div class="form-group">
                ...
                <select  id="class_id" name="class_id" class="form-control"  >
                    ...
                    foreach ($classlist as $class) {
                        ?>
                        <option value="<?php echo $class['id'] ?>"<?php if ($class_section_id == $class['id']) echo "selected=selected" ?>><?php echo $class['class'] ?></option>
                        <?php 
                    }
                    ?>
                </select>
            ...
            <?php if ($this->customlib->getfieldstatus('current_address')) { ?>
                ...
                <?php if ($this->customlib->getfieldstatus('guardian_address')) {?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="current_address" name="current_address" placeholder=""  class="form-control" autocomplete="off" rows="1" ><?php echo set_value('current_address'); ?><?php echo set_value('current_address',$current_address); ?></textarea>
     ...
     <div class="printcontent">    
        <div class="row">
          <h4 class="pagetitleh2"><?php echo $this->lang->line('upload') . " " . $this->lang->line('documents'); ?></h4>  
             <div class="col-md-6">
            <div class="form-group">
                <label> <?php echo $this->lang->line('upload') . " " . $this->lang->line('documents'); ?></label>
