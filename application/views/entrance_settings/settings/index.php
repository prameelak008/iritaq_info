        ...
        <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form" action="<?php echo site_url('entrance_settings/settings/create'); ?>"   name="form" method="post" >
                        <div class="box-body">                            
                        <?php
                           ...
                           <!-- <div class="form-group">
                            ...
                            <option value="<?php  echo $entrance_current_session['cur_session']; ?>"><?php  echo $entrance_current_session['session']; ?></option>
                            </select>
                            ...
                            if ($entrance_current_session['cur_session'] == $session['id']) 
                            {
                            ...
                            {
                            ?>
                            <option value="<?php  echo $phase['entrance_examgroup_id']; ?>"><?php  echo $phase['entrance_examgroup_name']; ?></option>
                            <?php } ?>
                            </select>
                            <span class="text-danger"><?php echo form_error('session'); ?></span>
                            </div>
                            ...
                            <input type="datetime-local" name="announce_date"  id="announce_date" class="form-control" />
                            </div>
                            ...
                            <option>Select Announce</option>
                            <?php
                            foreach($template as $temp)
                            {
                            ?>
                            <option value="<?php echo $temp['set_template_id'];  ?>"><?php echo $temp['set_template_name'];  ?></option>
                            <?php
                            } 
                            ?>
                            </select>
            ...
            ?>
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('template').'&nbsp;'.$this->lang->line('list') .'&nbsp;&nbsp;'.   $entrance_current_session['session']; ?></h3>
