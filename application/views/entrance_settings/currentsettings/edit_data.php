           ...
           // if ($this->rbac->hasPrivilege('expense', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form" action="<?php echo site_url('entrance_settings/currentsettings/edit/'.$id); ?>"   name="form" method="post" >
                            ...
                            */
                            ...
                            <option value="<?php echo $generalbyval['id'];  ?>" ><?php echo $generalbyval['session'];  ?></option>
                            <?php
                            ...
                            <textarea cols="3" rows="5" id="title" name="title" class="form-control ckeditor"  style="background-color: whitesmoke;"><?php echo $generalbyval['cur_title'];  ?></textarea>
                            </div> 
                            
                            
                            <div class="form-group" >
                            <label for="exampleInputEmail1">Sub Title </label>
                            <textarea cols="3" rows="5" id="subpage" name="subpage" class="form-control ckeditor"  style="background-color: whitesmoke;"><?php echo $generalbyval['cur_title_subpage'];  ?></textarea>
                            </div>
                            
                            
                            <div class="form-group" >
                            <label for="exampleInputEmail1">Admit Card Title </label>
                            <input type="text" name="admit_title" id="admit_title" class="form-control" value="<?php echo $generalbyval['cur_title_admitcard'];  ?>" />
                            </div> 
                            ...
                            <input id="is_status" name="is_status" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_status', '1', (set_value('is_status',  $generalbyval['is_activestatus']) == 1) ? true : false); ?>>
