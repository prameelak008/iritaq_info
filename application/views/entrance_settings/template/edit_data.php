            ...
            if ($this->rbac->hasPrivilege('expense', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url("entrance_settings/template/edit/" . $id); ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">                            
                               <?php
                            ...
                            */
                            ?>
                                ...
                                <input type="text" name="templatename" value="<?php echo  $tempval['set_template_name']; ?>"  class="form-control" />
                                <span class="text-danger"><?php echo form_error('templatename'); ?></span>
                                </div>
                                
                                <div class="form-group">
                                <label for="exampleInputEmail1">Instruction</label> 
                                <textarea name="instruction" id="instruction"  rows="6" class=" form-control ckeditor" required="required"><?php echo set_value('instruction', $tempval['set_template_instruction']); ?></textarea>
                                </div>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('template'); ?></h3>
