                    ...
                    'programme',
                    $this->lang->line('programme'),
                    'trim|required|xss_clean|callback_programme_exists'
                    );
                    ...
                    $data['programelist']   =   $this->Programee_model->get_programs();
                    $data['facultylist']    =   $this->Faculty_model->get_faculty();                    
                    $data['assignprgmlist'] =   $this->Programee_model->get_assignprograme();
                    ...
                    {
                    $exists = $this->Programee_model->programme_exists($programme);

                    if ($exists) {
                    $this->form_validation->set_message(
                    'programme_exists',
                    'This programme is already assigned.'
                    );
                    return false;
                    }
