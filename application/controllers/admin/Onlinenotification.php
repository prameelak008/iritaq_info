            ...
            class Onlinenotification extends Admin_Controller
            {
            ...
            $this->session->set_userdata('sub_menu', 'notification/online_setting');
            
            $data                     = array();
            $data['title']            = 'Email Config List';
            $notificationlist         = $this->notificationsetting_model->get_online();
            ...
            $this->notificationsetting_model->updatebatch_online($update_array);
            $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('update_message') . '</div>');
            redirect('admin/Onlinenotification/setting');
            }
            
            
            $data['title'] = 'Email Config List';
            $this->load->view('layout/header', $data);
            $this->load->view('admin/notification_online/setting', $data);
            $this->load->view('layout/footer', $data);
            }
            ...
            $data['record'] = $this->notificationsetting_model->get_online($id);
            
            $template = $this->load->view('admin/notification_online/gettemplate', $data, true);
            ...
            'template_two' => $this->input->post('template_message_two'),
            'is_template'  => $this->input->post('checktemplate'),
            'subject'      => $this->input->post('template_subject'));
            
            $this->notificationsetting_model->update_online($data_update);
