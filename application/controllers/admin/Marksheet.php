...
class Marksheet extends Admin_Controller {
    ...
    public function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (isset($_POST['is_section'])) {
             ...
             if (isset($_POST['is_preprint'])) {
                $is_preprint = 1;
            } else {
                $is_preprint = 0;
            }
            
             if (isset($_POST['is_examination_course'])) {
                $is_examination_course = 1;
            } else {
                $is_examination_course = 0;
            }
            ...
            $insert_data = array(
                ...
                'is_rollactive' => $is_rollactive,
                'is_photo' => $is_photo,
                'is_class' => $is_class,
                'is_division' => $is_division,
                'is_section' => $is_section,
                'is_examination_course'=>$is_examination_course,
                ...
                'footer_align'   => $this->input->post('footer_align'),
                 ...
                 'footer_text_bottom' => $this->input->post('footer_text_bottom'),
                'footer_align_bottom'   => $this->input->post('footer_align_bottom'),
                'footer_bottom_padding'   => $this->input->post('footer_bottom_padding'),
    ...
    public function removeleft_sign($id="0")
    {    
    $data =    array('left_sign'=> ""); 
    $this->db->where('id', $id);
    $this->db->update('template_marksheets', $data);
    redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function removemiddle_sign($id="0")
    {    
    $data =    array('middle_sign'=> ""); 
    $this->db->where('id', $id);
    $this->db->update('template_marksheets', $data);
    redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function removeright_sign($id="0")
    {    
    $data =    array('right_sign'=> ""); 
    $this->db->where('id', $id);
    $this->db->update('template_marksheets', $data);
    redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function removebackground_img($id="0")
    {    
