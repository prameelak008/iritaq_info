                        ...
                        {
                        $data = array(
                        'devieId' => $this->input->post('name'),
                        'isActive' => 'Yes',
                        'Date'=>date('Y-m-d H:i:s')
                        );
                        $this->db->insert('deviceid_info',$data);
                        $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">' . $this->lang->line('success_message') . '</div>');
                        redirect('admin/expense/mobileinfo');
                        }


                        $this->load->view('layout/header', $data);
                        $this->load->view('admin/expense/mobileinfo', $data);
                        $this->load->view('layout/footer', $data);
                        }
                        ...
                        public function getsearchexpenselist_default()
                        {
