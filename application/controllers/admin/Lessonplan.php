    ...
    public function gettopiclist()
    {
        ...
        if (!empty($m->data)) {
            foreach ($m->data as $key => $value) {
             ...
             $deletebtn = "<a onclick='deletetopicbulk(" . $value->lesson_id . ")'  class='btn btn-default btn-xs' data-placement='left' title='" . $this->lang->line('delete') . "' data-toggle='tooltip'><i class='fa fa-trash'></i></a>";
