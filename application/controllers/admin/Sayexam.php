                        ...
                        class Sayexam extends Admin_Controller
                        {
                        ...
                        $this->session->set_userdata('sub_menu','say_exam/sayexam_ce');
                        ...
                        $data['sayexam'] = $this->examresult_model->getsayexam_subjectfor_teachers($exam_id, $exam_group_id,$class_id, $section_id,$session_id);
                        ...
                        $this->load->view('admin/sayexam/index', $data);
                        ...
                        $this->db->update('exam_group_exam_sayexam', $data[$i]);
                        ...
                        public function  getstudent_sayexamlist_modal ()
                        {
                        ...
                        $data['sayexam']      = $this->examresult_model->getsayexam_subjectfor_Marks($post_exam_id, $post_exam_group_id, $students_array);
            
                        $data['getgroup_name'] = $this->examresult_model->getgroup_name($post_exam_id, $post_exam_group_id);
            
                        $data['sayexam_approved_status'] = $this->examresult_model->sayexam_approved_status($post_exam_id, $post_exam_group_id, $students_array);
                        ...
                        $this->load->view('admin/sayexam/online_exam_ajax',$data);
                        ...
                        $data['sayexam_marks']     = $this->examresult_model->admin_get_sayexam_students($post_exam_id, $post_exam_group_id,$students_array);
                        $data['sch_setting']       = $this->sch_setting_detail;
                        $data['sayexamfee_feecharge_ce']    = $this->examgroup_model->sayexamfee_feecharge_cemarks_admin($post_exam_id, $post_exam_group_id,$session_id);
                       
                        $student_exam_page         = $this->load->view('admin/sayexam/_printsayexam', $data, true); 
                        ...
                        $data=array();
                        $this->session->set_userdata('top_menu', 'say_exam');
                        $this->session->set_userdata('sub_menu', 'say_exam/sayexam_ce_payment');
                        ...
                        $data['class_id']         =  $class_id  ;
                        $data['section_id']       =  $section_id  ;
                        $data['online_examlist']  =  $this->examgroup_model->list_online_exam_sayexam($exam_group_id,$exam_id,$session_id,$class_id,$section_id);
                        $data['feelist']          =  $this->examgroup_model->online_exam_update_fees_sayexam($exam_group_id,$exam_id,$session_id,$class_id,$section_id);
                        }
                        
                        $data['current_session'] = $this->current_session; 
                        $this->load->view('layout/header', $data);
                        $this->load->view('admin/sayexam/updatepayment', $data);
                        $this->load->view('layout/footer', $data);
                        }
                        ...
                        $query= $this->db->insert('fees_sayexampayment',$data);
                        ...
                        $empdelete=$this->db->delete('fees_sayexampayment',$cond);
                        if($empdelete)
                        {
                        echo true;
                        } 
