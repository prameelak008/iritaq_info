            ...
            class Seatquota extends Admin_Controller 
            {
            ...
            $this->session->set_userdata('sub_menu', 'entrance_allotment/Seatquota');
            ...
            $this->load->view('admin/entranceexam/examgroup/seatquota/index', $data);
            ...
            $this->db->where('entranceexam_seatquota_course', $courseid);
            $this->db->where('entranceexam_seatquota_session', $sessionid);
            $this->db->where('entranceexam_seatquota_phase', $entrance_phase);
            ...
            // 'entranceexam_seatquota_phase'                =>     $entrance_phase,
            ...
            $condition=array('entranceexam_seatquota_course'   => $courseid,
            'entranceexam_seatquota_session'                   => $sessionid,
            'entranceexam_seatquota_phase'                     => $entrance_phase);
            $this->db->where($condition);
            $query=$this->db->update('entranceexam_seatquota', $dat);
            ...
            $this->db->where('entranceexam_eligiblequota_phase', $entrance_phase);
            ...
            $condition=array('entranceexam_eligiblequota_course'=>$courseid,
            'entranceexam_eligiblequota_session'=>$sessionid,
            'entranceexam_eligiblequota_seattype'=>$entrance_allot_type_name,
            'entranceexam_eligiblequota_phase'=>$entrance_phase,
            );
            $this->db->where($condition);
            $query=$this->db->update('entranceexam_eligiblequota', $dat);
            echo json_encode($query);
            }
            else
            {
            ...
            $query=$this->Entranceallotment_model->getseat_val($type_name,$courseid,$sessionid,$entrance_phase);
            echo json_encode($query);
            }
