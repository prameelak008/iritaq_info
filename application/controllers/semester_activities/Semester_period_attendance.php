            ...
            $data['time_period']                =    $this->Semesteractivities_model->list_period();      
            ...
            public function getPeriodsByBatch()
            {
            // Read POST values
            $batch          = $this->input->post('batch');
            $attendanceDate = $this->input->post('attendanceDate');
            $period         = $this->input->post('selectedPeriod');

            // Safety check
            // if (empty($batch) || empty($attendanceDate)) {
            //     echo json_encode([]);
            //     return;
            // }
            ...
            $periodlist     = $this->Semesteractivities_model->getPeriodsByBatch($batch, $day, $period);


            // Return JSON array (JS expects array)
