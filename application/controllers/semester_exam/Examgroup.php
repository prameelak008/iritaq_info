<<<<<<< HEAD
                ...
                redirect('semester_exam/examgroup/index');
                }
                $examgroup_result      = $this->examgroup_model->get_res();
                $data['examgrouplist'] = $examgroup_result;

                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/examgroupList', $data);
                ...
                $data['exam_subjects'] = $this->Semesterexam_model->getExamSubjects($id);
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/exam', $data);
                $this->load->view('layout/footer', $data);
                }
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/examresult', $data);
                $this->load->view('layout/footer', $data);
                }
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/addmark', $data);
                $this->load->view('layout/footer', $data);
                }
                ...
                redirect('semester_exam/examgroup');
                }
                ...
                if ($this->form_validation->run() == false) {
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/examgroupEdit', $data);
                $this->load->view('layout/footer', $data);
                } else {
                $is_active = 0;
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/addexam', $data);
                $this->load->view('layout/footer', $data);
                }
                ...
                // if ($this->form_validation->run() == false) {
                // $data = array(
                // 'Programe Type'   => form_error('sub_program_type'),        
                // );
                // $array = array('status' => 0, 'error' => $data);
                // echo json_encode($array);
                ...
                // $data['sub_sem_group_id']                       = $this->input->post('sub_sem_group_id');
                // $sub_sem_group_id                               = $data['sub_sem_group_id'];  
                
                 $data['sub_sem_group_id']                    = $this->input->post('sem_type');
                 $sub_sem_group_id                            = $data['sub_sem_group_id'];


                $resultlist                                    = $this->Semesterexam_model->examGroupSubjectResult($exam_subject_id, $sub_sem_group_id);
                // $resultlist                                     = $this->examgroupstudent_model->examGroupSubjectResult($exam_subject_id, $class_id, $section_id, $session_id);
                // $subject_detail                                 = $this->batchsubject_model->getExamSubject($exam_subject_id);       

                $subject_detail                                 = $this->Semesterexam_model->getExamSubject($exam_subject_id);
                $data['subject_detail']                         = $subject_detail;
                $data['attendence_exam']                        = $this->attendence_exam;

                $data['resultlist']                             = $resultlist;
                $data['sch_setting']                            = $this->sch_setting_detail;
                $student_exam_page                              = $this->load->view('semester_exam/examgroup/_partialstudentmarkEntry', $data, true);
                ...
                // $this->form_validation->set_rules('batch_group', $this->lang->line('batch_group'), 'required|trim|xss_clean');
                // $this->form_validation->set_rules('semester_semtype', $this->lang->line('semester'), 'required|trim|xss_clean');
                // $this->form_validation->set_rules('semester_term', $this->lang->line('term'), 'required|trim|xss_clean');

                // $data['adm_auto_insert'] = $this->sch_setting_detail->adm_auto_insert;
                // $data['sch_setting']     = $this->sch_setting_detail;
                if ($this->form_validation->run() == false) {
                $msg = array(
                'programee_type'   => form_error('programee'),
                'batch'            => form_error('batch'),
                // 'programee_type'   => form_error('programee_type'),
                // 'programee'        => form_error('programee'),
                // 'batch_group'      => form_error('batch_group'),
                // 'semester_semtype' => form_error('semester_semtype'),
                // 'semester_term'    => form_error('semester_term')
                ...
                $data['prog_id']           = $this->input->post('prog_id');
                $data['sem_type']          = $this->input->post('sem_type');
                $data['sem_group_id']      = $data['sem_type'] ; 

                // $data['programee_type']    = $this->input->post('programee_type');
                // $data['programee']         = $this->input->post('programe');
                // $data['batch_group']       = $this->input->post('batch_group');
                // $data['semester_semtype']  = $this->input->post('semester_semtype');
                // $data['semester_term']     = $this->input->post('semester_term');
                // $data['sem_group_id']      = $this->input->post('sem_group_id');
                $data['exam_id']           = $this->input->post('exam_id'); 
                // $studentlist               = $this->Semesterexam_model->searchExamSemStudents($data['sem_group_id']);

                $studentlist               = $this->Semesterexam_model->searchExamSemStudents($data['sem_group_id']);
                $data['studentlist']       = $studentlist;
                $studentdetails            = $this->load->view('semester_exam/examgroup/_partialexamstudent', $data, true);
                $array                     = array('status' => '1', 'error' => '', 'page' => $studentdetails);
                ...
                $exam_id            = $this->input->post('exam_id'); // exam_semestergroup
                $selected_students = $this->input->post('student_id'); // only checked (array)
            

                if (!is_array($selected_students)) {
                $selected_students = []; // ensure it's an array
                }

                // 1️ Get all previously allotted students for this exam
                $this->db->select('sem_student_id');
                $this->db->from('semester_student_tbl');
                $this->db->where('sem_exam_exam_id', $exam_id);
                $query = $this->db->get();
                $old_students = array_column($query->result_array(), 'sem_student_id');

                // 2️ Find students to delete (old but not in new list)
                $to_delete = array_diff($old_students, $selected_students);

                // 3️ Find students to insert (newly selected but not already there)
                $to_insert = array_diff($selected_students, $old_students);

                // 4️ Delete unchecked students
                if (!empty($to_delete)) {
                $this->db->where('sem_exam_exam_id', $exam_id);
                $this->db->where_in('sem_student_id', $to_delete);
                $this->db->delete('semester_student_tbl');
                }

                // 5️ Insert newly checked students
                foreach ($to_insert as $student_id)
                {

                // 🔹 Fetch student details for QR content
                $this->db->select('id, firstname, lastname, admission_no, roll_no');
                ...
                $data_text = "Student Id: $student_id\nExam Id: $exam_id\nName: $name\nAdmission No: $admission\nRoll No: $roll";

                // 🔹 Generate QR code using your function
                $qr = $this->generate_qrcode($data_text, $student_id);

                // 🔹 Prepare insert data
                $data = array(
                'sem_exam_exam_id'   => $exam_id,
                'sem_student_id'     => $student_id,
                'sem_exam_qrcode'    => $qr['file'],  // store generated QR file path
                'sem_teacher_remark' => NULL,
                'sem_is_active'      => 1,
                'sem_created_at'     => date("Y-m-d H:i:s"),
                'sem_updated_at'     => date("Y-m-d H:i:s"),
                );

                $this->db->insert('semester_student_tbl', $data);
                }
                }
                $this->session->set_flashdata('msg', 'Students allotted successfully with QR codes!');
                redirect('semester_exam/examgroup');
                }
...
=======
        ...
        {
        $this->form_validation->set_error_delimiters('<p>', '</p>');
        $this->form_validation->set_rules('Programe Type', $this->lang->line('sub_program_type'), 'required|trim|xss_clean');
...
>>>>>>> d118f7f6c5e54fefb367b87818d22f76b35a5956
                ...
                // public function entrystudents001()
                // {
                // $exam_id = $this->input->post('exam_id'); // exam_semestergroup
                // $selected_students = $this->input->post('student_id'); // only checked (array)
                // if (!is_array($selected_students)) {
                // $selected_students = []; // make sure it's always an array
                // }

                // // 1. Get all previously allotted students for this exam
                // $this->db->select('sem_student_id');
                // $this->db->from('semester_student_tbl');
                // $this->db->where('sem_exam_exam_id', $exam_id);
                // $query = $this->db->get();
                ...
                // // 2. Find students to delete (old but not in new list)
                // $to_delete = array_diff($old_students, $selected_students);

                // // 3. Find students to insert (newly selected but not already there)
                // $to_insert = array_diff($selected_students, $old_students);

                // // 4. Delete unchecked students
                // if (!empty($to_delete)) {
                // $this->db->where('sem_exam_exam_id', $exam_id);
                // $this->db->where_in('sem_student_id', $to_delete);
                // $this->db->delete('semester_student_tbl');
                ...
                // // 5. Insert newly checked students
                // foreach ($to_insert as $student_id) {
                // $data = array(
                // 'sem_exam_exam_id'       => $exam_id,
                // 'sem_student_id'         => $student_id,
                // 'sem_exam_qrcode'        => uniqid("EXAMQR_"), // generate unique QR
                // 'sem_teacher_remark'     => NULL,
                // 'sem_is_active'          => 1,
                // 'sem_created_at'         => date("Y-m-d H:i:s"),
                // 'sem_updated_at'         => date("Y-m-d H:i:s"),
                ...
                // $this->session->set_flashdata('msg', 'Students allotted successfully!');
                // redirect('semester_exam/examgroup');
                // }
<<<<<<< HEAD
                ...
                'attendence'                             => $attendance,
                'get_marks'                              => $this->input->post('exam_group_student_mark_' . $exam_group_student_value),
                'get_cmarks'                             => $this->input->post('exam_group_student_cmark_' . $exam_group_student_value),
                'note'                                   => $this->input->post('exam_group_student_note_' . $exam_group_student_value),
                );
                $insert_array[] = $array;
                }
                ...
                $this->db->where('exam_group_class_batch_exam_subject_id', $student_value['exam_group_class_batch_exam_subject_id']);
                $this->db->where('exam_group_class_batch_exam_student_id', $student_value['exam_group_class_batch_exam_student_id']);
                $q          = $this->db->get('semester_group_exam_results');
                ...
                $this->db->where('id', $update_result->id);
                $this->db->update('semester_group_exam_results', $da);

                $this->db->where('result_id', $update_result->id);
                $q_regular = $this->db->get('semester_group_exam_results_regular');
...
<<<<<<< HEAD
                ...
                $this->db->update('semester_group_exam_results_regular', $regular_data);
                }
                else
                {
                $regular_data = array(
...
<<<<<<< HEAD
                ...
                $this->db->insert('semester_group_exam_results_regular', $regular_data);
                }
                }
                else
                {
                ...
                $this->db->insert('semester_group_exam_results', $da);
                ...
                $data['exam_page'] = $this->load->view('semester_exam/examgroup/_partialexamList', $data, true);
                ...
                $data['exam_page'] = $this->load->view('semester_exam/examgroup/_partialexamListConnection', $data, true);
                echo json_encode($data);
                }
                ...
                $data['exam_subjects'] = $this->Semesterexam_model->getExamSubjects($exam_id);
                $data['batch_subjects']      = $this->subject_model->get();       

                $data['exam_group_ids']      = $exam_group_ids ;
                $data['exam_id']             = $exam_id;
                $data['exam_subjects_count'] = count($data['exam_subjects']);

                $data['batch_subject_dropdown'] = $this->load->view('semester_exam/examgroup/_partialexamSubjectDropdown', $data, true);        
                $data['subject_page']          = $this->load->view('semester_exam/examgroup/_partialexamSubjects', $data, true);        
                echo json_encode($data);
                }
                ...
                $data['sessionlist']     = $session;
                $data['current_session'] = $this->sch_current_session;
                $data['subject_page']    = $this->load->view('semester_exam/examgroup/_getSubjectByExam', $data, true);
                echo json_encode($data);        
                }
                ...
                $data['sch_setting']       = $this->sch_setting_detail;
                $data['subject_page']      = $this->load->view('semester_exam/examgroup/_getTeacherRemarkByExam', $data, true);
                echo json_encode($data);
                }
                ...
                if ($this->input->post('exam_group_class_batch_exam_id') != "" && $this->input->post('subject_' . $row_value) != "" && $this->input->post('date_from_' . $row_value) != "" && $this->input->post('time_from' . $row_value) != "" && $this->input->post('duration' . $row_value) != "" && $this->input->post('max_marks_' . $row_value) != "" && $this->input->post('min_marks_' . $row_value) != ""  && $this->input->post('max_cmarks_' . $row_value) != "" && $this->input->post('min_cmarks_' . $row_value) != "") {
                ...
                'max_cmarks'                        => $this->input->post('max_cmarks_' . $row_value),
                'min_cmarks'                        => $this->input->post('min_cmarks_' . $row_value));
                }
                } 
                else
                {
                ...
                $this->Semesterexam_model->add_subjects($insert_array, $update_array, $not_be_del, $this->input->post('exam_group_class_batch_exam_id'));
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('semester_exam/examgroup/assign', $data);
                $this->load->view('layout/footer', $data);
                }
                ...
                $dir = 'semester_records/partial_exam_qr/';
                if (!file_exists($dir)) {
                mkdir($dir, 0775, true);
                }
